"""
GraphIt API Type Definitions

Data classes and type definitions for GraphIt API objects including knowledge
...
class ProvenanceEvent:
    ...
    Attributes:
        explain_id: URI of the provenance node (e.g., urn:graphit:question:abc123)
