...
Document IDs are externally provided (e.g., https://graphit.ai/doc/abc123).
...
- Activity:  https://graphit.ai/activity/{uuid}
- Subgraph:  https://graphit.ai/subgraph/{uuid}
"""
...
def activity_uri(activity_id: str = None) -> str:
    ...
    return f"{GRAPHIT_BASE}/activity/{_encode_id(activity_id)}"
...
def subgraph_uri(subgraph_id: str = None) -> str:
    ...
    return f"{GRAPHIT_BASE}/subgraph/{_encode_id(subgraph_id)}"


def agent_uri(component_name: str) -> str:
    """Generate URI for a GraphIt component agent."""
    return f"{GRAPHIT_BASE}/agent/{_encode_id(component_name)}"


# Query-time provenance URIs
# These URIs use the urn:graphit: namespace to distinguish query-time
# provenance from extraction-time provenance (which uses https://graphit.ai/)
#
# Terminology:
...
def question_uri(session_id: str = None) -> str:
    ...
    Returns:
        URN in format: urn:graphit:question:{uuid}
    """
    if session_id is None:
        session_id = str(uuid.uuid4())
    return f"urn:graphit:question:{session_id}"
...
def grounding_uri(session_id: str) -> str:
    ...
    Returns:
        URN in format: urn:graphit:prov:grounding:{uuid}
    """
    return f"urn:graphit:prov:grounding:{session_id}"
...
def exploration_uri(session_id: str) -> str:
    ...
    Returns:
        URN in format: urn:graphit:prov:exploration:{uuid}
    """
    return f"urn:graphit:prov:exploration:{session_id}"
...
def focus_uri(session_id: str) -> str:
    ...
    Returns:
        URN in format: urn:graphit:prov:focus:{uuid}
    """
    return f"urn:graphit:prov:focus:{session_id}"
...
def synthesis_uri(session_id: str) -> str:
    ...
    Returns:
        URN in format: urn:graphit:prov:synthesis:{uuid}
    """
    return f"urn:graphit:prov:synthesis:{session_id}"
...
def edge_selection_uri(session_id: str, edge_index: int) -> str:
    ...
    Returns:
        URN in format: urn:graphit:prov:edge:{uuid}:{index}
    """
    return f"urn:graphit:prov:edge:{session_id}:{edge_index}"


# Agent provenance URIs
# These URIs use the urn:graphit:agent: namespace to distinguish agent
...
def agent_session_uri(session_id: str = None) -> str:
    ...
    Returns:
        URN in format: urn:graphit:agent:{uuid}
    """
    if session_id is None:
        session_id = str(uuid.uuid4())
    return f"urn:graphit:agent:{session_id}"
...
def agent_iteration_uri(session_id: str, iteration_num: int) -> str:
    ...
    Returns:
        URN in format: urn:graphit:agent:{uuid}/i{num}
    """
    return f"urn:graphit:agent:{session_id}/i{iteration_num}"
...
def agent_thought_uri(session_id: str, iteration_num: int) -> str:
    ...
    Returns:
        URN in format: urn:graphit:agent:{uuid}/i{num}/thought
    """
    return f"urn:graphit:agent:{session_id}/i{iteration_num}/thought"
...
def agent_observation_uri(session_id: str, iteration_num: int) -> str:
    ...
    Returns:
        URN in format: urn:graphit:agent:{uuid}/i{num}/observation
    """
    return f"urn:graphit:agent:{session_id}/i{iteration_num}/observation"
...
def docrag_question_uri(session_id: str = None) -> str:
    ...
    Returns:
        URN in format: urn:graphit:docrag:{uuid}
    """
    if session_id is None:
        session_id = str(uuid.uuid4())
    return f"urn:graphit:docrag:{session_id}"
...
def docrag_grounding_uri(session_id: str) -> str:
    ...
    Returns:
        URN in format: urn:graphit:docrag:{uuid}/grounding
    """
    return f"urn:graphit:docrag:{session_id}/grounding"
...
def docrag_exploration_uri(session_id: str) -> str:
    ...
    Returns:
        URN in format: urn:graphit:docrag:{uuid}/exploration
    """
    return f"urn:graphit:docrag:{session_id}/exploration"
...
def docrag_synthesis_uri(session_id: str) -> str:
    ...
    Returns:
        URN in format: urn:graphit:docrag:{uuid}/synthesis
    """
    return f"urn:graphit:docrag:{session_id}/synthesis"
