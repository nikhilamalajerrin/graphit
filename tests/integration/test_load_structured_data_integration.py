"""
Integration tests for gr-load-structured-data with actual GraphIt instance.
...
from graphit.cli.load_structured_data import load_structured_data
...
<ROOT>
    ...
    @pytest.mark.asyncio
    async def test_csv_to_graphit_pipeline(self):
        """Test complete CSV to GraphIt pipeline"""
    ...
    @pytest.mark.asyncio 
    async def test_xml_to_graphit_pipeline(self):
        """Test complete XML to GraphIt pipeline"""
    ...
    @pytest.mark.asyncio
    async def test_json_to_graphit_pipeline(self):
        """Test complete JSON to GraphIt pipeline"""
        json_descriptor = {
            **self.test_descriptor,
            "format": {
                "type": "json",
    ...
    def test_schema_suggestion_integration(self):
        ...
        pytest.skip("Requires running GraphIt API at localhost:8088")
