...
from graphit.retrieval.graph_rag.graph_rag import GraphRag
from graphit.schema import EntityMatch, Term, IRI
...
class TestGraphRagIntegration:
    ...
    def mock_graph_embeddings_client(self):
        ...
        client.query.return_value = [
            EntityMatch(entity=Term(type=IRI, iri="http://graphit.ai/e/machine-learning"), score=0.95),
            EntityMatch(entity=Term(type=IRI, iri="http://graphit.ai/e/artificial-intelligence"), score=0.90),
            EntityMatch(entity=Term(type=IRI, iri="http://graphit.ai/e/neural-networks"), score=0.85)
        ]
        return client
    ...
    def mock_triples_client(self):
        ...
        async def query_stream_side_effect(s=None, p=None, o=None, limit=None, user=None, collection=None, batch_size=20):
            ...
            if p == "http://www.w3.org/2000/01/rdf-schema#label":
                if s == "http://graphit.ai/e/machine-learning":
                    return [MagicMock(s=s, p=p, o="Machine Learning")]
                elif s == "http://graphit.ai/e/artificial-intelligence":
                    return [MagicMock(s=s, p=p, o="Artificial Intelligence")]
                elif s == "http://graphit.ai/e/neural-networks":
            ...
            if s == "http://graphit.ai/e/machine-learning":
                return [
                    MagicMock(
                        s="http://graphit.ai/e/machine-learning",
                        p="http://graphit.ai/is_subset_of",
                        o="http://graphit.ai/e/artificial-intelligence"
                    ),
                    MagicMock(
                        s="http://graphit.ai/e/machine-learning",
    ...
    async def test_graph_rag_end_to_end_flow(self, graph_rag, mock_embeddings_client,
        ...
        for triples, prov_id in provenance_events:
            ...
            assert prov_id.startswith("urn:graphit:")
