...
from graphit.extract.kg.definitions.extract import Processor as DefinitionsProcessor
from graphit.extract.kg.relationships.extract import Processor as RelationshipsProcessor
from graphit.storage.knowledge.store import Processor as KnowledgeStoreProcessor
from graphit.schema import Chunk, Triple, Triples, Metadata, Term, Error, IRI, LITERAL
from graphit.schema import EntityContext, EntityContexts, GraphEmbeddings, EntityEmbeddings
...
class TestKnowledgeGraphPipelineIntegration:
    ...
    async def test_uri_generation_consistency(self, definitions_processor, relationships_processor):
        ...
        for entity in test_entities:
            ...
            assert def_uri.startswith(GRAPHIT_ENTITIES)
    ...
    async def test_definitions_triple_generation(self, definitions_processor, sample_definitions_response):
        ...
        for entity in entities:
            ...
            assert entity.entity.iri.startswith(GRAPHIT_ENTITIES)
    ...
    async def test_knowledge_store_triples_storage(self, mock_cassandra_store):
        ...
        sample_triples = Triples(
            ...
            triples=[
                Triple(
                    s=Term(type=IRI, iri="http://graphit.ai/e/machine-learning"),
                    p=Term(type=IRI, iri=DEFINITION),
