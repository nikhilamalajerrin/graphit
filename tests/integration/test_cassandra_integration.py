...
from graphit.direct.cassandra_kg import KnowledgeGraph
from graphit.storage.triples.cassandra.write import Processor as StorageProcessor
from graphit.query.triples.cassandra.service import Processor as QueryProcessor
from graphit.schema import Triple, Term, Metadata, Triples, TriplesQueryRequest, IRI, LITERAL
...
class TestCassandraIntegration:
    ...
    async def test_complete_cassandra_integration(self, cassandra_shared_container):
        ...
        # Track the created GraphIt instance
