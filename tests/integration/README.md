# Integration Test Pattern for GraphIt

This directory contains integration tests that verify the coordination between multiple GraphIt services and components, following the patterns outlined in [TEST_STRATEGY.md](../../TEST_STRATEGY.md).
...
```bash
pytest tests/integration/ -m integration --cov=graphit --cov-fail-under=0
```
