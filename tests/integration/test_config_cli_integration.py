...
from graphit.cli.list_config_items import main as list_main
from graphit.cli.get_config_item import main as get_main
from graphit.cli.put_config_item import main as put_main
from graphit.cli.delete_config_item import main as delete_main
...
class TestConfigCLIIntegration:
    ...
    def test_list_config_items_integration(self, mock_api_class, capsys):
        """Test gr-list-config-items with mocked API response."""
    ...
    def test_get_config_item_integration(self, mock_api_class, capsys):
        """Test gr-get-config-item with mocked API response."""
        from graphit.api.types import ConfigValue
    ...
    def test_put_config_item_integration(self, mock_api_class, capsys):
        """Test gr-put-config-item with mocked API response."""
        # Mock the API and config objects
        mock_api = MagicMock()
        mock_config = MagicMock()
        mock_api.config.return_value = mock_config
    ...
    def test_delete_config_item_integration(self, mock_api_class, capsys):
        """Test gr-delete-config-item with mocked API response."""
        # Mock the API and config objects
        mock_api = MagicMock()
        mock_config = MagicMock()
        mock_api.config.return_value = mock_config
    ...
    def test_put_config_item_stdin_integration(self, mock_api_class, capsys):
        """Test gr-put-config-item with stdin input."""
        # Mock the API and config objects
        mock_api = MagicMock()
        mock_config = MagicMock()
        mock_api.config.return_value = mock_config
    ...
    def test_list_help_message(self):
        ...
        test_args = ['gr-list-config-items', '--help']
    ...
    def test_missing_required_args(self):
        ...
        test_args = ['gr-list-config-items']
        ...
        test_args = ['gr-get-config-item', '--type', 'prompt']
