...
from graphit.template.prompt_manager import PromptManager, PromptConfiguration, Prompt
...
class TestPromptManager:
    ...
    def test_simple_text_template_rendering(self, prompt_manager):
        ...
        assert rendered == "Hello Alice, welcome to GraphIt!"
    ...
    def test_global_terms_merging(self, prompt_manager):
        ...
        assert "GraphIt" in rendered  # From global terms
    ...
    async def test_invoke_text_response(self, prompt_manager):
        ...
        mock_llm = AsyncMock()
        mock_llm.return_value = "Welcome Alice to GraphIt!"
        ...
        assert result == "Welcome Alice to GraphIt!"
        
        # Verify LLM was called with correct prompts
        mock_llm.assert_called_once()
        call_args = mock_llm.call_args[1]
        assert call_args["system"] == "You are a helpful assistant."
        assert "Hello Alice, welcome to GraphIt!" in call_args["prompt"]
    ...
    def test_load_config_does_not_swallow_keyboard_interrupt(self, monkeypatch):
        ...
        monkeypatch.setattr("graphit.template.prompt_manager.json.loads", interrupt)
