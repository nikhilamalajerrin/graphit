"""
Unit tests for graphit.decoding.universal.processor
"""
...
from graphit.decoding.universal.processor import (
...
class TestUniversalProcessor(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.base.librarian_client.Consumer')
    @patch('graphit.base.librarian_client.Producer')
    @patch('graphit.decoding.universal.processor.partition')
    @patch('graphit.base.async_processor.AsyncProcessor', MockAsyncProcessor)
    async def test_on_message_inline_non_page(
        ...
        with patch('graphit.decoding.universal.processor.magic') as mock_magic:
    ...
    @patch('graphit.decoding.universal.processor.Processor.launch')
    def test_run(self, mock_launch):
        """Test run function."""
        from graphit.decoding.universal.processor import run
        run()
