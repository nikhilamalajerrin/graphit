"""
Unit tests for graphit.decoding.pdf.pdf_decoder
"""
...
from graphit.decoding.pdf.pdf_decoder import Processor
from graphit.schema import Document, TextDocument, Metadata
...
class TestPdfDecoderProcessor(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.base.librarian_client.Consumer')
    @patch('graphit.base.librarian_client.Producer')
    @patch('graphit.decoding.pdf.pdf_decoder.PyPDFLoader')
    @patch('graphit.base.async_processor.AsyncProcessor', MockAsyncProcessor)
    ...
    @patch('graphit.decoding.pdf.pdf_decoder.Processor.launch')
    def test_run(self, mock_launch):
        """Test run function"""
        from graphit.decoding.pdf.pdf_decoder import run
        run()
