...
from graphit.schema import GraphRagQuery, GraphRagResponse
    ...
    async def test_non_streaming_sends_chunk_then_provenance_messages(self, mock_graph_rag_class):
        ...
        async def mock_query(**kwargs):
            ...
            if explain_callback:
                ...
                await explain_callback([], "urn:graphit:session:test")
                await explain_callback([], "urn:graphit:prov:retrieval:test")
                await explain_callback([], "urn:graphit:prov:selection:test")
                await explain_callback([], "urn:graphit:prov:answer:test")
