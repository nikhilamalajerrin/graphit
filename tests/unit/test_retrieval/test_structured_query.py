...
from graphit.retrieval.structured_query.service import Processor
...
class TestStructuredQueryHelperFunctions:
    ...
    def test_service_logging_integration(self):
        ...
        # Import the logger
        from graphit.retrieval.structured_query.service import logger
        
        assert logger.name == "graphit.retrieval.structured_query.service"
        
    def test_default_values(self):
        """Test default configuration values"""
        from graphit.retrieval.structured_query.service import default_ident
