...
from graphit.retrieval.document_rag.rag import Processor
from graphit.schema import DocumentRagQuery, DocumentRagResponse


class TestDocumentRagService:
    """Test DocumentRAG service parameter passing"""

    @patch('graphit.retrieval.document_rag.rag.DocumentRag')
    @pytest.mark.asyncio
    async def test_collection_parameter_passed_to_query(self, mock_document_rag_class):
        ...
        was ignored, causing wrong collection names like 'd_graphit_default_384'
