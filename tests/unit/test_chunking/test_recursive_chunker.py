"""
Unit tests for graphit.chunking.recursive
...
from graphit.chunking.recursive.chunker import Processor
from graphit.schema import TextDocument, Chunk, Metadata
...
class TestRecursiveChunkerSimple(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.base.librarian_client.Consumer')
    @patch('graphit.base.librarian_client.Producer')
    @patch('graphit.chunking.recursive.chunker.RecursiveCharacterTextSplitter')
    @patch('graphit.base.async_processor.AsyncProcessor', MockAsyncProcessor)
