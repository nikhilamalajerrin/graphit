...
from graphit.schema import TextDocument, Metadata
from graphit.chunking.recursive.chunker import Processor as RecursiveChunker
from graphit.chunking.token.chunker import Processor as TokenChunker
...
def mock_async_processor_init():
    ...
    with patch('graphit.base.async_processor.AsyncProcessor.__init__', init_mock):
        yield