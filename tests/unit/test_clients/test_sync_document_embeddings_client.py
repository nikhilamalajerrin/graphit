"""
Unit tests for graphit.clients.document_embeddings_client
...
from graphit.clients.document_embeddings_client import DocumentEmbeddingsClient
from graphit.schema import DocumentEmbeddingsRequest, DocumentEmbeddingsResponse


class TestSyncDocumentEmbeddingsClient:
    """Test synchronous document embeddings client functionality"""

    @patch('graphit.clients.document_embeddings_client.BaseClient.__init__')
