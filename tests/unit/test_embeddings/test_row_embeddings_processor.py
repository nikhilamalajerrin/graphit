"""
Unit tests for graphit.embeddings.row_embeddings.embeddings
...
class TestRowEmbeddingsProcessor(IsolatedAsyncioTestCase):
    ...
    async def test_processor_initialization(self):
        ...
        from graphit.embeddings.row_embeddings.embeddings import Processor
    ...
    async def test_on_message_drops_unknown_collection(self):
        ...
        from graphit.embeddings.row_embeddings.embeddings import Processor
        from graphit.schema import ExtractedObject
    ...
    async def test_on_message_processes_embeddings(self):
        ...
        from graphit.embeddings.row_embeddings.embeddings import Processor
        from graphit.schema import ExtractedObject, RowSchema, Field
        import json
