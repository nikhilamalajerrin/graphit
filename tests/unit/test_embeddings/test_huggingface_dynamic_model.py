...
# Skip all tests in this module if graphit.embeddings.hf is not installed
pytest.importorskip("graphit.embeddings.hf")

from graphit.embeddings.hf.hf import Processor
...
class TestHuggingFaceDynamicModelLoading(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.base.embeddings_service.EmbeddingsService.__init__')
