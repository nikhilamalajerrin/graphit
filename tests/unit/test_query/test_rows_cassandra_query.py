...
from graphit.query.rows.cassandra.service import Processor
from graphit.schema import RowsQueryRequest, RowsQueryResponse, GraphQLError
from graphit.schema import RowSchema, Field
...
class TestUnifiedTableQueries:
    ...
    @pytest.mark.asyncio
    @patch('graphit.query.rows.cassandra.service.async_execute_paged', new_callable=AsyncMock)
    ...
    @pytest.mark.asyncio
    @patch('graphit.query.rows.cassandra.service.async_scan', new_callable=AsyncMock)
