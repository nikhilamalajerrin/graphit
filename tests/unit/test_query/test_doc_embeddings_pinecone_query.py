...
from graphit.query.doc_embeddings.pinecone.service import Processor
...
class TestPineconeDocEmbeddingsQueryProcessor:
    ...
    def processor(self):
        ...
        with patch('graphit.query.doc_embeddings.pinecone.service.Pinecone') as mock_pinecone_class:
    ...
    @patch('graphit.query.doc_embeddings.pinecone.service.Pinecone')
    @patch('graphit.query.doc_embeddings.pinecone.service.default_api_key', 'env-api-key')
    ...
    @patch('graphit.query.doc_embeddings.pinecone.service.PineconeGRPC')
    ...
    @patch('graphit.query.doc_embeddings.pinecone.service.default_api_key', 'not-specified')
    ...
    def test_add_args_method(self):
        ...
        with patch('graphit.query.doc_embeddings.pinecone.service.DocumentEmbeddingsQueryService.add_args') as mock_parent_add_args:
    ...
    def test_add_args_with_custom_values(self):
        ...
        with patch('graphit.query.doc_embeddings.pinecone.service.DocumentEmbeddingsQueryService.add_args'):
            Processor.add_args(parser)
    ...
    @patch('graphit.query.doc_embeddings.pinecone.service.Processor.launch')
    def test_run_function(self, mock_launch):
        """Test the run function calls Processor.launch with correct parameters"""
        from graphit.query.doc_embeddings.pinecone.service import run, default_ident
