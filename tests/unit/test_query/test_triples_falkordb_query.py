...
from graphit.query.triples.falkordb.service import Processor
...
class TestFalkorDBQueryProcessor:
    ...
    def processor(self):
        ...
        with patch('graphit.query.triples.falkordb.service.FalkorDB'):
            return Processor(
                taskgroup=MagicMock(),
    ...
    @patch('graphit.query.triples.falkordb.service.FalkorDB')
    ...
    def test_add_args_method(self):
        ...
        with patch('graphit.query.triples.falkordb.service.TriplesQueryService.add_args') as mock_parent_add_args:
    ...
    def test_add_args_with_custom_values(self):
        ...
        with patch('graphit.query.triples.falkordb.service.TriplesQueryService.add_args'):
            Processor.add_args(parser)
    ...
    @patch('graphit.query.triples.falkordb.service.Processor.launch')
    def test_run_function(self, mock_launch):
        """Test the run function calls Processor.launch with correct parameters"""
        from graphit.query.triples.falkordb.service import run, default_ident
