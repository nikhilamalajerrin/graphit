"""
Unit tests for graphit.query.graph_embeddings.qdrant.service
...
from graphit.query.graph_embeddings.qdrant.service import Processor
from graphit.schema import IRI, LITERAL, EntityMatch


class TestQdrantGraphEmbeddingsQuery(IsolatedAsyncioTestCase):
    """Test Qdrant graph embeddings query functionality"""

    @patch('graphit.query.graph_embeddings.qdrant.service.QdrantClient')
    @patch('graphit.base.GraphEmbeddingsQueryService.__init__')
    ...
    async def test_add_args_calls_parent(self, mock_base_init, mock_qdrant_client):
        ...
        # Act
        with patch('graphit.base.GraphEmbeddingsQueryService.add_args') as mock_parent_add_args:
