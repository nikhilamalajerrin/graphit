...
from graphit.query.doc_embeddings.milvus.service import Processor
from graphit.schema import DocumentEmbeddingsRequest, ChunkMatch
...
class TestMilvusDocEmbeddingsQueryProcessor:
    ...
    def processor(self):
        ...
        with patch('graphit.query.doc_embeddings.milvus.service.DocVectors') as mock_doc_vectors:
    ...
    @patch('graphit.query.doc_embeddings.milvus.service.DocVectors')
    ...
    def test_add_args_method(self):
        ...
        with patch('graphit.query.doc_embeddings.milvus.service.DocumentEmbeddingsQueryService.add_args') as mock_parent_add_args:
    ...
    def test_add_args_with_custom_values(self):
        ...
        with patch('graphit.query.doc_embeddings.milvus.service.DocumentEmbeddingsQueryService.add_args'):
            Processor.add_args(parser)
    ...
    @patch('graphit.query.doc_embeddings.milvus.service.Processor.launch')
    def test_run_function(self, mock_launch):
        """Test the run function calls Processor.launch with correct parameters"""
        from graphit.query.doc_embeddings.milvus.service import run, default_ident
