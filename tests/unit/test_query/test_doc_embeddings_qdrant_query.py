"""
Unit tests for graphit.query.doc_embeddings.qdrant.service
...
from graphit.query.doc_embeddings.qdrant.service import Processor
...
class TestQdrantDocEmbeddingsQuery(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.query.doc_embeddings.qdrant.service.QdrantClient')
    @patch('graphit.base.DocumentEmbeddingsQueryService.__init__')
    ...
    async def test_add_args_calls_parent(self, mock_base_init, mock_qdrant_client):
        ...
        # Act
        with patch('graphit.base.DocumentEmbeddingsQueryService.add_args') as mock_parent_add_args:
