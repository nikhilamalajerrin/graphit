...
from graphit.query.graph_embeddings.milvus.service import Processor
from graphit.schema import Term, GraphEmbeddingsRequest, IRI, LITERAL, EntityMatch
...
class TestMilvusGraphEmbeddingsQueryProcessor:
    ...
    def processor(self):
        ...
        with patch('graphit.query.graph_embeddings.milvus.service.EntityVectors') as mock_entity_vectors:
    ...
    @patch('graphit.query.graph_embeddings.milvus.service.EntityVectors')
    ...
    def test_add_args_method(self):
        ...
        with patch('graphit.query.graph_embeddings.milvus.service.GraphEmbeddingsQueryService.add_args') as mock_parent_add_args:
    ...
    def test_add_args_with_custom_values(self):
        ...
        with patch('graphit.query.graph_embeddings.milvus.service.GraphEmbeddingsQueryService.add_args'):
            Processor.add_args(parser)
    ...
    @patch('graphit.query.graph_embeddings.milvus.service.Processor.launch')
    def test_run_function(self, mock_launch):
        """Test the run function calls Processor.launch with correct parameters"""
        from graphit.query.graph_embeddings.milvus.service import run, default_ident
