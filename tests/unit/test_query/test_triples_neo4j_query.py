...
from graphit.query.triples.neo4j.service import Processor
...
class TestNeo4jQueryProcessor:
    ...
    def processor(self):
        ...
        with patch('graphit.query.triples.neo4j.service.GraphDatabase'):
            return Processor(
                taskgroup=MagicMock(),
                id='test-neo4j-query',
    ...
    @patch('graphit.query.triples.neo4j.service.GraphDatabase')
    ...
    def test_add_args_method(self):
        ...
        with patch('graphit.query.triples.neo4j.service.TriplesQueryService.add_args') as mock_parent_add_args:
    ...
    def test_add_args_with_custom_values(self):
        ...
        with patch('graphit.query.triples.neo4j.service.TriplesQueryService.add_args'):
            Processor.add_args(parser)
    ...
    @patch('graphit.query.triples.neo4j.service.Processor.launch')
    def test_run_function(self, mock_launch):
        """Test the run function calls Processor.launch with correct parameters"""
        from graphit.query.triples.neo4j.service import run, default_ident
