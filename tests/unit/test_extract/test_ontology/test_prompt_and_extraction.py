...
from graphit.schema.core.primitives import Triple, Term, IRI, LITERAL
...
class TestTripleParsing:
    ...
    def test_parse_simple_triple_dict(self, extractor, sample_ontology_subset):
        ...
        assert validated[0].s.iri == "https://graphit.ai/food/cornish-pasty"
    ...
    def test_expands_uris_in_parsed_triples(self, extractor, sample_ontology_subset):
        ...
        assert validated[0].s.iri.startswith("https://graphit.ai/food/")
