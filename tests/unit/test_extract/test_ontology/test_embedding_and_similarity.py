...
from graphit.extract.kg.ontology.ontology_embedder import (
    OntologyEmbedder,
    OntologyElementMetadata
)
from graphit.extract.kg.ontology.ontology_loader import (
    Ontology,
    OntologyClass,
    OntologyProperty
)
from graphit.extract.kg.ontology.vector_store import InMemoryVectorStore, SearchResult
from graphit.extract.kg.ontology.text_processor import TextSegment
from graphit.extract.kg.ontology.ontology_selector import OntologySelector, OntologySubset
