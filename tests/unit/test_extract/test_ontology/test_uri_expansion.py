...
import pytest
from graphit.extract.kg.ontology.extract import Processor
from graphit.extract.kg.ontology.ontology_selector import OntologySubset
...
class TestURIExpansion:
    ...
    def test_fallback_uri_for_instance(self, extractor, ontology_subset_with_uris):
        ...
        assert result.startswith("https://graphit.ai/food/"), \
            "Entity instance should get constructed URI under graphit.ai domain"
    ...
    def test_class_without_uri_gets_fallback(self, extractor):
        ...
        assert result == "https://graphit.ai/ontology/test#SomeClass", \
    ...
    def test_property_without_uri_gets_fallback(self, extractor):
        ...
        assert result == "https://graphit.ai/ontology/test#someProperty", \
    ...
    def test_entity_normalization_in_constructed_uri(self, extractor, ontology_subset_with_uris):
        ...
        assert result == "https://graphit.ai/food/cornish-pasty-recipe", \
