...
from graphit.extract.kg.ontology.triple_converter import TripleConverter
from graphit.extract.kg.ontology.ontology_selector import (
    OntologySelector,
    OntologySubset,
)
...
from graphit.extract.kg.ontology.simplified_parser import (
    Relationship,
    Attribute,
)
