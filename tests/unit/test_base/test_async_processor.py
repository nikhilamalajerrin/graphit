"""
Unit tests for graphit.base.async_processor
...
class TestAsyncProcessorSimple(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.base.async_processor.get_pubsub')
    @patch('graphit.base.async_processor.Consumer')
    @patch('graphit.base.async_processor.ProcessorMetrics')
    @patch('graphit.base.async_processor.ConsumerMetrics')
