...
def processor():
    ...
    with patch('graphit.base.async_processor.get_pubsub') as mock_pubsub, \
         patch('graphit.base.async_processor.Consumer') as mock_consumer, \
         patch('graphit.base.async_processor.ProcessorMetrics') as mock_pm, \
         patch('graphit.base.async_processor.ConsumerMetrics') as mock_cm:
        ...
        from graphit.base.async_processor import AsyncProcessor
        p = AsyncProcessor(
            id="test-processor",
            taskgroup=AsyncMock(),
        )
