"""
Unit tests for graphit.base.document_embeddings_client
...
from graphit.base.document_embeddings_client import DocumentEmbeddingsClient, DocumentEmbeddingsClientSpec
from graphit.schema import DocumentEmbeddingsRequest, DocumentEmbeddingsResponse, Error


class TestDocumentEmbeddingsClient(IsolatedAsyncioTestCase):
    """Test async document embeddings client functionality"""

    @patch('graphit.base.request_response_spec.RequestResponse.__init__')
    ...
    async def test_query_logging(self, mock_parent_init):
        ...
        # Act
        with patch('graphit.base.document_embeddings_client.logger') as mock_logger:
            result = await client.query(vector=[0.1, 0.2, 0.3])
...
class TestDocumentEmbeddingsClientSpec(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.base.request_response_spec.RequestResponseSpec.__init__')
