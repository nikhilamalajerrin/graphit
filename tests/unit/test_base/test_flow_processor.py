"""
Unit tests for graphit.base.flow_processor
"""
...
from graphit.base.flow_processor import FlowProcessor
...
ASYNC_PROCESSOR_PATCHES = [
    patch('graphit.base.async_processor.get_pubsub', return_value=MagicMock()),
    patch('graphit.base.async_processor.ProcessorMetrics', return_value=MagicMock()),
    patch('graphit.base.async_processor.Consumer', return_value=MagicMock()),
]
...
class TestFlowProcessorSimple(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.base.flow_processor.Flow')
    @with_async_processor_patches
    ...
    @with_async_processor_patches
    @patch('graphit.base.workspace_processor.WorkspaceProcessor.start')
    ...
    async def test_add_args_calls_parent(self):
        ...
        with patch('graphit.base.async_processor.AsyncProcessor.add_args') as mock_parent_add_args:
