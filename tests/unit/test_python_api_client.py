"""
Unit tests for GraphIt Python API client library
...
class TestErrorHandling:
    ...
    def test_protocol_exception_on_non_200(self, mock_post):
        ...
        from graphit.api.exceptions import ProtocolException
    ...
    def test_application_exception_on_error_response(self, mock_post):
        ...
        from graphit.api.exceptions import ApplicationException
