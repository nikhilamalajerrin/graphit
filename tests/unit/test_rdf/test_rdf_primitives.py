...
from graphit.schema import Term, Triple, IRI, BLANK, LITERAL, TRIPLE
...
class TestQuotedTriple:
    ...
    def test_quoted_triple_as_object(self):
        ...
        outer = Triple(
            ...
            p=Term(type=IRI, iri="http://graphit.ai/tg/contains"),
...
class TestKnowledgeDefs:
    ...
    def test_uri_type(self):
        from graphit.knowledge.defs import Uri
    ...
    def test_literal_type(self):
        from graphit.knowledge.defs import Literal
    ...
    def test_quoted_triple_type(self):
        from graphit.knowledge.defs import QuotedTriple, Uri, Literal
        qt = QuotedTriple(
