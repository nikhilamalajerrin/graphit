"""
Unit tests for graphit.model.text_completion.vertexai
...
class TestVertexAIProcessorSimple(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.model.text_completion.vertexai.llm.genai')
    @patch('graphit.model.text_completion.vertexai.llm.service_account')
    @patch('graphit.base.async_processor.AsyncProcessor.__init__')
    @patch('graphit.base.llm_service.LlmService.__init__')
    ...
    async def test_generate_content_rate_limit_error(self, mock_llm_init, mock_async_init, mock_service_account, mock_genai):
        ...
        from graphit.exceptions import TooManyRequests
    ...
    @patch('graphit.model.text_completion.vertexai.llm.google.auth.default')
    @patch('graphit.model.text_completion.vertexai.llm.genai')
    @patch('graphit.model.text_completion.vertexai.llm.service_account')
    @patch('graphit.base.async_processor.AsyncProcessor.__init__')
    @patch('graphit.base.llm_service.LlmService.__init__')
    ...
    @patch('graphit.model.text_completion.vertexai.llm.AnthropicVertex')
    @patch('graphit.model.text_completion.vertexai.llm.genai')
    @patch('graphit.model.text_completion.vertexai.llm.service_account')
    @patch('graphit.base.async_processor.AsyncProcessor.__init__')
    @patch('graphit.base.llm_service.LlmService.__init__')
