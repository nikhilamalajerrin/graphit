...
from graphit.model.text_completion.googleaistudio.llm import Processor as GoogleAIProcessor
...
class TestParameterCaching(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.model.text_completion.googleaistudio.llm.genai')
