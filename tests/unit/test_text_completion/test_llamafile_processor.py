"""
Unit tests for graphit.model.text_completion.llamafile
...
from graphit.model.text_completion.llamafile.llm import Processor
...
class TestLlamaFileProcessorSimple(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.model.text_completion.llamafile.llm.OpenAI')
