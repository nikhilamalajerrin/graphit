"""
Unit tests for graphit.model.text_completion.bedrock
...
from graphit.model.text_completion.bedrock.llm import Processor, Mistral, Anthropic
...
class TestBedrockProcessorSimple(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.model.text_completion.bedrock.llm.boto3.Session')
