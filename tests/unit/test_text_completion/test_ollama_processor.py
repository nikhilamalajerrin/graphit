"""
Unit tests for graphit.model.text_completion.ollama
...
from graphit.model.text_completion.ollama.llm import Processor
...
class TestOllamaProcessorSimple(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.model.text_completion.ollama.llm.AsyncClient')
