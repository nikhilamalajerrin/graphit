"""
Unit tests for graphit.model.text_completion.lmstudio
...
from graphit.model.text_completion.lmstudio.llm import Processor
...
class TestLMStudioProcessorSimple(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.model.text_completion.lmstudio.llm.OpenAI')
