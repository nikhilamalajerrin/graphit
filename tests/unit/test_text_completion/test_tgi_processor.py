"""
Unit tests for graphit.model.text_completion.tgi
...
from graphit.model.text_completion.tgi.llm import Processor
...
class TestTGIProcessorSimple(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.model.text_completion.tgi.llm.aiohttp.ClientSession')
