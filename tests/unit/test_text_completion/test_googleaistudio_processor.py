"""
Unit tests for graphit.model.text_completion.googleaistudio
...
from graphit.model.text_completion.googleaistudio.llm import Processor
...
class TestGoogleAIStudioProcessorSimple(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.model.text_completion.googleaistudio.llm.genai.Client')
