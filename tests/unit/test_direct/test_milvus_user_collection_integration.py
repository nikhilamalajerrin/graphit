...
from graphit.direct.milvus_doc_embeddings import DocVectors, make_safe_collection_name
from graphit.direct.milvus_graph_embeddings import EntityVectors


class TestMilvusUserCollectionIntegration:
    """Test cases for Milvus user/collection integration functionality"""

    @patch('graphit.direct.milvus_doc_embeddings.MilvusClient')
    ...
    @patch('graphit.direct.milvus_graph_embeddings.MilvusClient')
