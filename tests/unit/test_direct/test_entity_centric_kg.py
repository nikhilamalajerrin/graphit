...
class TestEntityCentricKnowledgeGraph:
    ...
    def mock_cluster(self):
        ...
        with patch('graphit.direct.cassandra_kg.Cluster') as mock_cluster_cls:
    ...
    def entity_kg(self, mock_cluster):
        ...
        from graphit.direct.cassandra_kg import EntityCentricKnowledgeGraph
...
class TestQuadResult:
    ...
    def test_quad_result_stores_all_fields(self):
        ...
        from graphit.direct.cassandra_kg import QuadResult
...
class TestWriteHelperFunctions:
    ...
    def test_get_term_otype_for_iri(self):
        ...
        from graphit.storage.triples.cassandra.write import get_term_otype
        from graphit.schema import Term, IRI
    ...
    def test_get_term_otype_for_literal(self):
        ...
        from graphit.storage.triples.cassandra.write import get_term_otype
        from graphit.schema import Term, LITERAL
    ...
    def test_get_term_otype_for_blank(self):
        ...
        from graphit.storage.triples.cassandra.write import get_term_otype
        from graphit.schema import Term, BLANK
    ...
    def test_get_term_otype_for_triple(self):
        ...
        from graphit.storage.triples.cassandra.write import get_term_otype
        from graphit.schema import Term, TRIPLE
    ...
    def test_get_term_dtype_for_literal(self):
        ...
        from graphit.storage.triples.cassandra.write import get_term_dtype
        from graphit.schema import Term, LITERAL
    ...
    def test_get_term_lang_for_literal(self):
        ...
        from graphit.storage.triples.cassandra.write import get_term_lang
        from graphit.schema import Term, LITERAL
...
class TestServiceHelperFunctions:
    ...
    def test_create_term_with_uri_otype(self):
        ...
        from graphit.query.triples.cassandra.service import create_term
        from graphit.schema import IRI
    ...
    def test_create_term_with_literal_otype(self):
        ...
        from graphit.query.triples.cassandra.service import create_term
        from graphit.schema import LITERAL
    ...
    def test_create_term_with_triple_otype(self):
        ...
        from graphit.query.triples.cassandra.service import create_term
        from graphit.schema import TRIPLE, IRI
        import json
