...
class TestTriplesWriterConfiguration:
    ...
    @patch('graphit.direct.cassandra_kg.KnowledgeGraph')
    def test_environment_variable_configuration(self, mock_graphit):
    ...
    @patch('graphit.direct.cassandra_kg.KnowledgeGraph')
    def test_parameter_override_environment(self, mock_graphit):
    ...
    @patch('graphit.direct.cassandra_kg.KnowledgeGraph')
    def test_no_backward_compatibility_graph_params(self, mock_graphit):
    ...
    @patch('graphit.direct.cassandra_kg.KnowledgeGraph')
    def test_default_configuration(self, mock_graphit):
...
class TestTriplesQueryConfiguration:
    ...
    @patch('graphit.direct.cassandra_kg.KnowledgeGraph')
    def test_only_new_parameters_work(self, mock_graphit):
...
class TestConfigurationPriorityIntegration:
    ...
    @patch('graphit.direct.cassandra_kg.KnowledgeGraph')
    def test_complete_priority_chain(self, mock_graphit):
