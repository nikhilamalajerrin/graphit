...
from graphit.storage.graph_embeddings.milvus.write import Processor
from graphit.schema import Term, EntityEmbeddings, IRI, LITERAL
...
class TestMilvusGraphEmbeddingsStorageProcessor:
    ...
    def processor(self):
        ...
        with patch('graphit.storage.graph_embeddings.milvus.write.EntityVectors') as mock_entity_vectors:
    ...
    @patch('graphit.storage.graph_embeddings.milvus.write.EntityVectors')
    ...
    def test_add_args_method(self):
        ...
        with patch('graphit.storage.graph_embeddings.milvus.write.GraphEmbeddingsStoreService.add_args') as mock_parent_add_args:
    ...
    def test_add_args_with_custom_values(self):
        ...
        with patch('graphit.storage.graph_embeddings.milvus.write.GraphEmbeddingsStoreService.add_args'):
            Processor.add_args(parser)
    ...
    @patch('graphit.storage.graph_embeddings.milvus.write.Processor.launch')
    def test_run_function(self, mock_launch):
        """Test the run function calls Processor.launch with correct parameters"""
        from graphit.storage.graph_embeddings.milvus.write import run, default_ident
