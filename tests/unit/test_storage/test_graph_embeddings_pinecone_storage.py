...
from graphit.storage.graph_embeddings.pinecone.write import Processor
from graphit.schema import EntityEmbeddings, Value
...
class TestPineconeGraphEmbeddingsStorageProcessor:
    ...
    def processor(self):
        ...
        with patch('graphit.storage.graph_embeddings.pinecone.write.Pinecone') as mock_pinecone_class:
    ...
    @patch('graphit.storage.graph_embeddings.pinecone.write.Pinecone')
    @patch('graphit.storage.graph_embeddings.pinecone.write.default_api_key', 'env-api-key')
    ...
    @patch('graphit.storage.graph_embeddings.pinecone.write.PineconeGRPC')
    ...
    @patch('graphit.storage.graph_embeddings.pinecone.write.default_api_key', 'not-specified')
    ...
    def test_add_args_method(self):
        ...
        with patch('graphit.storage.graph_embeddings.pinecone.write.GraphEmbeddingsStoreService.add_args') as mock_parent_add_args:
    ...
    def test_add_args_with_custom_values(self):
        ...
        with patch('graphit.storage.graph_embeddings.pinecone.write.GraphEmbeddingsStoreService.add_args'):
            Processor.add_args(parser)
    ...
    @patch('graphit.storage.graph_embeddings.pinecone.write.Processor.launch')
    def test_run_function(self, mock_launch):
        """Test the run function calls Processor.launch with correct parameters"""
        from graphit.storage.graph_embeddings.pinecone.write import run, default_ident
