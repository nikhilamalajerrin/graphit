...
from graphit.storage.triples.falkordb.write import Processor
...
class TestFalkorDBStorageProcessor:
    ...
    def processor(self):
        ...
        with patch('graphit.storage.triples.falkordb.write.FalkorDB') as mock_falkordb:
    ...
    @patch('graphit.storage.triples.falkordb.write.FalkorDB')
    ...
    def test_add_args_method(self):
        ...
        with patch('graphit.storage.triples.falkordb.write.TriplesStoreService.add_args') as mock_parent_add_args:
    ...
    def test_add_args_with_custom_values(self):
        ...
        with patch('graphit.storage.triples.falkordb.write.TriplesStoreService.add_args'):
            Processor.add_args(parser)
    ...
    @patch('graphit.storage.triples.falkordb.write.Processor.launch')
    def test_run_function(self, mock_launch):
        """Test the run function calls Processor.launch with correct parameters"""
        from graphit.storage.triples.falkordb.write import run, default_ident
