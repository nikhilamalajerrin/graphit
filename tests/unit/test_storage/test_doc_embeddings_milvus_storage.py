...
from graphit.storage.doc_embeddings.milvus.write import Processor
...
class TestMilvusDocEmbeddingsStorageProcessor:
    ...
    def processor(self):
        ...
        with patch('graphit.storage.doc_embeddings.milvus.write.DocVectors') as mock_doc_vectors:
    ...
    @patch('graphit.storage.doc_embeddings.milvus.write.DocVectors')
    ...
    def test_add_args_method(self):
        ...
        with patch('graphit.storage.doc_embeddings.milvus.write.DocumentEmbeddingsStoreService.add_args') as mock_parent_add_args:
    ...
    def test_add_args_with_custom_values(self):
        ...
        with patch('graphit.storage.doc_embeddings.milvus.write.DocumentEmbeddingsStoreService.add_args'):
            Processor.add_args(parser)
    ...
    @patch('graphit.storage.doc_embeddings.milvus.write.Processor.launch')
    def test_run_function(self, mock_launch):
        """Test the run function calls Processor.launch with correct parameters"""
        from graphit.storage.doc_embeddings.milvus.write import run, default_ident
