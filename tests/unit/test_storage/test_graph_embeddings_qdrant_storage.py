"""
Unit tests for graphit.storage.graph_embeddings.qdrant.write
...
from graphit.storage.graph_embeddings.qdrant.write import Processor
...
class TestQdrantGraphEmbeddingsStorage(IsolatedAsyncioTestCase):
    ...
    @patch('graphit.storage.graph_embeddings.qdrant.write.QdrantClient')
    ...
    @patch('graphit.storage.graph_embeddings.qdrant.write.QdrantClient')
    @patch('graphit.storage.graph_embeddings.qdrant.write.uuid')
    ...
    async def test_add_args_calls_parent(self, mock_qdrant_client):
        ...
        # Act
        with patch('graphit.base.GraphEmbeddingsStoreService.add_args') as mock_parent_add_args:
