...
from graphit.storage.triples.memgraph.write import Processor
from graphit.schema import Term, Triple, IRI, LITERAL
...
class TestMemgraphStorageProcessor:
    ...
    def processor(self):
        ...
        with patch('graphit.storage.triples.memgraph.write.GraphDatabase') as mock_graph_db:
    ...
    @patch('graphit.storage.triples.memgraph.write.GraphDatabase')
    ...
    def test_add_args_method(self):
        ...
        with patch('graphit.storage.triples.memgraph.write.TriplesStoreService.add_args') as mock_parent_add_args:
    ...
    def test_add_args_with_custom_values(self):
        ...
        with patch('graphit.storage.triples.memgraph.write.TriplesStoreService.add_args'):
            Processor.add_args(parser)
    ...
    @patch('graphit.storage.triples.memgraph.write.Processor.launch')
    def test_run_function(self, mock_launch):
        """Test the run function calls Processor.launch with correct parameters"""
        from graphit.storage.triples.memgraph.write import run, default_ident
