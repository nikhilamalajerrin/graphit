...
from graphit.gateway.dispatch.core_export import CoreExport
from graphit.gateway.dispatch.core_import import CoreImport
...
class TestCoreExportWireFormat:
    ...
    @pytest.mark.asyncio
    @patch("graphit.gateway.dispatch.core_export.KnowledgeRequestor")
...
class TestCoreImportWireFormat:
    ...
    @pytest.mark.asyncio
    @patch("graphit.gateway.dispatch.core_import.KnowledgeRequestor")
