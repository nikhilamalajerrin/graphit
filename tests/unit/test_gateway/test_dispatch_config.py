...
from graphit.gateway.dispatch.config import ConfigRequestor

# Import parent class for local patching
from graphit.gateway.dispatch.requestor import ServiceRequestor


class TestConfigRequestor:
    """Test cases for ConfigRequestor class"""

    @patch('graphit.gateway.dispatch.config.TranslatorRegistry')
