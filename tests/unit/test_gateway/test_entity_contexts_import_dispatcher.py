...
from graphit.gateway.dispatch.entity_contexts_import import EntityContextsImport
from graphit.schema import EntityContexts, EntityContext, Metadata
...
class TestEntityContextsImportInitialization:
    ...
    @patch('graphit.gateway.dispatch.entity_contexts_import.Publisher')
