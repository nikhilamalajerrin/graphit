...
from graphit.gateway.dispatch.rows_import import RowsImport
from graphit.schema import Metadata, ExtractedObject
...
class TestRowsImportInitialization:
    ...
    @patch('graphit.gateway.dispatch.rows_import.Publisher')
...
class TestRowsImportRunMethod:
    ...
    @patch('graphit.gateway.dispatch.rows_import.Publisher')
    @patch('graphit.gateway.dispatch.rows_import.asyncio.sleep')
    @pytest.mark.asyncio
