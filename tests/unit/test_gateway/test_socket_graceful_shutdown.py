...
from graphit.gateway.endpoint.socket import SocketEndpoint
from graphit.gateway.running import Running
from graphit.gateway.auth import Identity
...
async def test_handle_exception_group_cleanup():
    ...
    with patch('aiohttp.web.WebSocketResponse') as mock_ws_class:
        ...
        with patch('asyncio.TaskGroup') as mock_task_group:
            ...
            with patch('graphit.gateway.endpoint.socket.asyncio.wait_for', new_callable=AsyncMock) as mock_wait_for:
