...
from graphit.gateway.dispatch.graph_embeddings_import import GraphEmbeddingsImport
from graphit.schema import GraphEmbeddings, EntityEmbeddings, Metadata
...
class TestGraphEmbeddingsImportInitialization:
    ...
    @patch('graphit.gateway.dispatch.graph_embeddings_import.Publisher')
