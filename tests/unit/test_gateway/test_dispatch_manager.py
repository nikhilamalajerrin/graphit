...
from graphit.gateway.dispatch.manager import DispatcherManager, DispatcherWrapper
...
class TestDispatcherManager:
    ...
    async def test_process_core_import(self):
        ...
        with patch('graphit.gateway.dispatch.manager.CoreImport') as mock_core_import:
            mock_importer = Mock()
    ...
    async def test_process_core_export(self):
        ...
        with patch('graphit.gateway.dispatch.manager.CoreExport') as mock_core_export:
            mock_exporter = Mock()
    ...
    async def test_invoke_global_service_creates_new_dispatcher(self):
        ...
        with patch('graphit.gateway.dispatch.manager.global_dispatchers') as mock_dispatchers:
    ...
    async def test_process_flow_import_with_valid_flow_and_kind(self):
        ...
        with patch('graphit.gateway.dispatch.manager.import_dispatchers') as mock_dispatchers, \
    ...
    async def test_process_flow_export_with_valid_flow_and_kind(self):
        ...
        with patch('graphit.gateway.dispatch.manager.export_dispatchers') as mock_dispatchers, \
             patch('uuid.uuid4') as mock_uuid:
            mock_uuid.return_value = "test-uuid"
            mock_dispatcher_class = Mock()
            mock_dispatcher = Mock()
    ...
    async def test_process_socket(self):
        ...
        with patch('graphit.gateway.dispatch.manager.Mux') as mock_mux:
    ...
    async def test_invoke_flow_service_creates_request_response_dispatcher(self):
        ...
        with patch('graphit.gateway.dispatch.manager.request_response_dispatchers') as mock_dispatchers:
            mock_dispatcher_class = Mock()
            mock_dispatcher = Mock()
            mock_dispatcher.start = AsyncMock()
            mock_dispatcher.process = AsyncMock(return_value="new_result")
    ...
    async def test_invoke_flow_service_creates_sender_dispatcher(self):
        ...
        with patch('graphit.gateway.dispatch.manager.request_response_dispatchers') as mock_rr_dispatchers, \
             patch('graphit.gateway.dispatch.manager.sender_dispatchers') as mock_sender_dispatchers:
