...
from graphit.rev_gateway.service import ReverseGateway, run


MOCK_PATCHES = [
    'graphit.rev_gateway.service.IamAuth',
    'graphit.rev_gateway.service.ConfigReceiver',
    'graphit.rev_gateway.service.MessageDispatcher',
    'graphit.rev_gateway.service.get_pubsub',
]
...
class TestReverseGateway:
    ...
    @patch(*MOCK_PATCHES[2:3])
    @patch(*MOCK_PATCHES[3:4])
    @patch('graphit.rev_gateway.service.ClientSession')
    @pytest.mark.asyncio
