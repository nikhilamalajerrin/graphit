...
from graphit.rev_gateway.dispatcher import MessageDispatcher
...
class TestMessageDispatcher:
    ...
    @patch('graphit.rev_gateway.dispatcher.DispatcherManager')
    ...
    async def test_handle_message_global_service(self):
        ...
        with patch(
            'graphit.gateway.dispatch.manager.global_dispatchers',
