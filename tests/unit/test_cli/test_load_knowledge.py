...
from graphit.cli.load_knowledge import KnowledgeLoader, main
...
"""
    ...
    @patch('graphit.cli.load_knowledge.Api')
...
class TestCLIArgumentParsing:
    ...
    @patch('graphit.cli.load_knowledge.KnowledgeLoader')
    @patch('graphit.cli.load_knowledge.time.sleep')
