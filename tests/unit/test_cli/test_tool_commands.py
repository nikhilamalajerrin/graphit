...
from graphit.cli.set_tool import set_tool, main as set_main, Argument
from graphit.cli.show_tools import show_config, main as show_main
...
class TestSetToolStructuredQuery:
    ...
    @patch('graphit.cli.set_tool.Api')
    ...
    def test_set_main_structured_query_with_collection(self):
        ...
        with patch('sys.argv', test_args), \
             patch('graphit.cli.set_tool.set_tool') as mock_set:
...
class TestShowToolsStructuredQuery:
    ...
    @patch('graphit.cli.show_tools.Api')
    ...
    def test_show_main_parses_args_correctly(self):
        ...
        with patch('sys.argv', test_args), \
             patch('graphit.cli.show_tools.show_config') as mock_show:
...
class TestStructuredQueryToolValidation:
    ...
    def test_structured_query_accepts_optional_collection(self):
        ...
        with patch('graphit.cli.set_tool.set_tool') as mock_set:
            test_args = [
                'gr-set-tool',
                '--id', 'test1',
                '--name', 'test_tool',
