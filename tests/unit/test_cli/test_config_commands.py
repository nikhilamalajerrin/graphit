...
from graphit.cli.list_config_items import list_config_items, main as list_main
from graphit.cli.get_config_item import get_config_item, main as get_main
from graphit.cli.put_config_item import put_config_item, main as put_main
from graphit.cli.delete_config_item import delete_config_item, main as delete_main
from graphit.api.types import ConfigKey, ConfigValue
...
class TestListConfigItems:
    ...
    @patch('graphit.cli.list_config_items.Api')
    ...
    def test_list_main_parses_args_correctly(self):
        ...
        with patch('sys.argv', test_args), \
             patch('graphit.cli.list_config_items.list_config_items') as mock_list:
...
class TestGetConfigItem:
    ...
    @patch('graphit.cli.get_config_item.Api')
    ...
    def test_get_main_parses_args_correctly(self):
        ...
        with patch('sys.argv', test_args), \
             patch('graphit.cli.get_config_item.get_config_item') as mock_get:
...
class TestPutConfigItem:
    ...
    @patch('graphit.cli.put_config_item.Api')
    ...
    def test_put_main_with_value_arg(self):
        ...
        with patch('sys.argv', test_args), \
             patch('graphit.cli.put_config_item.put_config_item') as mock_put:
...
class TestDeleteConfigItem:
    ...
    @patch('graphit.cli.delete_config_item.Api')
    ...
    def test_delete_main_parses_args_correctly(self):
        ...
        with patch('sys.argv', test_args), \
             patch('graphit.cli.delete_config_item.delete_config_item') as mock_delete:
...
def list_main_with_args(args):
    ...
    test_args = ['gr-list-config-items'] + args
    with patch('sys.argv', test_args):
        try:
            list_main()
        except SystemExit:
...
def get_main_with_args(args):
    ...
    test_args = ['gr-get-config-item'] + args
    with patch('sys.argv', test_args):
        try:
            get_main()
        except SystemExit:
...
def put_main_with_args(args):
    ...
    test_args = ['gr-put-config-item'] + args
    with patch('sys.argv', test_args):
        try:
            put_main()
        except SystemExit:
...
def delete_main_with_args(args):
    ...
    test_args = ['gr-delete-config-item'] + args
    with patch('sys.argv', test_args):
        try:
            delete_main()
        except SystemExit:
