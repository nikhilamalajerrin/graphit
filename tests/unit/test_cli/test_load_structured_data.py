"""
Unit tests for gr-load-structured-data CLI command.
...
<ROOT>
    ...
    def test_suggest_schema_file_processing(self):
        ...
        pytest.skip("Schema suggestion requires GraphIt API connection")
    ...
    def test_generate_descriptor_file_processing(self):
        ...
        pytest.skip("Descriptor generation requires GraphIt API connection")
