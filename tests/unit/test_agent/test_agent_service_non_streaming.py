...
from graphit.agent.react.service import Processor
from graphit.schema import AgentRequest, AgentResponse
from graphit.agent.react.types import Final


class TestAgentServiceNonStreaming:
    """Test Agent service non-streaming behavior"""

    @patch('graphit.agent.react.service.AgentManager')
    @pytest.mark.asyncio
