...
from graphit.schema import Triple, Term, IRI, LITERAL, TRIPLE

from graphit.provenance.triples import (
    set_graph,
    document_triples,
...
class TestSubgraphProvenanceTriples:
    ...
    SG_URI = "https://graphit.ai/subgraph/test-sg"
...
class TestQuestionTriples:
    ...
    Q_URI = "urn:graphit:question:test-session"
...
class TestGroundingTriples:
    ...
    GND_URI = "urn:graphit:prov:grounding:test-session"
    Q_URI = "urn:graphit:question:test-session"
...
class TestExplorationTriples:
    ...
    EXP_URI = "urn:graphit:prov:exploration:test-session"
    GND_URI = "urn:graphit:prov:grounding:test-session"
...
class TestFocusTriples:
    ...
    FOC_URI = "urn:graphit:prov:focus:test-session"
    EXP_URI = "urn:graphit:prov:exploration:test-session"
...
class TestSynthesisTriples:
    ...
    SYN_URI = "urn:graphit:prov:synthesis:test-session"
    FOC_URI = "urn:graphit:prov:focus:test-session"
    ...
    def test_synthesis_with_document_reference(self):
        triples = synthesis_triples(
            ...
            document_id="urn:graphit:question:abc/answer",
        )
        doc = find_triple(triples, TG_DOCUMENT, self.SYN_URI)
        assert doc is not None
        assert doc.o.type == IRI
        assert doc.o.iri == "urn:graphit:question:abc/answer"
...
class TestDocRagQuestionTriples:
    ...
    Q_URI = "urn:graphit:docrag:test-session"
...
class TestDocRagExplorationTriples:
    ...
    EXP_URI = "urn:graphit:docrag:test/exploration"
    GND_URI = "urn:graphit:docrag:test/grounding"
...
class TestDocRagSynthesisTriples:
    ...
    SYN_URI = "urn:graphit:docrag:test/synthesis"
    EXP_URI = "urn:graphit:docrag:test/exploration"
