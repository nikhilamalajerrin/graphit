...
This document describes streaming behavior for GraphIt WebSocket services.

## Overview

Many GraphIt services support streaming responses, where a single request results in multiple response messages sent progressively over time. This enables:
