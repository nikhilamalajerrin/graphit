# Unit Testing Strategy for GraphIt Microservices

## Overview

This document outlines the unit testing strategy for the GraphIt microservices architecture. The approach focuses on testing business logic while mocking external infrastructure to ensure fast, reliable, and maintainable tests.
...
from graphit.model.text_completion.openai import Processor
...
This testing strategy ensures that GraphIt microservices are thoroughly tested without relying on external infrastructure. By focusing on business logic and mocking external dependencies, we achieve fast, reliable tests that provide confidence in code quality while maintaining development velocity.
