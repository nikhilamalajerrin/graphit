...
você mantém a propriedade total do seu trabalho. Ele simplesmente concede ao projeto GraphIt
...
e você só precisa fazer isso uma vez em todos os repositórios do GraphIt.

Contribuindo como um **indivíduo**? Assine o [CLA Individual](https://github.com/graphit-ai/contributor-license-agreement/blob/main/Fiduciary-Contributor-License-Agreement.md)
Contribuindo em nome de uma **empresa ou organização**? Assine o [CLA para Entidades](https://github.com/graphit-ai/contributor-license-agreement/blob/main/Entity-Fiduciary-Contributor-License-Agreement.md)
