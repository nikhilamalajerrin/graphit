...
يتم إنشاء وثائق واجهة برمجة تطبيقات Python من سلاسل التوثيق باستخدام نص برمجي Python مخصص يقوم بتحليل حزمة `graphit.api`.

### المتطلبات الأساسية

يجب أن تكون حزمة graphit قابلة للاستيراد. إذا كنت تعمل في بيئة تطوير:
...
تعرض الوثائق التي تم إنشاؤها واجهة برمجة التطبيقات العامة تمامًا كما يستوردها المستخدمون من `graphit.api`، دون الكشف عن هيكل الوحدة الداخلية.
