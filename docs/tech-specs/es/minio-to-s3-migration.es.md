...
**Ubicación**: `graphit-flow/graphit/librarian/blob_store.py`
**Operaciones**:
...
### Archivos Clave
1. `graphit-flow/graphit/librarian/blob_store.py` - Implementación de BlobStore.
2. `graphit-flow/graphit/librarian/librarian.py` - Inicialización de BlobStore.
3. `graphit-flow/graphit/librarian/service.py` - Configuración del servicio.
4. `graphit-flow/pyproject.toml` - Dependencias (paquete `minio`).
