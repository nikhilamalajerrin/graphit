...
Esta especificación aborda los problemas de rendimiento en la implementación de la base de conocimiento GraphIt Cassandra y propone optimizaciones para el almacenamiento y la consulta de triples RDF.

## Implementación Actual

### Diseño del Esquema

La implementación actual utiliza un diseño de tabla única en `graphit-flow/graphit/direct/cassandra_kg.py`:
...
**Archivo: `graphit-flow/graphit/direct/cassandra_kg.py`**
...
**Ruta de Escritura:** `graphit-flow/graphit/storage/triples/cassandra/write.py`
**Ruta de Consulta:** `graphit-flow/graphit/query/triples/cassandra/service.py`
**Almacén de Conocimiento:** `graphit-flow/graphit/tables/knowledge.py`
...
**`graphit-flow/graphit/direct/cassandra_kg.py`** - Se requiere una reescritura completa.
