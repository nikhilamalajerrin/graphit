...
El sistema GraphIt utiliza una **arquitectura basada en flujos** para la resolución dinámica de colas, lo que inherentemente admite la multi-inquilinización:
...
**Archivo:** `graphit-base/graphit/base/async_processor.py`
**Línea:** 260-264
...
**Archivo:** `graphit-flow/graphit/config/service/service.py`
**Línea:** 276-279
...
**Archivo:** `graphit-base/graphit/base/cassandra_config.py`
...
**Archivo:** `graphit-flow/graphit/cores/service.py`
...
**Archivo:** `graphit-flow/graphit/librarian/service.py`
...
**Archivo:** `graphit-flow/graphit/librarian/collection_manager.py`
...
from graphit.schema.services.config import ConfigRequest, ConfigResponse
...
**Archivo:** `graphit-flow/graphit/tables/library.py`
...
**Archivo:** `graphit-base/graphit/schema/services/collection.py`
...
graph-embeddings \
  ...
  --pulsar-api-key <KEY> \
  --config-push-queue persistent://gr-dev/config/config
...
1. **Servicio de Consulta de Triples** (`graphit-flow/graphit/query/triples/cassandra/service.py:65`)
   Utiliza `keyspace=query.user`
2. **Servicio de Consulta de Objetos** (`graphit-flow/graphit/query/objects/cassandra/service.py:479`)
   Utiliza `keyspace=self.sanitize_name(user)`
3. **Acceso Directo al Gráfico de Conocimiento** (`graphit-flow/graphit/direct/cassandra_kg.py:18`)
   Parámetro predeterminado `keyspace="graphit"`
...
## Referencias
Problema de GitHub: https://github.com/example.com/graphit/issues/582
Archivos relacionados:
  `graphit-base/graphit/base/async_processor.py`
  `graphit-base/graphit/base/cassandra_config.py`
  `graphit-base/graphit/schema/core/topic.py`
  `graphit-base/graphit/schema/services/collection.py`
  `graphit-flow/graphit/config/service/service.py`
  `graphit-flow/graphit/cores/service.py`
  `graphit-flow/graphit/librarian/service.py`
  `graphit-flow/graphit/librarian/collection_manager.py`
  `graphit-flow/graphit/tables/library.py`
