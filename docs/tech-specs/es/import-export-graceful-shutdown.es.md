...
**Archivo**: `graphit-base/graphit/base/publisher.py`
...
**Archivo**: `graphit-flow/graphit/gateway/dispatch/triples_import.py`
...
**Archivo**: `graphit-base/graphit/base/subscriber.py`
...
**Archivo**: `graphit-flow/graphit/gateway/dispatch/triples_export.py`
...
**Archivo**: `graphit-flow/graphit/gateway/endpoint/socket.py`
