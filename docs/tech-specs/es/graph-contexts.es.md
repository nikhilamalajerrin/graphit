...
Esta especificación describe los cambios en los primitivos de grafos centrales de GraphIt para
...
La clase `Value` actual en `graphit-base/graphit/schema/core/primitives.py`
puede representar:
...
#### Este repositorio (graphit)

- **Primitivos del esquema** (`graphit-base/graphit/schema/core/primitives.py`)
...
- **Traductores de mensajes** (`graphit-base/graphit/messaging/translators/`)
