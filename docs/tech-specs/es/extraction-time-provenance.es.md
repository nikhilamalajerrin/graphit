...
`graphit-flow/graphit/librarian/librarian.py`: operaciones principales del bibliotecario.
`graphit-flow/graphit/librarian/service.py`: procesador de servicios, carga de documentos.
`graphit-flow/graphit/tables/library.py`: almacén de tablas de Cassandra.
`graphit-base/graphit/schema/services/library.py`: definiciones de esquema.
...
`graphit-flow/graphit/librarian/librarian.py`: Operaciones principales de "Librarian".
`graphit-flow/graphit/librarian/service.py`: Procesador de servicios, carga de documentos.
`graphit-flow/graphit/tables/library.py`: Almacén de tablas de Cassandra.
`graphit-base/graphit/schema/services/library.py`: Definiciones de esquema.
...
#### Extensiones del Espacio de Nombres de GraphIt
