...
en GraphIt. El streaming permite la entrega en tiempo real de tokens generados
...
Esquema actual (`graphit-base/graphit/schema/services/llm.py`):
...
##### Esquema de LLM (`graphit-base/graphit/schema/services/llm.py`)
...
##### Esquema de la solicitud (`graphit-base/graphit/schema/services/prompt.py`)
...
**Actualizaciones de LlmClient** (`graphit-base/graphit/clients/llm_client.py`):
...
**Actualizaciones de PromptClient** (`graphit-base/graphit/base/prompt_client.py`):
...
El mismo patrón que `gr-invoke-llm`.
...
**Módulo:** `graphit-vertexai/graphit/model/text_completion/vertexai/llm.py`
...
|----------|---------|-------------------|
| OpenAI | graphit-flow | Completo (API de streaming nativo) |
| Claude/Anthropic | graphit-flow | Completo (API de streaming nativo) |
| Ollama | graphit-flow | Completo (API de streaming nativo) |
| Cohere | graphit-flow | Completo (API de streaming nativo) |
| Mistral | graphit-flow | Completo (API de streaming nativo) |
| Azure OpenAI | graphit-flow | Completo (API de streaming nativo) |
| Google AI Studio | graphit-flow | Completo (API de streaming nativo) |
| VertexAI | graphit-vertexai | Completo (Fase 2) |
| Bedrock | graphit-bedrock | Completo (API de streaming nativo) |
| LM Studio | graphit-flow | Completo (compatible con OpenAI) |
| LlamaFile | graphit-flow | Completo (compatible con OpenAI) |
| vLLM | graphit-flow | Completo (compatible con OpenAI) |
| TGI | graphit-flow | Por determinar |
| Azure | graphit-flow | Por determinar |
...
Esquema de LLM actual: `graphit-base/graphit/schema/services/llm.py`
Esquema de prompt actual: `graphit-base/graphit/schema/services/prompt.py`
Esquema de agente actual: `graphit-base/graphit/schema/services/agent.py`
Base del servicio de LLM: `graphit-base/graphit/base/llm_service.py`
Proveedor de VertexAI: `graphit-vertexai/graphit/model/text_completion/vertexai/llm.py`
API de Gateway: `graphit-base/graphit/api/`
Herramientas de CLI: `graphit-cli/graphit/cli/`
