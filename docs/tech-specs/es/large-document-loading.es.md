...
documentos grandes en GraphIt. La arquitectura actual trata la carga de documentos
...
Archivos clave:
Punto de entrada REST/WebSocket: `graphit-flow/graphit/gateway/service.py`
Núcleo de Librarian: `graphit-flow/graphit/librarian/librarian.py`
Almacenamiento de blobs: `graphit-flow/graphit/librarian/blob_store.py`
Tablas de Cassandra: `graphit-flow/graphit/tables/library.py`
Esquema de la API: `graphit-base/graphit/schema/services/library.py`
...
**Archivo:** `graphit-flow/graphit/librarian/blob_store.py`
...
El SDK de Python (`graphit-base/graphit/api/library.py`) debe manejar
...
**`gr-add-library-document`** continúa funcionando sin cambios:
...
`gr-load-pdf` - obsoleto, usar `gr-add-library-document`
`gr-load-text` - obsoleto, usar `gr-add-library-document`
