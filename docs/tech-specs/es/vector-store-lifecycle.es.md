...
Este documento describe cómo GraphIt gestiona las colecciones de almacenes de vectores en diferentes implementaciones de backend (Qdrant, Pinecone, Milvus). El diseño aborda el desafío de admitir incrustaciones con diferentes dimensiones sin codificar valores de dimensión.
...
Una sola colección de GraphIt puede recibir incrustaciones de múltiples modelos
...
Esquema de Almacenamiento: `graphit-base/graphit/schema/services/storage.py`
Servicio de Bibliotecario: `graphit-flow/graphit/librarian/service.py`
