...
- **graphit-flow/agent/react/service.py**: Carga de la configuración de las herramientas y creación del AgentManager
- **graphit-flow/agent/react/tools.py**: Implementación de McpToolImpl
- **graphit-flow/agent/react/agent_manager.py**: Generación de prompts con argumentos de las herramientas
...
5. **Soporte CLI**: Las herramientas CLI existentes (`gr-invoke-mcp-tool`) soportan argumentos (ya implementado)
...
- [Implementación de las herramientas MCP](./graphit-flow/graphit/agent/react/service.py#L114-129)
- [Implementación actual de las herramientas MCP](./graphit-flow/graphit/agent/react/tools.py#L58-86)
