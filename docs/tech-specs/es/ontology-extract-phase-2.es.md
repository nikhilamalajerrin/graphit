...
4. **Expansión de URIs** (`extract.py:473-521`)
   ...
   Si no se encuentra, construye el URI: `f"https://example.com/ontology/{ontology_id}#{value}"`
...
URI construido: `https://example.com/ontology/food#Recipe`
...
Implementación actual: `graphit-flow/graphit/extract/kg/ontology/extract.py`
