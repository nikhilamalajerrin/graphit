...
Esta especificación describe las capacidades mejoradas de configuración a través de la línea de comandos para GraphIt, lo que permite a los usuarios gestionar elementos de configuración individuales utilizando comandos CLI granulares. La integración soporta cuatro casos de uso principales:
...
- **Patrón CLI Consistente**: Seguir las convenciones y patrones CLI establecidos de GraphIt.
...
Actualmente, GraphIt proporciona la gestión de la configuración a través de la API de Config y un único comando de línea de comandos `gr-show-config` que muestra toda la configuración. Si bien esto funciona para la visualización de la configuración, carece de capacidades de gestión granular.
...
Esta especificación aborda estas lagunas agregando cuatro nuevos comandos de línea de comandos que proporcionan la gestión de configuración granular. Al exponer las operaciones de la API de Config individual a través de comandos CLI, GraphIt puede:
...
Los comandos utilizan las estructuras de datos existentes de `graphit.api.types`:
...
```bash
gr-list-config-items --type <tipo-de-configuración> [--formato texto|json] [--url-api <url>]
```
...
#### gr-get-config-item
```bash
gr-get-config-item --type <tipo-de-configuración> --clave <clave> [--formato texto|json] [--url-api <url>]
```
...
#### gr-put-config-item
```bash
gr-put-config-item --type <tipo-de-configuración> --clave <clave> --valor <valor> [--url-api <url>]
gr-put-config-item --type <tipo-de-configuración> --clave <clave> --stdin [--url-api <url>]
```
...
```bash
gr-delete-config-item --type <tipo-de-configuración> --clave <clave> [--url-api <url>]
```
...
- API de Config existente: `graphit/api/config.py`
- Patrones de CLI: `graphit-cli/graphit/cli/show_config.py`
- Tipos de datos: `graphit/api/types.py`
