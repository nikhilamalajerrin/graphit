...
Tanto GraphRAG como Agent utilizan PROV-O como la ontología base con subtipos específicos de GraphIt:
...
|---------|-------------|-----------|
| `tg:GraphRagQuestion` | `urn:graphit:question:{uuid}` | RAG de grafo de conocimiento |
| `tg:DocRagQuestion` | `urn:graphit:docrag:{uuid}` | RAG de documento/fragmento |
| `tg:AgentQuestion` | `urn:graphit:agent:{uuid}` | Agente ReAct |
...
**Archivo:** `graphit-base/graphit/schema/services/agent.py`
...
**Archivo:** `graphit-base/graphit/messaging/translators/agent.py`
...
**Archivo:** `graphit-flow/graphit/agent/react/service.py`
...
**Archivo:** `graphit-base/graphit/provenance/agent.py`
...
**Archivo:** `graphit-base/graphit/provenance/namespaces.py`
...
| Archivo | Cambio |
|------|--------|
| `graphit-base/graphit/schema/services/agent.py` | Agregar session_id y collection a AgentRequest |
| `graphit-base/graphit/messaging/translators/agent.py` | Actualizar el traductor para nuevos campos |
| `graphit-base/graphit/provenance/namespaces.py` | Agregar tipos de entidad, predicados de agente y predicados de Document RAG |
| `graphit-base/graphit/provenance/triples.py` | Agregar tipos de TG a los constructores de triples de GraphRAG, agregar constructores de triples de Document RAG |
| `graphit-base/graphit/provenance/uris.py` | Agregar generadores de URI de Document RAG |
| `graphit-base/graphit/provenance/__init__.py` | Exportar nuevos tipos, predicados y funciones de Document RAG |
| `graphit-base/graphit/schema/services/retrieval.py` | Agregar explain_id y explain_graph a DocumentRagResponse |
| `graphit-base/graphit/messaging/translators/retrieval.py` | Actualizar DocumentRagResponseTranslator para campos de explicabilidad |
| `graphit-flow/graphit/agent/react/service.py` | Agregar lógica de productor y registro de explicabilidad |
| `graphit-flow/graphit/retrieval/document_rag/document_rag.py` | Agregar devolución de llamada de explicabilidad y emitir triples de procedencia |
| `graphit-flow/graphit/retrieval/document_rag/rag.py` | Agregar productor de explicabilidad y conectar la devolución de llamada |
| `graphit-cli/graphit/cli/show_explain_trace.py` | Manejar tipos de traza de agente |
| `graphit-cli/graphit/cli/list_explain_traces.py` | Listar sesiones de agente junto con GraphRAG |

## Archivos Creados

| Archivo | Propósito |
|------|---------|
| `graphit-base/graphit/provenance/agent.py` | Generadores de triples específicos del agente |
...
1. Patrón de URI: `urn:graphit:agent:` vs `urn:graphit:question:`
