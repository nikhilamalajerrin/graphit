...
La implementación de embeddings en `graphit-flow/graphit/embeddings/fastembed/processor.py` presenta una ineficiencia de rendimiento significativa:
...
**Archivo:** `graphit-flow/graphit/gateway/dispatch/embeddings.py`
...
**Archivo:** `graphit-flow/graphit/embeddings/document_embeddings/embeddings.py`
...
**Archivo:** `graphit-flow/graphit/embeddings/graph_embeddings/embeddings.py`
...
**Archivo:** `graphit-flow/graphit/embeddings/row_embeddings/embeddings.py`
...
**Archivo:** `graphit-base/graphit/base/embeddings_client.py`
...
**Archivo:** `graphit-cli/graphit/cli/invoke_embeddings.py`
...
El SDK de Python proporciona dos clases de cliente para interactuar con los servicios de GraphIt. Ambas solo admiten la incrustación de un solo texto.

**Archivo:** `graphit-base/graphit/api/flow.py`
...
**Archivo:** `graphit-base/graphit/api/socket_client.py`
...
#### 1. **Mejora del esquema**
   ...
   Módulo: `graphit-base/graphit/schema/services/llm.py`
...
#### 2. **Mejora del servicio base**
   ...
   Módulo: `graphit-base/graphit/base/embeddings_service.py`
...
#### 3. **Actualizaciones del procesador del proveedor**
   ...
   Módulos:
   `graphit-flow/graphit/embeddings/fastembed/processor.py`
   `graphit-flow/graphit/embeddings/ollama/processor.py`
...
#### 4. **Mejora del cliente**
   ...
   Módulo: `graphit-base/graphit/base/embeddings_client.py`
...
#### 5. **Actualizaciones del llamador: Procesadores de flujo**
   ...
   Módulos:
   `graphit-flow/graphit/embeddings/graph_embeddings/embeddings.py`
   `graphit-flow/graphit/embeddings/row_embeddings/embeddings.py`
   `graphit-flow/graphit/embeddings/document_embeddings/embeddings.py`
...
#### 6. **Mejora de la puerta de enlace de API**
   ...
   Módulo: `graphit-flow/graphit/gateway/dispatch/embeddings.py`
...
#### 7. **Mejora de la herramienta de la línea de comandos**
   ...
   Módulo: `graphit-cli/graphit/cli/invoke_embeddings.py`
...
#### 8. **Mejora del SDK de Python**
   ...
   Módulos:
   `graphit-base/graphit/api/flow.py`
   `graphit-base/graphit/api/socket_client.py`
...
gr-invoke-embeddings "hello world"

# Multiple texts
gr-invoke-embeddings "text one" "text two" "text three"

# From file
gr-invoke-embeddings -f texts.txt --batch-size 64
```
...
[Implementación del Servicio de Inserción](graphit-base/graphit/base/embeddings_service.py)
