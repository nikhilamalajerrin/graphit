...
Las herramientas se definen actualmente en `graphit-flow/graphit/agent/react/tools.py` con implementaciones tipadas:
...
Utilice `gr-put-config-item` para cargar configuraciones:

```bash
# Load tool-service config
gr-put-config-item tool-service/joke-service < joke-service.json

# Load tool config
gr-put-config-item tool/tell-joke < tell-joke.json
```
...
Tipos de solicitud y respuesta en `graphit-base/graphit/schema/services/tool_service.py`:
...
Clase base en `graphit-base/graphit/base/dynamic_tool_service.py`:
...
Implementación en `graphit-flow/graphit/agent/react/tools.py`:
...
| Archivo | Propósito |
|------|---------|
| `graphit-base/graphit/schema/services/tool_service.py` | Esquemas de solicitud/respuesta |
| `graphit-base/graphit/base/tool_service_client.py` | Cliente para invocar servicios |
| `graphit-base/graphit/base/dynamic_tool_service.py` | Clase base para la implementación de servicios |
| `graphit-flow/graphit/agent/react/tools.py` | Clase `ToolServiceImpl` |
| `graphit-flow/graphit/agent/react/service.py` | Carga de configuración |

### Ejemplo: Servicio de Chistes

Un ejemplo de servicio en `graphit-flow/graphit/tool_service/joke/`:
...
Implementación actual de la herramienta: `graphit-flow/graphit/agent/react/tools.py`
Registro de herramientas: `graphit-flow/graphit/agent/react/service.py:105-214`
Esquemas del agente: `graphit-base/graphit/schema/services/agent.py`
