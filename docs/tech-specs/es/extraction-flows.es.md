...
Este documento describe cómo los datos fluyen a través de la canalización de extracción de GraphIt, desde la presentación del documento hasta el almacenamiento en almacenes de conocimiento.
...
TextDocument
├── metadata: Metadata
│   ├── id: str              # Page URI (e.g., https://example.com/doc/xxx/p1)
│   ├── user: str
│   ├── collection: str
