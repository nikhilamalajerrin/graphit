...
Los flow blueprints en GraphIt ahora admiten parámetros de procesador que pueden contener valores fijos o marcadores de posición de parámetros. Esto crea una oportunidad para la personalización en tiempo de ejecución.
=======
...
Los blueprints de flujo en GraphIt ahora admiten parámetros de procesador que pueden contener valores fijos o marcadores de posición de parámetros. Esto crea una oportunidad para la personalización en tiempo de ejecución.
>>>>>>> 82edf2d (New md files from RunPod)
...
Al aprovechar los parámetros de procesador parametrizados, GraphIt puede:
<<<<<<< HEAD
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   Módulo: graphit-flow/graphit/flow/definition.py
...
2. **Motor de Resolución de Parámetros**
   ...
   Módulo: graphit-flow/graphit/flow/parameter_resolver.py
...
3. **Integración del Almacén de Parámetros**
   ...
   Módulo: graphit-flow/graphit/flow/parameter_store.py
...
4. **Extensiones del Lanzador de Flujos**
   ...
   Módulo: graphit-flow/graphit/flow/launcher.py
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   Módulo: graphit-ui/components/flow-parameters/
...
El servicio de configuración de flujo (`graphit-flow/graphit/config/service/flow.py`) requiere las siguientes mejoras:
