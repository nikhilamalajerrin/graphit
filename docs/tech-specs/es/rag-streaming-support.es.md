...
- **Experiencia de usuario consistente**: Proporcionar la misma experiencia de streaming en todos los servicios GraphIt.
...
- Experiencia inconsistente en comparación con otros servicios de GraphIt.

Esta especificación aborda estas limitaciones añadiendo soporte de streaming a GraphRAG y DocumentRAG. Al permitir respuestas token por token, GraphIt puede:
...
2.  **Servicio GraphRAG** (Necesita pasar el parámetro `streaming`)
    ...
    -   Módulos:
        ...
        -   `graphit-flow/graphit/retrieval/graph_rag/rag.py` (Procesador)
        -   `graphit-base/graphit/schema/graph_rag.py` (Esquema de solicitud)
...
3.  **Servicio DocumentRAG** (Necesita pasar el parámetro `streaming`)
    ...
    -   Módulos:
        ...
        -   `graphit-flow/graphit/retrieval/document_rag/rag.py` (Procesador)
        -   `graphit-base/graphit/schema/document_rag.py` (Esquema de solicitud)
...
- Streaming de PromptClient: `graphit-base/graphit/base/prompt_client.py`
- Streaming de Agent: `graphit-flow/graphit/agent/react/agent_manager.py`
