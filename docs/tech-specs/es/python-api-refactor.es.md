...
Esta especificación describe una refactorización integral de la biblioteca de cliente de la API de Python de GraphIt para lograr la paridad de funciones con la API Gateway y agregar soporte para patrones de comunicación en tiempo real modernos.
...
La API de Python (`graphit-base/graphit/api/`) es una biblioteca de cliente REST con los siguientes módulos:
...
Módulo: `graphit-base/graphit/api/api.py`
...
Módulo: `graphit-base/graphit/api/socket_client.py` (nuevo)
...
Módulo: `graphit-base/graphit/api/async_socket_client.py` (nuevo)
...
Módulo: `graphit-base/graphit/api/bulk_client.py` (nuevo)
...
Módulo: `graphit-base/graphit/api/async_bulk_client.py` (nuevo)
...
Módulo: `graphit-base/graphit/api/flow.py`
...
Módulo: `graphit-base/graphit/api/async_flow.py` (nuevo)
...
Módulo: `graphit-base/graphit/api/metrics.py` (nuevo)
...
Módulo: `graphit-base/graphit/api/types.py` (modificado)
...
`graphit-base/graphit/api/` - Código fuente de la API de Python
`graphit-flow/graphit/gateway/` - Código fuente de la pasarela
`graphit-flow/graphit/gateway/dispatch/mux.py` - Implementación de referencia de multiplexor de WebSocket
