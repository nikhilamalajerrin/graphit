...
Basado en la especificación `STRUCTURED_DATA.md`, este documento propone las adiciones y modificaciones necesarias en el esquema de Pulsar para soportar las capacidades de datos estructurados en GraphIt.
...
- `graphit-flow/graphit/decoding/structured` - Utiliza StructuredDataSubmission
- `graphit-flow/graphit/query/nlp_query/cassandra` - Utiliza esquemas de consulta NLP
- `graphit-flow/graphit/query/objects/cassandra` - Utiliza esquemas de consulta estructurada
- `graphit-flow/graphit/extract/object/row/` - Consumo de Chunk, produce ExtractedObject
- `graphit-flow/graphit/storage/objects/cassandra` - Utiliza Esquema de Filas
- `graphit-flow/graphit/embeddings/object_embeddings/qdrant` - Utiliza esquemas de incorporación de objetos
