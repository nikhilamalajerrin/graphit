...
para respuestas de prompts en GraphIt. JSONL permite la extracción resistente a
...
Implementación actual en `graphit-flow/graphit/template/prompt_manager.py`:
...
<<<<<<< HEAD
Implementación actual: `graphit-flow/graphit/template/prompt_manager.py`.
