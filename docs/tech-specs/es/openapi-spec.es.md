...
Crear una especificación OpenAPI 3.1 completa y modular para la puerta de enlace de la API REST de GraphIt que:
...
**Traductores de Mensajes**: `graphit-base/graphit/messaging/translators/*.py`
**Administrador del Despachador**: `graphit-flow/graphit/gateway/dispatch/manager.py`
**Administrador de Puntos Finales**: `graphit-flow/graphit/gateway/endpoint/manager.py`
...
Para cada traductor en `graphit-base/graphit/messaging/translators/`:
...
def to_pulsar(self, data: Dict[str, Any]) -> DocumentRagQuery:
    return DocumentRagQuery(
        ...
        user=data.get("user", "graphit"),             # optional string, default "graphit"
...
Traductores: `graphit-base/graphit/messaging/translators/`
Mapeo del despachador: `graphit-flow/graphit/gateway/dispatch/manager.py`
Enrutamiento de puntos finales: `graphit-flow/graphit/gateway/endpoint/manager.py`
