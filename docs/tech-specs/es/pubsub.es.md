...
Este documento cataloga todas las conexiones entre el código base de GraphIt y la infraestructura pub/sub. Actualmente, el sistema está codificado para usar Apache Pulsar. Este análisis identifica todos los puntos de integración para informar futuras refactorizaciones hacia una abstracción pub/sub configurable.

## Estado actual: Puntos de integración de Pulsar

### 1. Uso directo del cliente de Pulsar

**Ubicación:** `graphit-flow/graphit/gateway/service.py`
...
**Ubicación:** `graphit-base/graphit/base/async_processor.py`
...
**Ubicación:** `graphit-base/graphit/base/consumer.py`
...
**Archivo de especificación:** `graphit-base/graphit/base/consumer_spec.py`
**Línea 22:** Hace referencia a `processor.pulsar_client`

### 4. Abstracción del productor

**Ubicación:** `graphit-base/graphit/base/producer.py`
...
**Archivo de especificación:** `graphit-base/graphit/base/producer_spec.py`
**Línea 18:** Hace referencia a `processor.pulsar_client`

### 5. Abstracción del publicador

**Ubicación:** `graphit-base/graphit/base/publisher.py`
...
**Ubicación:** `graphit-base/graphit/base/subscriber.py`
...
**Archivo de especificaciones:** `graphit-base/graphit/base/subscriber_spec.py`
**Línea 19:** Referencias a `processor.pulsar_client`

### 7. Sistema de esquemas (Heart of Darkness)

**Ubicación:** `graphit-base/graphit/schema/`
...
Crear un sistema de esquemas **GraphIt** que sea independiente de pub/sub (usando dataclasses o Pydantic), y luego generar esquemas de Pulsar/Kafka/etc a partir de él. Esto requiere reescribir cada archivo de esquema y podría provocar cambios importantes.
...
from graphit.schema.services.llm import TextCompletionRequest
...
1. **Crear versiones de clases de datos** de todos los esquemas en `graphit/schema/`
