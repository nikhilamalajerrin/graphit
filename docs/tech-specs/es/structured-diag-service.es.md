...
Esta especificación describe un nuevo servicio invocable para diagnosticar y analizar datos estructurados dentro de GraphIt. El servicio extrae la funcionalidad de la herramienta de línea de comandos `gr-load-structured-data` existente y la expone como un servicio de solicitud/respuesta, lo que permite el acceso programático a las capacidades de detección de tipos de datos y generación de descriptores.
...
2. **Generación de Descriptores**: Genera un descriptor de datos estructurados de GraphIt para una muestra de datos y tipo dados.
...
**Generar Descriptores Precisos**: Produce descriptores de datos estructurados que mapean con precisión los datos de origen a los esquemas de GraphIt.
...
Actualmente, el comando `gr-load-structured-data` proporciona una funcionalidad completa para analizar datos estructurados y generar descriptores. Sin embargo, esta funcionalidad está estrechamente acoplada a la interfaz de la CLI, lo que limita su reutilización.
...
Esta especificación aborda estas deficiencias mediante la creación de un servicio dedicado para el diagnóstico de datos estructurados. Al exponer estas capacidades como un servicio, GraphIt puede:
...
1. **Procesador del Servicio de Diagnóstico**
   ...
   Módulo: `graphit-flow/graphit/diagnosis/structured_data/service.py`
...
2. **Detector de Tipo de Datos**
   ...
   Módulo: `graphit-flow/graphit/diagnosis/structured_data/type_detector.py`
...
3. **Generador de Descriptores**
   ...
   Mapea los campos de datos a los campos del esquema de GraphIt a través de las respuestas del prompt.

   Módulo: `graphit-flow/graphit/diagnosis/structured_data/descriptor_generator.py`
...
El servicio seguirá las convenciones del servicio GraphIt:
...
El servicio se integrará con las API existentes de GraphIt:

Componentes Modificados:
`gr-load-structured-data` CLI: Refactorizado para utilizar el nuevo servicio para las operaciones de diagnóstico
...
Control de acceso a través de la autenticación GraphIt existente
...
`gr-load-structured-data` implementación: `graphit-cli/graphit/cli/load_structured_data.py`
