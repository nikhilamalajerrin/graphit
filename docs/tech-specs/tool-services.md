...
Tools are currently defined in `graphit-flow/graphit/agent/react/tools.py` with typed implementations:
...
Use `gr-put-config-item` to load configurations:
...
Request and response types in `graphit-base/graphit/schema/services/tool_service.py`:
...
Base class in `graphit-base/graphit/base/dynamic_tool_service.py`:
...
Implementation in `graphit-flow/graphit/agent/react/tools.py`:
...
| File | Purpose |
|------|---------|
| `graphit-base/graphit/schema/services/tool_service.py` | Request/response schemas |
| `graphit-base/graphit/base/tool_service_client.py` | Client for invoking services |
| `graphit-base/graphit/base/dynamic_tool_service.py` | Base class for service implementation |
| `graphit-flow/graphit/agent/react/tools.py` | `ToolServiceImpl` class |
| `graphit-flow/graphit/agent/react/service.py` | Config loading |

### Example: Joke Service

An example service in `graphit-flow/graphit/tool_service/joke/`:
...
- Current tool implementation: `graphit-flow/graphit/agent/react/tools.py`
- Tool registration: `graphit-flow/graphit/agent/react/service.py:105-214`
- Agent schemas: `graphit-base/graphit/schema/services/agent.py`
