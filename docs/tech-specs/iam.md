...
GraphIt has no meaningful identity or access management. The system
...
Implementation: `graphit-flow/graphit/gateway/auth.py`
...
(e.g. `?user=graphit`) or set by CLI tools. It flows through the
...
| File | Purpose |
|------|---------|
| `graphit-flow/graphit/gateway/auth.py` | Authenticator class |
| `graphit-flow/graphit/gateway/service.py` | Gateway init, token config |
| `graphit-flow/graphit/gateway/endpoint/*.py` | Per-endpoint auth checks |
| `graphit-base/graphit/schema/core/metadata.py` | `Metadata` dataclass with `user` field |
...
- `gr-create-workspace`, `gr-list-workspaces` for workspace management.
- `gr-create-user`, `gr-list-users`, `gr-disable-user` for user
  management.
- `gr-create-api-key`, `gr-list-api-keys`, `gr-revoke-api-key` for
  key management.
...
- Add `gr-create-workspace`, `gr-list-workspaces` commands
...
- Add `gr-create-user`, `gr-list-users`, `gr-disable-user` commands
- Add `gr-create-api-key`, `gr-list-api-keys`, `gr-revoke-api-key`
  commands
