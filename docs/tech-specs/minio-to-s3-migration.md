...
### Key Files
1. `graphit-flow/graphit/librarian/blob_store.py` - BlobStore implementation
2. `graphit-flow/graphit/librarian/librarian.py` - BlobStore initialization
3. `graphit-flow/graphit/librarian/service.py` - Service configuration
4. `graphit-flow/pyproject.toml` - Dependencies (`minio` package)
