...
This specification addresses the inconsistent naming and configuration patterns for Cassandra connection parameters across the GraphIt codebase. Currently, two different parameter naming schemes exist (`cassandra_*` vs `graph_*`), leading to confusion and maintenance complexity.
