...
| Old | New |
|-----|-----|
| `stmt_uri` (`https://example.com/stmt/{uuid}`) | `subgraph_uri` (`https://example.com/subgraph/{uuid}`) |
...
(`graphit-flow/graphit/extract/kg/definitions/extract.py`)
...
(`graphit-flow/graphit/extract/kg/relationships/extract.py`)
...
**kg-extract-ontology**
(`graphit-flow/graphit/extract/kg/ontology/extract.py`)
...
**kg-extract-agent**
(`graphit-flow/graphit/extract/kg/agent/extract.py`)
...
**`graphit-base/graphit/provenance/triples.py`**
...
**`graphit-base/graphit/provenance/uris.py`**

- Replace `statement_uri()` with `subgraph_uri()`

**`graphit-base/graphit/provenance/namespaces.py`**
...
The full OWL ontology covering all extraction and query-time classes and predicates is at `specs/ontology/graphit.ttl`.
