...
responses in GraphIt. Streaming enables real-time delivery of generated
...
Current schema (`graphit-base/graphit/schema/services/llm.py`):
...
##### LLM Schema (`graphit-base/graphit/schema/services/llm.py`)
...
##### Prompt Schema (`graphit-base/graphit/schema/services/prompt.py`)
...
**LlmClient Updates** (`graphit-base/graphit/clients/llm_client.py`):
...
**PromptClient Updates** (`graphit-base/graphit/base/prompt_client.py`):
...
**Module:** `graphit-vertexai/graphit/model/text_completion/vertexai/llm.py`
...
|----------|---------|-------------------|
| OpenAI | graphit-flow | Full (native streaming API) |
| Claude/Anthropic | graphit-flow | Full (native streaming API) |
| Ollama | graphit-flow | Full (native streaming API) |
| Cohere | graphit-flow | Full (native streaming API) |
| Mistral | graphit-flow | Full (native streaming API) |
| Azure OpenAI | graphit-flow | Full (native streaming API) |
| Google AI Studio | graphit-flow | Full (native streaming API) |
| VertexAI | graphit-vertexai | Full (Phase 2) |
| Bedrock | graphit-bedrock | Full (native streaming API) |
| LM Studio | graphit-flow | Full (OpenAI-compatible) |
| LlamaFile | graphit-flow | Full (OpenAI-compatible) |
| vLLM | graphit-flow | Full (OpenAI-compatible) |
| TGI | graphit-flow | TBD |
| Azure | graphit-flow | TBD |
...
- Current LLM schema: `graphit-base/graphit/schema/services/llm.py`
- Current prompt schema: `graphit-base/graphit/schema/services/prompt.py`
- Current agent schema: `graphit-base/graphit/schema/services/agent.py`
- LLM service base: `graphit-base/graphit/base/llm_service.py`
- VertexAI provider: `graphit-vertexai/graphit/model/text_completion/vertexai/llm.py`
- Gateway API: `graphit-base/graphit/api/`
- CLI tools: `graphit-cli/graphit/cli/`
