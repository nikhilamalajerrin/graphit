...
The embeddings implementation in `graphit-flow/graphit/embeddings/fastembed/processor.py` exhibits a significant performance inefficiency:
...
**File:** `graphit-flow/graphit/gateway/dispatch/embeddings.py`
...
**File:** `graphit-flow/graphit/embeddings/document_embeddings/embeddings.py`
...
**File:** `graphit-flow/graphit/embeddings/graph_embeddings/embeddings.py`
...
**File:** `graphit-flow/graphit/embeddings/row_embeddings/embeddings.py`
...
**File:** `graphit-base/graphit/base/embeddings_client.py`
...
**File:** `graphit-cli/graphit/cli/invoke_embeddings.py`
...
The Python SDK provides two client classes for interacting with GraphIt services. Both only support single-text embedding.

**File:** `graphit-base/graphit/api/flow.py`
...
**File:** `graphit-base/graphit/api/socket_client.py`
...
#### 1. **Schema Enhancement**
   ...
   Module: `graphit-base/graphit/schema/services/llm.py`
...
#### 2. **Base Service Enhancement**
   ...
   Module: `graphit-base/graphit/base/embeddings_service.py`
...
#### 4. **Client Enhancement**
   ...
   Module: `graphit-base/graphit/base/embeddings_client.py`
...
#### 6. **API Gateway Enhancement**
   ...
   Module: `graphit-flow/graphit/gateway/dispatch/embeddings.py`

#### 7. **CLI Tool Enhancement**
   - Add support for multiple texts or file input
   - Add batch size parameter

   Module: `graphit-cli/graphit/cli/invoke_embeddings.py`
...
- [EmbeddingsService Implementation](graphit-base/graphit/base/embeddings_service.py)
