...
The GraphIt system uses a **flow-based architecture** for dynamic queue resolution, which inherently supports multi-tenancy:
...
**File:** `graphit-base/graphit/base/async_processor.py`
**Line:** 260-264
...
**File:** `graphit-flow/graphit/config/service/service.py`
**Line:** 276-279
...
**File:** `graphit-base/graphit/base/cassandra_config.py`
...
**File:** `graphit-flow/graphit/cores/service.py`
...
**File:** `graphit-flow/graphit/librarian/service.py`
...
**File:** `graphit-flow/graphit/librarian/collection_manager.py`
...
**File:** `graphit-flow/graphit/tables/library.py`
...
**File:** `graphit-base/graphit/schema/services/collection.py`
...
3. **KnowledgeGraph Direct Access** (`graphit-flow/graphit/direct/cassandra_kg.py:18`)
   - Default parameter `keyspace="graphit"`
