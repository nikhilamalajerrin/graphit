...
4. **הרחבת URI** (`extract.py:473-521`)
   ...
   אם לא נמצא, בונה את ה-URI: `f"https://example.com/ontology/{ontology_id}#{value}"`
...
URI שנוצר: `https://example.com/ontology/food#Recipe`
...
יישום נוכחי: `graphit-flow/graphit/extract/kg/ontology/extract.py`
