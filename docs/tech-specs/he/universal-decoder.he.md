...
כיום, ל-GraphIt יש מפענח ספציפי ל-PDF. תמיכה בפורמטים נוספים (DOCX, XLSX, HTML, Markdown, טקסט רגיל, PPTX וכו') דורשת
...
קונטיינר חדש: `graphit-flow-universal-decoder`
