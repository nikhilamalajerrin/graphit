...
גם GraphRAG וגם Agent משתמשים ב-PROV-O כאונטולוגיה בסיסית עם תת-סוגים ספציפיים ל-GraphIt:
...
|---------|-------------|-----------|
| `tg:GraphRagQuestion` | `urn:graphit:question:{uuid}` | RAG של גרף ידע |
| `tg:DocRagQuestion` | `urn:graphit:docrag:{uuid}` | RAG של מסמכים/חלקים |
| `tg:AgentQuestion` | `urn:graphit:agent:{uuid}` | סוכן ReAct |
...
**קובץ:** `graphit-base/graphit/schema/services/agent.py`
...
**קובץ:** `graphit-base/graphit/provenance/agent.py`
...
**קובץ:** `graphit-base/graphit/provenance/namespaces.py`
...
| קובץ | שינוי |
|------|--------|
| `graphit-base/graphit/schema/services/agent.py` | הוספת session_id ו-collection ל-AgentRequest |
| `graphit-base/graphit/messaging/translators/agent.py` | עדכון מתרגם עבור שדות חדשים |
| `graphit-base/graphit/provenance/namespaces.py` | הוספת סוגי ישויות, טענות של סוכן וטענות של Document RAG |
| `graphit-base/graphit/provenance/triples.py` | הוספת סוגי TG לבונים של משולשים של GraphRAG, הוספת בונים של משולשים של Document RAG |
| `graphit-base/graphit/provenance/uris.py` | הוספת יוצרי URI של Document RAG |
| `graphit-base/graphit/provenance/__init__.py` | ייצוא סוגים, טענות ופונקציות חדשות של Document RAG |
| `graphit-base/graphit/schema/services/retrieval.py` | הוספת explain_id ו-explain_graph ל-DocumentRagResponse |
| `graphit-base/graphit/messaging/translators/retrieval.py` | עדכון DocumentRagResponseTranslator עבור שדות הסברתיות |
| `graphit-flow/graphit/agent/react/service.py` | הוספת מפיק הסברתיות + לוגיקת הקלטה |
| `graphit-flow/graphit/retrieval/document_rag/document_rag.py` | הוספת קריאה חוזרת של הסברתיות ופליטת משולשים של מקור |
| `graphit-flow/graphit/retrieval/document_rag/rag.py` | הוספת מפיק הסברתיות וחיבור הקריאה החוזרת |
| `graphit-cli/graphit/cli/show_explain_trace.py` | טיפול בסוגי מעקב של סוכן |
| `graphit-cli/graphit/cli/list_explain_traces.py` | הצגת סשנים של סוכן לצד GraphRAG |

## קבצים שנוצרו

| קובץ | מטרה |
|------|---------|
| `graphit-base/graphit/provenance/agent.py` | יוצרי משולשים ספציפיים לסוכן |

## עדכוני CLI

**זיהוי:** גם לשאלות GraphRAG וגם לשאלות סוכן יש סוג `tg:Question`. מובחנים על ידי:
1. תבנית URI: `urn:graphit:agent:` לעומת `urn:graphit:question:`
