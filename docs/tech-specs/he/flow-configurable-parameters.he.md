...
<<<<<<< HEAD
מפרט זה מתאר את יישום הפרמטרים הניתנים להגדרה עבור תבניות זרימה ב-GraphIt. פרמטרים מאפשרים למשתמשים להתאים אישית את פרמטרי המעבד בזמן הפעלת הזרימה על ידי מתן ערכים המחליפים את מקומות הפרמטרים בהגדרת תבנית הזרימה.
=======
מפרט זה מתאר את יישום הפרמטרים הניתנים להגדרה עבור תבניות זרימה ב-GraphIt. פרמטרים מאפשרים למשתמשים להתאים אישית את פרמטרי המעבד בזמן הפעלת הזרימה על ידי מתן ערכים שמחליפים את מקומות הפרמטרים בהגדרת תבנית הזרימה.
...
<<<<<<< HEAD
תבניות זרימה ב-GraphIt תומכות כעת בפרמטרי מעבד שניתן להכיל ערכים קבועים או מקומות שמירת פרמטרים. זה יוצר הזדמנות להתאמה אישית בזמן ריצה.

פרמטרי מעבד קיימים תומכים ב:
ערכים קבועים: `"model": "gemma3:12b"`
מקומות שמירת פרמטרים: `"model": "gemma3:{model-size}"`
=======
תבניות זרימה ב-GraphIt תומכות כעת בפרמטרי מעבד שניתן להכיל ערכים קבועים או מקומות פרמטרים. זה יוצר הזדמנות להתאמה אישית בזמן ריצה.
...
<<<<<<< HEAD
על ידי שימוש בפרמטרי מעבד מוגדרים, GraphIt יכולה:
=======
על ידי שימוש בפרמטרי מעבד מותאמים אישית, GraphIt יכולה:
>>>>>>> 82edf2d (New md files from RunPod)
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   מודול: graphit-flow/graphit/flow/definition.py
...
2. **מנוע פתרון פרמטרים**
   ...
   מודול: graphit-flow/graphit/flow/parameter_resolver.py
...
3. **אינטגרציה עם מאגר פרמטרים**
   ...
   מודול: graphit-flow/graphit/flow/parameter_store.py
...
4. **הרחבות משגר זרימה**
   ...
   מודול: graphit-flow/graphit/flow/launcher.py
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   מודול: graphit-ui/components/flow-parameters/
...
שירות תצורת הזרימה (`graphit-flow/graphit/config/service/flow.py`) דורש את השיפורים הבאים:
