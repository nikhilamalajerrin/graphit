...
**מיקום יישום**: `graphit-flow/graphit/extract/kg/ontology/ontology_loader.py`
...
**מיקום יישום**: `graphit-flow/graphit/extract/kg/ontology/ontology_embedder.py`
...
**מיקום יישום**: `graphit-flow/graphit/extract/kg/ontology/text_processor.py`
...
**מיקום יישום**: `graphit-flow/graphit/extract/kg/ontology/ontology_selector.py`
...
**מיקום יישום**: `graphit-flow/graphit/extract/kg/ontology/extract.py` (שיטת build_extraction_variables)
...
**יישום**:
שירות החילוץ הראשי (KgExtractOntology) הוא שכבת הארגון המנהלת את זרימת העבודה שלמה. הוא משתמש בדפוס FlowProcessor של GraphIt עם אתחול רכיבים ספציפיים לכל זרימה. כאשר מגיעה עדכון תצורה של אונטולוגיה, הוא מאתחל או מעדכן את הרכיבים הספציפיים לזרימה (טוען אונטולוגיה, ממיר, מעבד טקסט, בוחר). כאשר מגיע מקטע טקסט לעיבוד, הוא מתאם את הצינור: חלוקת הטקסט למקטעים, מציאת אלמנטי אונטולוגיה רלוונטיים באמצעות חיפוש וקטורי, בניית הנחיה מוגבלת, קריאה לשירות ההנחיה, ניתוח ותיקוף של התגובה, יצירת משולשות הגדרת אונטולוגיה, ופליטה הן של משולשות תוכן והן של הקשרים של ישויות.
...
**מיקום יישום**: `graphit-flow/graphit/extract/kg/ontology/extract.py`

### תצורה

השירות משתמש בגישה הסטנדרטית של GraphIt לתצורה עם ארגומנטים של שורת הפקודה:
...
**מיקום יישום**: `graphit-flow/graphit/extract/kg/ontology/vector_store.py`
