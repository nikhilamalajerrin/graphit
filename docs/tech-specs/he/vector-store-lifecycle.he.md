...
מסמך זה מתאר כיצד GraphIt מנהלת אוספי מאגרי וקטורים על פני יישומים שונים (Qdrant, Pinecone, Milvus). העיצוב מתמודד עם האתגר של תמיכה בהטבעות עם ממדים שונים מבלי לקודד ערכי ממדים באופן קשיח.
...
אוסף GraphIt יחיד עשוי לקבל הטבעות ממודלים מרובים
...
סכימת אחסון: `graphit-base/graphit/schema/services/storage.py`
שירות ספרית: `graphit-flow/graphit/librarian/service.py`
