...
<<<<<<< HEAD
מפרט זה מתאר שיפורי ביצועים מקיפים עבור אלגוריתם GraphRAG (Graph Retrieval-Augmented Generation) ב-GraphIt. יישום הנוכחי סובל מבעיות ביצועים משמעותיות המגבילות את יכולת ההרחבה וזמני התגובה. מפרט זה מתייחס לארבעה תחומים עיקריים של אופטימיזציה:
...
=======
מפרט זה מתאר שיפורים מקיפים בביצועים עבור אלגוריתם GraphRAG (Graph Retrieval-Augmented Generation) ב-GraphIt. יישום הנוכחי סובל מבעיות ביצועים משמעותיות המגבילות את יכולת ההרחבה וזמני התגובה. מפרט זה מתייחס לארבעה תחומים עיקריים של אופטימיזציה:
...
יישום GraphRAG הנוכחי ב-`graphit-flow/graphit/retrieval/graph_rag/graph_rag.py` מציג מספר בעיות ביצועים קריטיות המשפיעות באופן משמעותי על יכולת ההרחבה של המערכת:
...
מפרט זה מתייחס לפערים אלה על ידי יישום שאילתות באצווה, מטמון חכם ועיבוד מקבילי. על ידי אופטימיזציה של דפוסי שאילתות וגישה לנתונים, GraphIt יכולה:
...
>>>>>>> 82edf2d (New md files from RunPod)
   **שמירה על חיבורים**: שמור על חיבורי לקוח למסד הנתונים בין בקשות
   ...
   מודול: `graphit-flow/graphit/retrieval/graph_rag/rag.py` (עודכן)
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   מודול: `graphit-flow/graphit/retrieval/graph_rag/optimized_traversal.py`
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   מודול: `graphit-flow/graphit/retrieval/graph_rag/label_resolver.py`
...
#### 4. **שכבת מטמון תוויות שמרנית**
   ...
   **ללא מטמון תוצאות שאילתה**: עקב חששות לגבי עקביות שינוי גרף
   ...
   מודול: `graphit-flow/graphit/retrieval/graph_rag/cache_manager.py`
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   מודול: `graphit-flow/graphit/retrieval/graph_rag/query_optimizer.py`
...
[מימוש מקורי של GraphRAG](graphit-flow/graphit/retrieval/graph_rag/graph_rag.py)
[עקרונות ארכיטקטורה של GraphIt](architecture-principles.md)
