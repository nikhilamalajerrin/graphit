...
מפרט זה מתאר את המבנה והפורמט של אונטולוגיות במערכת GraphIt. אונטולוגיות מספקות מודלים פורמליים של ידע המגדירים מחלקות, תכונות ויחסים, ומאפשרים יכולות של הסקה והסקת מסקנות. המערכת משתמשת בפורמט תצורה השואב השראה מ-OWL, ומייצג באופן כללי מושגי OWL/RDFS תוך התאמה לדרישות של GraphIt.
...
GraphIt מאחסן אונטולוגיות כפריטים תצורה במערכת מבוססת מפתח-ערך גמישה. למרות שהפורמט מושפע מ-OWL (שפת אונטולוגיה ווב), הוא מותאם במיוחד לשימושים הספציפיים של GraphIt ואינו עומד במלואן בכל המפרטים של OWL.

אונטולוגיות ב-GraphIt מאפשרות:
