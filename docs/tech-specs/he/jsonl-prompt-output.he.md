...
עבור תשובות לשאילתות ב-GraphIt. JSONL מאפשר חילוץ עמיד לקיטוע
...
יישום נוכחי ב-`graphit-flow/graphit/template/prompt_manager.py`:
...
יישום נוכחי: `graphit-flow/graphit/template/prompt_manager.py`.
