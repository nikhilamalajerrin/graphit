...
```python
# לפני
from graphit.schema import Error, Triple, GraphEmbeddings, TextCompletionRequest

# אחרי
from graphit.schema.core import Error, Triple
from graphit.schema.knowledge import GraphEmbeddings
from graphit.schema.services import TextCompletionRequest
```
