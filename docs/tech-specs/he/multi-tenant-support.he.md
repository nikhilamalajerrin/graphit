...
מערכת GraphIt משתמשת בארכיטקטורה **מבוססת זרימה** לפתרון דינמי של תורים, התומכת באופן מובנה בריבוי דיירים:
...
**קובץ:** `graphit-base/graphit/base/async_processor.py`
**שורה:** 260-264
...
**קובץ:** `graphit-flow/graphit/config/service/service.py`
**שורה:** 276-279
...
**קובץ:** `graphit-base/graphit/base/cassandra_config.py`
...
**קובץ:** `graphit-flow/graphit/cores/service.py`
...
**קובץ:** `graphit-flow/graphit/librarian/service.py`
...
**קובץ:** `graphit-flow/graphit/librarian/collection_manager.py`
...
**קובץ:** `graphit-flow/graphit/tables/library.py`
...
**קובץ:** `graphit-base/graphit/schema/services/collection.py`
...
3. **KnowledgeGraph Direct Access** (`graphit-flow/graphit/direct/cassandra_kg.py:18`)
   פרמטר ברירת מחדל `keyspace="graphit"`
