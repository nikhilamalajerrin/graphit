...
<<<<<<< HEAD
שער GraphIt חווה כרגע אובדן הודעות במהלך סגירת WebSocket בפעולות ייבוא ויצוא כאחד. זה קורה עקב מצבי מירוץ שבהם הודעות בתנועה נזרקות לפני שהן מגיעות ליעדים שלהן (תורי Pulsar לייבוא, לקוחות WebSocket לייצוא).
=======
שער GraphIt חווה כרגע אובדן הודעות במהלך סגירת WebSocket בפעולות ייבוא ויצוא כאחד. זה קורה עקב מצבי מירוץ שבהם הודעות בתנועה נזרקות לפני שהן מגיעות ליעדים שלהן (תורי Pulsar עבור ייבוא, לקוחות WebSocket עבור יצוא).
...
**קובץ:** `graphit-base/graphit/base/publisher.py`
...
**קובץ:** `graphit-flow/graphit/gateway/dispatch/triples_import.py`
...
<<<<<<< HEAD
**קובץ**: `graphit-base/graphit/base/subscriber.py`
=======
**קובץ:** `graphit-base/graphit/base/subscriber.py`
>>>>>>> 82edf2d (New md files from RunPod)
...
**קובץ:** `graphit-flow/graphit/gateway/dispatch/triples_export.py`
...
**קובץ:** `graphit-flow/graphit/gateway/endpoint/socket.py`
