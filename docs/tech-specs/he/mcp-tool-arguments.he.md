...
### רכיבים קשורים
- **graphit-flow/agent/react/service.py**: טעינת הגדרות כלי וליצירת מנהל סוכן
- **graphit-flow/agent/react/tools.py**: יישום של McpToolImpl
- **graphit-flow/agent/react/agent_manager.py**: יצירת הנחיה עם ארגומנטי כלי
- **graphit-cli**: כלים של שורת פקודה לניהול כלי MCP
...
5. **תמיכה ב-CLI**: כלי ה-CLI הקיים `gr-invoke-mcp-tool` תומך בארגומנטים (כבר מיושם)
...
- [יישום כלי תבנית הנחיה](./graphit-flow/graphit/agent/react/service.py#L114-129)
- [יישום כלי MCP נוכחי](./graphit-flow/graphit/agent/react/tools.py#L58-86)
