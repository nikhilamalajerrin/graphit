...
היישום של ההטמעות ב-`graphit-flow/graphit/embeddings/fastembed/processor.py` מציג חוסר יעילות משמעותי בביצועים:
...
**קובץ:** `graphit-flow/graphit/gateway/dispatch/embeddings.py`
...
**קובץ:** `graphit-flow/graphit/embeddings/document_embeddings/embeddings.py`
...
**קובץ:** `graphit-flow/graphit/embeddings/graph_embeddings/embeddings.py`
...
**קובץ:** `graphit-flow/graphit/embeddings/row_embeddings/embeddings.py`
...
**קובץ:** `graphit-base/graphit/base/embeddings_client.py`
...
**קובץ:** `graphit-cli/graphit/cli/invoke_embeddings.py`
...
ערכת הפיתוח תוכנה עבור Python מספקת שתי מחלקות לקוח לצורך אינטראקציה עם שירותי GraphIt. שתיהן תומכות רק בהטמעה של טקסט בודד.

**קובץ:** `graphit-base/graphit/api/flow.py`
...
**קובץ:** `graphit-base/graphit/api/socket_client.py`
...
#### 1. **שיפור סכימה**
   ...
   מודול: `graphit-base/graphit/schema/services/llm.py`
...
#### 2. **שיפור שירות בסיסי**
   ...
   מודול: `graphit-base/graphit/base/embeddings_service.py`
...
#### 4. **שיפור לקוח**
   ...
   מודול: `graphit-base/graphit/base/embeddings_client.py`
...
#### 6. **שיפור שער API**
   ...
   מודול: `graphit-flow/graphit/gateway/dispatch/embeddings.py`

#### 7. **שיפור כלי שורת הפקודה**
   הוספת תמיכה במספר טקסטים או קלט של קובץ
   הוספת פרמטר גודל אצווה

   מודול: `graphit-cli/graphit/cli/invoke_embeddings.py`
...
[יישום של EmbeddingsService](graphit-base/graphit/base/embeddings_service.py)
