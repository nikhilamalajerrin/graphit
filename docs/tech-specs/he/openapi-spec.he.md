...
ליצור מפרט OpenAPI 3.1 מקיף ומודולרי עבור שער ה-API של GraphIt REST, אשר:
...
ה-API מוגדר על ידי:
**מתרגמי הודעות**: `graphit-base/graphit/messaging/translators/*.py`
**מנהל ה-Dispatcher**: `graphit-flow/graphit/gateway/dispatch/manager.py`
**מנהל נקודות הקצה**: `graphit-flow/graphit/gateway/endpoint/manager.py`
...
עבור כל מתרגם ב-`graphit-base/graphit/messaging/translators/`:
...
מתרגמים: `graphit-base/graphit/messaging/translators/`
מיפוי מפיץ: `graphit-flow/graphit/gateway/dispatch/manager.py`
ניתוב נקודת קצה: `graphit-flow/graphit/gateway/endpoint/manager.py`
