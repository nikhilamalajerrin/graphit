...
בהתבסס על מפרט ה-STRUCTURED_DATA.md, המסמך מציע את התוספות והשינויים הנדרשים בסכימת פולסר כדי לתמוך ביכולות נתונים מובנות ב-GraphIt.
...
- `graphit-flow/graphit/decoding/structured` - משתמש ב-StructuredDataSubmission
- `graphit-flow/graphit/query/nlp_query/cassandra` - משתמש בסכימות שאילתות NLP
- `graphit-flow/graphit/query/objects/cassandra` - משתמש בסכימות שאילתות מובנות
- `graphit-flow/graphit/extract/object/row/` - צורך Chunk, מייצר ExtractedObject
- `graphit-flow/graphit/storage/objects/cassandra` - משתמש בסכימה Rows
- `graphit-flow/graphit/embeddings/object_embeddings/qdrant` - משתמש בסכימות אמצעי הטבע
