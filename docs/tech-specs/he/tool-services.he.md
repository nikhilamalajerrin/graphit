...
כלי מוגדרים כיום ב-`graphit-flow/graphit/agent/react/tools.py` עם יישומים מטיפוסים:
...
השתמשו ב-`gr-put-config-item` כדי לטעון הגדרות:
...
סוגי בקשות ותגובות ב-`graphit-base/graphit/schema/services/tool_service.py`:
...
מחלקה בסיסית ב-`graphit-base/graphit/base/dynamic_tool_service.py`:
...
יישום ב-`graphit-flow/graphit/agent/react/tools.py`:
...
| קובץ | מטרה |
|------|---------|
| `graphit-base/graphit/schema/services/tool_service.py` | סכימות בקשה/תגובה |
| `graphit-base/graphit/base/tool_service_client.py` | לקוח להפעלת שירותים |
| `graphit-base/graphit/base/dynamic_tool_service.py` | מחלקה בסיסית ליישום שירות |
| `graphit-flow/graphit/agent/react/tools.py` | מחלקה `ToolServiceImpl` |
| `graphit-flow/graphit/agent/react/service.py` | טעינת תצורה |

### דוגמה: שירות בדיחות

דוגמה לשירות ב-`graphit-flow/graphit/tool_service/joke/`:
...
יישום כלי נוכחי: `graphit-flow/graphit/agent/react/tools.py`
רישום כלים: `graphit-flow/graphit/agent/react/service.py:105-214`
סכימות סוכן: `graphit-base/graphit/schema/services/agent.py`
