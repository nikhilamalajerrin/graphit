...
תוכנית זרימה מגדירה תבנית מלאה של דפוסי זרימת נתונים במערכת GraphIt. כאשר היא מופעלת, היא יוצרת רשת מקושרת של מעבדים המטפלים בקליטת נתונים, עיבוד, אחסון ושליפה כחלק ממערכת מאוחדת.
...
**tenant**: `tg` עבור הגדרות תבניות זרימה המסופקות על ידי GraphIt
