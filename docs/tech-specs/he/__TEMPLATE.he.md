...
מפרט זה מתאר את ממשקי שורת הפקודה לטעינת ידע לתוך GraphIt, ומאפשר למשתמשים לקלוט נתונים ממקורות שונים באמצעות כלי שורת פקודה. האינטגרציה תומכת בארבעה תרחישי שימוש עיקריים:
...
מפרט זה מתייחס לפערים אלה על ידי [description]. באמצעות [capability], GraphIt יכול:
- [Benefit 1]
- [Benefit 2]
- [Benefit 3]
- [Benefit 4]
