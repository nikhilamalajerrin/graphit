...
`graphit-flow/graphit/librarian/librarian.py` - פעולות ליבה של הספרן
`graphit-flow/graphit/librarian/service.py` - מעבד שירות, טעינת מסמכים
`graphit-flow/graphit/tables/library.py` - חנות טבלאות Cassandra
`graphit-base/graphit/schema/services/library.py` - הגדרות סכימה
