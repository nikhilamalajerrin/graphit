...
large documents into GraphIt. The current architecture treats document upload
...
Key files:
- REST/WebSocket entry: `graphit-flow/graphit/gateway/service.py`
- Librarian core: `graphit-flow/graphit/librarian/librarian.py`
- Blob storage: `graphit-flow/graphit/librarian/blob_store.py`
- Cassandra tables: `graphit-flow/graphit/tables/library.py`
- API schema: `graphit-base/graphit/schema/services/library.py`
...
**File:** `graphit-flow/graphit/librarian/blob_store.py`
...
The Python SDK (`graphit-base/graphit/api/library.py`) should handle
...
**`gr-add-library-document`** continues to work unchanged:
...
- `gr-load-pdf` - deprecated, use `gr-add-library-document`
- `gr-load-text` - deprecated, use `gr-add-library-document`
