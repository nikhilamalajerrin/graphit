...
**位置**: `graphit-flow/graphit/librarian/blob_store.py`
**操作**:
...
### 关键文件
1. `graphit-flow/graphit/librarian/blob_store.py` - BlobStore 实现
2. `graphit-flow/graphit/librarian/librarian.py` - BlobStore 初始化
3. `graphit-flow/graphit/librarian/service.py` - 服务配置
4. `graphit-flow/pyproject.toml` - 依赖项 (`minio` 包)
