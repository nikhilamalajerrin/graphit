...
位于 `graphit-flow/graphit/embeddings/fastembed/processor.py` 中的嵌入式实现存在显著的性能低效问题：
...
**文件:** `graphit-flow/graphit/gateway/dispatch/embeddings.py`
...
**文件：** `graphit-flow/graphit/embeddings/document_embeddings/embeddings.py`
...
**文件：** `graphit-flow/graphit/embeddings/graph_embeddings/embeddings.py`
...
**文件：** `graphit-flow/graphit/embeddings/row_embeddings/embeddings.py`
...
**文件：** `graphit-base/graphit/base/embeddings_client.py`
...
**文件：** `graphit-cli/graphit/cli/invoke_embeddings.py`
...
Python SDK 提供了两个客户端类，用于与 GraphIt 服务进行交互。这两个客户端类仅支持单文本嵌入。

**文件：** `graphit-base/graphit/api/flow.py`
...
**文件：** `graphit-base/graphit/api/socket_client.py`
...
#### 1. **模式增强**
   ...
   模块：`graphit-base/graphit/schema/services/llm.py`
...
#### 2. **基础服务增强**
   ...
   模块：`graphit-base/graphit/base/embeddings_service.py`
...
#### 4. **客户端增强**
   ...
   模块：`graphit-base/graphit/base/embeddings_client.py`
...
#### 6. **API 网关增强**
   ...
   模块：`graphit-flow/graphit/gateway/dispatch/embeddings.py`

#### 7. **CLI 工具增强**
   添加对多个文本或文件输入的支持
   添加批量大小参数

   模块：`graphit-cli/graphit/cli/invoke_embeddings.py`
...
[EmbeddingsService 实现](graphit-base/graphit/base/embeddings_service.py)
