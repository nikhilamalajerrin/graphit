...
当前，工具在`graphit-flow/graphit/agent/react/tools.py`中定义，并具有类型化的实现：
...
`graphit-base/graphit/schema/services/tool_service.py` 中的请求和响应类型：
...
基类位于 `graphit-base/graphit/base/dynamic_tool_service.py`：
...
在 `graphit-flow/graphit/agent/react/tools.py` 中的实现：
...
| 文件 | 目的 |
|------|---------|
| `graphit-base/graphit/schema/services/tool_service.py` | 请求/响应模式 |
| `graphit-base/graphit/base/tool_service_client.py` | 调用服务的客户端 |
| `graphit-base/graphit/base/dynamic_tool_service.py` | 服务实现的基类 |
| `graphit-flow/graphit/agent/react/tools.py` | `ToolServiceImpl` 类 |
| `graphit-flow/graphit/agent/react/service.py` | 配置加载 |

### 示例：笑话服务

一个用 `graphit-flow/graphit/tool_service/joke/` 编写的示例服务：
...
当前工具实现：`graphit-flow/graphit/agent/react/tools.py`
工具注册：`graphit-flow/graphit/agent/react/service.py:105-214`
代理模式：`graphit-base/graphit/schema/services/agent.py`
