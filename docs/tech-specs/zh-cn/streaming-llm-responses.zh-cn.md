...
本规范描述了在GraphIt中实现LLM响应的流式支持。流式传输允许实时交付由LLM生成的token，而不是等待完整的响应生成。
...
当前模式 (`graphit-base/graphit/schema/services/llm.py`)：
...
##### LLM 模式 (`graphit-base/graphit/schema/services/llm.py`)
...
##### 提示模式 (`graphit-base/graphit/schema/services/prompt.py`)
...
**LlmClient 更新** (`graphit-base/graphit/clients/llm_client.py`):
...
**PromptClient 更新** (`graphit-base/graphit/base/prompt_client.py`):
...
**模块：** `graphit-vertexai/graphit/model/text_completion/vertexai/llm.py`
...
| 提供商 | 包 | 流式支持 |
|----------|---------|-------------------|
| OpenAI | graphit-flow | 完全 (原生流式 API) |
| Claude/Anthropic | graphit-flow | 完全 (原生流式 API) |
| Ollama | graphit-flow | 完全 (原生流式 API) |
| Cohere | graphit-flow | 完全 (原生流式 API) |
| Mistral | graphit-flow | 完全 (原生流式 API) |
| Azure OpenAI | graphit-flow | 完全 (原生流式 API) |
| Google AI Studio | graphit-flow | 完全 (原生流式 API) |
| VertexAI | graphit-vertexai | 完全 (第二阶段) |
| Bedrock | graphit-bedrock | 完全 (原生流式 API) |
| LM Studio | graphit-flow | 完全 (与 OpenAI 兼容) |
| LlamaFile | graphit-flow | 完全 (与 OpenAI 兼容) |
| vLLM | graphit-flow | 完全 (与 OpenAI 兼容) |
| TGI | graphit-flow | 待定 |
| Azure | graphit-flow | 待定 |
...
当前 LLM 模式：`graphit-base/graphit/schema/services/llm.py`
当前提示词模式：`graphit-base/graphit/schema/services/prompt.py`
当前代理模式：`graphit-base/graphit/schema/services/agent.py`
LLM 服务基础地址：`graphit-base/graphit/base/llm_service.py`
VertexAI 提供商：`graphit-vertexai/graphit/model/text_completion/vertexai/llm.py`
网关 API：`graphit-base/graphit/api/`
CLI 工具：`graphit-cli/graphit/cli/`
