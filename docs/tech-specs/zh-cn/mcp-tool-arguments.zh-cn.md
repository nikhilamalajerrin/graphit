...
### 相关组件
- **graphit-flow/agent/react/service.py**: 工具配置加载和 AgentManager 创建
- **graphit-flow/agent/react/tools.py**: McpToolImpl 实现
- **graphit-flow/agent/react/agent_manager.py**: 使用工具参数生成提示
- **gr-invoke-mcp-tool**: 用于 MCP 工具管理的 CLI 工具
...
5. **CLI 支持**: 现有的 `gr-invoke-mcp-tool` CLI 支持参数（已实现）
...
- [提示模板工具实现](./graphit-flow/graphit/agent/react/service.py#L114-129)
- [当前的 MCP 工具实现](./graphit-flow/graphit/agent/react/tools.py#L58-86)
