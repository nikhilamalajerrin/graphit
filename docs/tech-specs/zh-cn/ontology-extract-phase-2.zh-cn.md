...
4. **URI 扩展** (`extract.py:473-521`)
   ...
   如果找到，从类定义中提取 URI
   如果未找到，则构建 URI: `f"https://example.com/ontology/{ontology_id}#{value}"`
...
构建的 URI: `https://example.com/ontology/food#Recipe`
语义信息丢失，破坏互操作性
...
当前实现：`graphit-flow/graphit/extract/kg/ontology/extract.py`
