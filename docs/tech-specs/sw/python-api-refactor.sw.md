...
Vipangilio hivi vinaelezea marekebisho kamili ya maktaba ya mteja wa API ya Python ya GraphIt ili kufikia utendaji sawa na API Gateway na kuongeza ufuatiliaji wa mitindo ya kisasa ya mawasiliano ya muda halisi.
...
API ya Python (`graphit-base/graphit/api/`) ni maktaba ya mteja ya REST pekee na moduli zifuatazo:
...
Moduli: `graphit-base/graphit/api/api.py`
...
Moduli: `graphit-base/graphit/api/socket_client.py` (mpya)
...
Moduli: `graphit-base/graphit/api/async_socket_client.py` (mpya)
...
Moduli: `graphit-base/graphit/api/bulk_client.py` (mpya)
...
Moduli: `graphit-base/graphit/api/async_bulk_client.py` (mpya)
...
Moduli: `graphit-base/graphit/api/flow.py`
...
Moduli: `graphit-base/graphit/api/async_flow.py` (mpya)
...
Moduli: `graphit-base/graphit/api/metrics.py` (mpya)
...
Moduli: `graphit-base/graphit/api/types.py` (iliyorekebishwa)
...
### Faili za Utendaji
`graphit-base/graphit/api/` - Chanzo cha API ya Python.
`graphit-flow/graphit/gateway/` - Chanzo cha lango.
`graphit-flow/graphit/gateway/dispatch/mux.py` - Utaratibu wa marejeleo wa mchanganyiko wa WebSocket.
