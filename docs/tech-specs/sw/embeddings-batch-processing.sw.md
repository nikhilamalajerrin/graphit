...
Utaratibu wa matukio katika `graphit-flow/graphit/embeddings/fastembed/processor.py` unaonyesha upotevu mkubwa wa utendaji:
...
**Faili:** `graphit-flow/graphit/gateway/dispatch/embeddings.py`
...
**Faili:** `graphit-flow/graphit/embeddings/document_embeddings/embeddings.py`
...
**Faili:** `graphit-flow/graphit/embeddings/graph_embeddings/embeddings.py`
...
**Faili:** `graphit-flow/graphit/embeddings/row_embeddings/embeddings.py`
...
**Faili:** `graphit-base/graphit/base/embeddings_client.py`
...
**Faili:** `graphit-cli/graphit/cli/invoke_embeddings.py`
...
SDK ya Python hutoa madarasa mawili ya wateja kwa kuingiliana na huduma za GraphIt. Zote mbili zinaunga mkono tu kuingiza maandishi moja.

**Faili:** `graphit-base/graphit/api/flow.py`
...
**Faili:** `graphit-base/graphit/api/socket_client.py`
...
#### 1. **Uboreshaji wa Mfumo**
   ...
   Moduli: `graphit-base/graphit/schema/services/llm.py`
...
#### 2. **Uboreshaji wa Huduma ya Msingi**
   ...
   Moduli: `graphit-base/graphit/base/embeddings_service.py`
...
#### 4. **Uboreshaji kwa Mteja**
   ...
   Moduli: `graphit-base/graphit/base/embeddings_client.py`
...
[Utekelezaji wa Huduma ya Uingizaji](graphit-base/graphit/base/embeddings_service.py)
