...
**Mahali pa Utekelezaji**: `graphit-flow/graphit/extract/kg/ontology/ontology_loader.py`
...
**Mahali pa Utekelezaji**: `graphit-flow/graphit/extract/kg/ontology/ontology_embedder.py`
...
**Mahali pa Utekelezaji**: `graphit-flow/graphit/extract/kg/ontology/text_processor.py`
...
**Mahali pa Utendaji**: `graphit-flow/graphit/extract/kg/ontology/ontology_selector.py`
...
**Mahali pa Utendaji**: `graphit-flow/graphit/extract/kg/ontology/extract.py` (mbinu ya build_extraction_variables)
...
**Mahali pa Utendaji**: `graphit-flow/graphit/extract/kg/ontology/extract.py`

### Usanidi

Huduma hutumia mbinu ya kawaida ya usanidi ya GraphIt na hoja za mstari wa amri:
...
**Mahali pa Utekelezaji**: `graphit-flow/graphit/extract/kg/ontology/vector_store.py`
