...
Kulingana na toleo la `STRUCTURED_DATA.md`, hati hii inatoa mabadiliko muhimu ya mfano wa Pulsar na mabadiliko, ili kupendeza uwezo wa data iliyoundwa katika GraphIt.
...
- `graphit-flow/graphit/decoding/structured` - Inatumia StructuredDataSubmission
- `graphit-flow/graphit/query/nlp_query/cassandra` - Inatumia mifano za sarani
- `graphit-flow/graphit/query/objects/cassandra` - Inatumia mifano za sarani
- `graphit-flow/graphit/extract/object/row/` - Inatumia Chunk, inatoa ExtractedObject
- `graphit-flow/graphit/storage/objects/cassandra` - Inatumia mfano wa Rows
- `graphit-flow/graphit/embeddings/object_embeddings/qdrant` - Inatumia mifano za embedings
