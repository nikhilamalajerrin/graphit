...
<<<<<<< HEAD
Hati hii inaeleza uboreshaji wa kina wa utendaji wa algorithm ya GraphRAG (Graph Retrieval-Augmented Generation) katika GraphIt. Utaratibu wa sasa una matatizo makubwa ya utendaji ambayo yanapunguza uwezo wa kupanuka na wakati wa majibu. Hati hii inashughulikia maeneo manne makuu ya uboreshaji:
...
=======
Maelekezo haya yanaelezea uboreshaji wa kina wa utendaji kwa algorithm ya GraphRAG (Graph Retrieval-Augmented Generation) katika GraphIt. Utaratibu wa sasa una matatizo makubwa ya utendaji ambayo yanapunguza uwezo wa kupanuka na wakati wa majibu. Maelekezo haya yanaangazia maeneo manne makuu ya uboreshaji:
...
Utaratibu wa sasa wa GraphRAG katika `graphit-flow/graphit/retrieval/graph_rag/graph_rag.py` una masuala muhimu ya utendaji ambayo yanaathiri sana uwezo wa kupanuka wa mfumo:
...
Maelezo haya yanaangazia pengo hizi kwa kutumia maswali ya kikundi, uhifadhi mahiri, na usindikaji wa sambamba. Kwa kuboresha mifumo ya maswali na ufikiaji wa data, GraphIt inaweza:
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   Moduli: `graphit-flow/graphit/retrieval/graph_rag/rag.py` (iliyorekebishwa)
...
#### 2. **Injini Iliyoboreshwa ya Ufuatiliaji wa Vielelezo**
   ...
   Moduli: `graphit-flow/graphit/retrieval/graph_rag/optimized_traversal.py`
...
#### 3. **Mfumo wa Ufafanuzi wa Lebo Sambamba**
   ...
   Moduli: `graphit-flow/graphit/retrieval/graph_rag/label_resolver.py`
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   Moduli: `graphit-flow/graphit/retrieval/graph_rag/cache_manager.py`
...
#### 5. **Mfumo wa Uboreshaji wa Swali**
   ...
   Moduli: `graphit-flow/graphit/retrieval/graph_rag/query_optimizer.py`
...
class GraphRag:
    async def query(self, query, user="graphit", collection="default", ...):
...
[Utekelezaji Asili wa GraphRAG](graphit-flow/graphit/retrieval/graph_rag/graph_rag.py)
<<<<<<< HEAD
[Kanuni za Usanifu wa GraphIt](architecture-principles.md)
=======
[Kanuni za Usawa wa GraphIt](architecture-principles.md)
>>>>>>> 82edf2d (New md files from RunPod)
