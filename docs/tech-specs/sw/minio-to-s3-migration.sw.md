...
**Mahali:** `graphit-flow/graphit/librarian/blob_store.py`
**Tendo:**
...
### Faili Muhimu
1. `graphit-flow/graphit/librarian/blob_store.py` - Utendaji wa BlobStore
2. `graphit-flow/graphit/librarian/librarian.py` - Uanzishaji wa BlobStore
3. `graphit-flow/graphit/librarian/service.py` - Usanidi wa huduma
4. `graphit-flow/pyproject.toml` - Utendakazi (pakiti ya `minio`)
