...
### Vipengele Vinavyohusiana
   **graphit-flow/agent/react/service.py**: Kupakia usanidi wa zana na uundaji wa AgentManager.
**graphit-flow/agent/react/tools.py**: Utendaji wa McpToolImpl.
**graphit-flow/agent/react/agent_manager.py**: Uundaji wa maagizo pamoja na hoja za zana.
**graphit-cli**: Vifaa vya CLI kwa usimamizi wa zana za MCP.
...
5. **Usaidizi wa CLI**: CLI ya `gr-invoke-mcp-tool` iliyopo inasaidia vigezo (tayari imetekelezwa).
...
**Uunganisho wa CLI**: Jaribu kama `gr-invoke-mcp-tool` inafanya kazi na zana za MCP ambazo zimepangwa na hoja.
...
[Utekelezaji wa Zana ya Kiolezo ya Maagizo](./graphit-flow/graphit/agent/react/service.py#L114-129)
[Utekelezaji wa Sasa wa Zana ya MCP](./graphit-flow/graphit/agent/react/tools.py#L58-86)
