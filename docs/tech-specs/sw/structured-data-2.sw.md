...
Maelezo haya yanaeleza masuala na pengo ambazo zimetambuliwa wakati wa utekelezaji wa awali wa ujumuishaji wa takwimu zilizopangwa wa GraphIt, kama ilivyoelezwa katika `structured-data.md`.
...
**Hatua ya 1: Hesabu ya uwekaji** (`graphit-flow/graphit/embeddings/row_embeddings/`) - Hutumia `ExtractedObject`, huhesabu uwekaji kupitia huduma ya uwekaji, hutoka `RowEmbeddings`.
**Hatua ya 2: Uhifadhi wa uwekaji** (`graphit-flow/graphit/storage/row_embeddings/qdrant/`) - Hutumia `RowEmbeddings`, huandika vectori kwenye Qdrant.

Mwandishi wa mistari wa Cassandra ni mtumiaji wa ziada unaoendeshwa kwa njia fiche:

**Mwandishi wa mistari wa Cassandra** (`graphit-flow/graphit/storage/rows/cassandra`) - Hutumia `ExtractedObject`, huandika mistari kwenye Cassandra.
...
|-------|--------|-------------|
| Hatua 1 | `graphit-flow/graphit/embeddings/row_embeddings/` | `row-embeddings` |
| Hatua 2 | `graphit-flow/graphit/storage/row_embeddings/qdrant/` | `row-embeddings-write-qdrant` |
...
Moduli: `graphit-flow/graphit/query/row_embeddings/qdrant`
...
| Sehemu | Mahali |
|-----------|----------|
| Msambazaji | `graphit-flow/graphit/gateway/dispatch/row_embeddings_query.py` |
...
|-----------|----------|-------|-------------|
| Huduma ya Utafutaji | `graphit-flow/graphit/query/objects/cassandra/service.py` | ~740 | Moja kwa moja: Uundaji wa schema ya GraphQL, uchanganuzi wa vichujio, maswali ya Cassandra, usimamizi wa ombi |
| Mwandishi | `graphit-flow/graphit/storage/objects/cassandra/write.py` | ~540 | Uundaji wa jedwali kwa kila schema, fahirisi za sekondari, kuingiza/kufuta |
...
**Mwandishi** (`graphit-flow/graphit/storage/rows/cassandra/`):
...
**Huduma ya Utafiti** (`graphit-flow/graphit/query/rows/cassandra/`):
...
| Moduli | Lengo |
|--------|---------|
| `graphit-flow/graphit/query/graphql/` | Utumizi wa pamoja wa GraphQL. |
| `graphit-flow/graphit/query/row_embeddings/qdrant/` | API ya utafiti wa uingishaji wa mstari. |
| `graphit-flow/graphit/embeddings/row_embeddings/` | Hesabu ya uingishaji wa mstari (Hatua ya 1). |
| `graphit-flow/graphit/storage/row_embeddings/qdrant/` | Uhifadhi wa uingishaji wa mstari (Hatua ya 2). |
