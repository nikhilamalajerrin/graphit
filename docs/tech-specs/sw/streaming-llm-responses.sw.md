...
katika GraphIt. Utiririshaji unawezesha utoaji wa wakati halisi wa alama (tokens)
...
Muundo wa sasa (`graphit-base/graphit/schema/services/llm.py`):
...
##### Muundo wa LLM (`graphit-base/graphit/schema/services/llm.py`)
...
##### Muundo wa Ombi (`graphit-base/graphit/schema/services/prompt.py`)
...
**Sasisho za LlmClient** (`graphit-base/graphit/clients/llm_client.py`):
...
**Sasisho za PromptClient** (`graphit-base/graphit/base/prompt_client.py`):
...
**Moduli:** `graphit-vertexai/graphit/model/text_completion/vertexai/llm.py`
...
|----------|---------|-------------------|
| OpenAI | graphit-flow | Kamili (API ya asili ya utiririshaji) |
| Claude/Anthropic | graphit-flow | Kamili (API ya asili ya utiririshaji) |
| Ollama | graphit-flow | Kamili (API ya asili ya utiririshaji) |
| Cohere | graphit-flow | Kamili (API ya asili ya utiririshaji) |
| Mistral | graphit-flow | Kamili (API ya asili ya utiririshaji) |
| Azure OpenAI | graphit-flow | Kamili (API ya asili ya utiririshaji) |
| Google AI Studio | graphit-flow | Kamili (API ya asili ya utiririshaji) |
| VertexAI | graphit-vertexai | Kamili (Awamu ya 2) |
| Bedrock | graphit-bedrock | Kamili (API ya asili ya utiririshaji) |
| LM Studio | graphit-flow | Kamili (Inafaa na OpenAI) |
| LlamaFile | graphit-flow | Kamili (Inafaa na OpenAI) |
| vLLM | graphit-flow | Kamili (Inafaa na OpenAI) |
| TGI | graphit-flow | Itatolewa baadaye |
| Azure | graphit-flow | Itatolewa baadaye |
...
Muundo wa sasa wa LLM: `graphit-base/graphit/schema/services/llm.py`
Muundo wa sasa wa prompt: `graphit-base/graphit/schema/services/prompt.py`
Muundo wa sasa wa wakala: `graphit-base/graphit/schema/services/agent.py`
Msingi wa huduma ya LLM: `graphit-base/graphit/base/llm_service.py`
Mtoa huduma wa VertexAI: `graphit-vertexai/graphit/model/text_completion/vertexai/llm.py`
API ya lango: `graphit-base/graphit/api/`
Zana za CLI: `graphit-cli/graphit/cli/`
