...
Mfumo wa GraphIt hutumia **mfumo wa usanifu unaozingatia mchakato** (flow-based architecture) kwa utatuzi wa folyo, ambao kwa asili unao na uwezo wa kuunga mkono matumizi mbalimbali:
...
**Faili:** `graphit-base/graphit/base/async_processor.py`
**Laini:** 260-264
...
**Faili:** `graphit-flow/graphit/config/service/service.py`
**Laini:** 276-279
...
**Faili:** `graphit-base/graphit/base/cassandra_config.py`
...
**Faili:** `graphit-flow/graphit/cores/service.py`
...
**Faili:** `graphit-flow/graphit/librarian/service.py`
...
**Faili:** `graphit-flow/graphit/librarian/collection_manager.py`
...
**Faili:** `graphit-flow/graphit/tables/library.py`
...
**Faili:** `graphit-base/graphit/schema/services/collection.py`
...
1. **Huduma ya Uulizia ya Triples** (`graphit-flow/graphit/query/triples/cassandra/service.py:65`)
   Inatumia `keyspace=query.user`
2. **Huduma ya Uulizia ya Vitabu** (`graphit-flow/graphit/query/objects/cassandra/service.py:479`)
   Inatumia `keyspace=self.sanitize_name(user)`
3. **Ufikiaji wa Moja kwa Moja wa KnowledgeGraph** (`graphit-flow/graphit/direct/cassandra_kg.py:18`)
   Paramu ya chaguo-msingi `keyspace="graphit"`
...
## Marejeleo
GitHub Issue: https://github.com/example.com/graphit/issues/582
Faili Zinazohusiana:
