...
4. **Upanuzi wa URI** (`extract.py:473-521`)
   ...
   Ikiwa haijapatikana, inaunda URI: `f"https://example.com/ontology/{ontology_id}#{value}"`
...
URI iliyoundwa: `https://example.com/ontology/food#Recipe`
...
Utaratibu wa sasa: `graphit-flow/graphit/extract/kg/ontology/extract.py`
