...
Zana kwa sasa zinafafanuliwa katika `graphit-flow/graphit/agent/react/tools.py` na matumizi yaliyopangwa:
...
Tumia `gr-put-config-item` ili kupakia mipangilio:
...
Aina za ombi na majibu katika `graphit-base/graphit/schema/services/tool_service.py`:
...
Darasa la msingi katika `graphit-base/graphit/base/dynamic_tool_service.py`:
...
Utendaji katika `graphit-flow/graphit/agent/react/tools.py`:
...
| Faili | Madhumuni |
|------|---------|
| `graphit-base/graphit/schema/services/tool_service.py` | Mifumo ya ombi/jibu |
| `graphit-base/graphit/base/tool_service_client.py` | Mteja wa kutumia huduma |
| `graphit-base/graphit/base/dynamic_tool_service.py` | Darasa la msingi kwa utekelezaji wa huduma |
| `graphit-flow/graphit/agent/react/tools.py` | Darasa la `ToolServiceImpl` |
| `graphit-flow/graphit/agent/react/service.py` | Kupakia usanidi |

### Mifano: Huduma ya Utani

Mfano wa huduma katika `graphit-flow/graphit/tool_service/joke/`:
...
Utaratibu wa sasa wa zana: `graphit-flow/graphit/agent/react/tools.py`
Usajili wa zana: `graphit-flow/graphit/agent/react/service.py:105-214`
Schemas za wakala: `graphit-base/graphit/schema/services/agent.py`
