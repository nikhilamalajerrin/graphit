...
Maelezo haya yanashughulikia masuala ya utendaji katika utekelezaji wa hifadhidata ya maarifa ya GraphIt ya Cassandra na yanapendekeza uboreshaji kwa uhifadhi na utafutaji wa data ya RDF.

## Utendaji wa Sasa

### Muundo wa Skimu

Utendaji wa sasa hutumia muundo wa jedwali moja katika `graphit-flow/graphit/direct/cassandra_kg.py`:
...
**Faili: `graphit-flow/graphit/direct/cassandra_kg.py`**
...
**Njia ya Kuandika:** `graphit-flow/graphit/storage/triples/cassandra/write.py`
**Njia ya Umasilisho:** `graphit-flow/graphit/query/triples/cassandra/service.py`
**Hifadhi ya Maarifa:** `graphit-flow/graphit/tables/knowledge.py`
...
**`graphit-flow/graphit/direct/cassandra_kg.py`** - Inahitajika kuandikwa upya kabisa.
