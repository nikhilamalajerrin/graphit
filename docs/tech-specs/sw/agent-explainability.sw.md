...
GraphRAG na Agent hutumia PROV-O kama ontolojia ya msingi na aina za ziada maalum za GraphIt:
...
|---------|-------------|-----------|
| `tg:GraphRagQuestion` | `urn:graphit:question:{uuid}` | RAG ya grafu ya maarifa |
| `tg:DocRagQuestion` | `urn:graphit:docrag:{uuid}` | RAG ya hati/sehemu |
| `tg:AgentQuestion` | `urn:graphit:agent:{uuid}` | Wakala wa ReAct |
...
**Faili:** `graphit-base/graphit/schema/services/agent.py`
...
**Faidio:** `graphit-base/graphit/messaging/translators/agent.py`
...
**Faidio:** `graphit-flow/graphit/agent/react/service.py`
...
**Faili:** `graphit-base/graphit/provenance/agent.py`
...
**Faili:** `graphit-base/graphit/provenance/namespaces.py`
...
| Faili | Mabadiliko |
|------|--------|
| `graphit-base/graphit/schema/services/agent.py` | Ongeza `session_id` na `collection` kwenye `AgentRequest` |
| `graphit-base/graphit/messaging/translators/agent.py` | Sasisha `translator` kwa ajili ya sehemu mpya |
| `graphit-base/graphit/provenance/namespaces.py` | Ongeza aina za `entity`, `agent predicates`, na `Document RAG predicates` |
| `graphit-base/graphit/provenance/triples.py` | Ongeza aina za `TG` kwenye `GraphRAG triple builders`, ongeza `Document RAG triple builders` |
| `graphit-base/graphit/provenance/uris.py` | Ongeza `Document RAG URI generators` |
| `graphit-base/graphit/provenance/__init__.py` | Export aina mpya, `predicates`, na `Document RAG functions` |
| `graphit-base/graphit/schema/services/retrieval.py` | Ongeza `explain_id` na `explain_graph` kwenye `DocumentRagResponse` |
| `graphit-base/graphit/messaging/translators/retrieval.py` | Sasisha `DocumentRagResponseTranslator` kwa ajili ya sehemu za `explainability` |
| `graphit-flow/graphit/agent/react/service.py` | Ongeza mzalishaji wa `explainability` + mantiki ya kurekodi |
| `graphit-flow/graphit/retrieval/document_rag/document_rag.py` | Ongeza `explainability callback` na toa `provenance triples` |
| `graphit-flow/graphit/retrieval/document_rag/rag.py` | Ongeza mzalishaji wa `explainability` na uunganishe `callback` |
| `graphit-cli/graphit/cli/show_explain_trace.py` | Shirikisha aina za `agent trace` |
| `graphit-cli/graphit/cli/list_explain_traces.py` | Orodha `agent sessions` pamoja na `GraphRAG` |

## Faili Zilizoundwa

| Faili | Madhumuni |
|------|---------|
| `graphit-base/graphit/provenance/agent.py` | Wazalishaji wa `triple` maalum kwa `agent` |

## Mabadiliko ya CLI

**Kugundua:** Maswali ya `GraphRAG` na `Agent` yana aina ya `tg:Question`. Hutofautishwa na:
1. Mfumo wa `URI`: `urn:graphit:agent:` dhidi ya `urn:graphit:question:`
