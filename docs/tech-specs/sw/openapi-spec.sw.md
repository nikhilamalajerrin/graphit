...
Kuunda maelezo kamili na yanayoweza kutenganishwa ya OpenAPI 3.1 kwa lango la API la GraphIt ambalo:
...
**Wasimamizi wa Tafsiri ya Ujumbe**: `graphit-base/graphit/messaging/translators/*.py`
**Meneja wa Msambazaji**: `graphit-flow/graphit/gateway/dispatch/manager.py`
**Meneja wa Kikoa**: `graphit-flow/graphit/gateway/endpoint/manager.py`
...
Kwa kila mtumizi katika `graphit-base/graphit/messaging/translators/`:
...
Watengenezaji: `graphit-base/graphit/messaging/translators/`
Ramani ya utumaji: `graphit-flow/graphit/gateway/dispatch/manager.py`
Uelekezaji wa mwisho: `graphit-flow/graphit/gateway/endpoint/manager.py`
