...
Maelezo haya yanaeleza utekelezaji wa vigezo vinavyoweza kubadilishwa kwa mifumo ya uwekaji njia (flow blueprints) katika GraphIt. Vigezo huruhusu watumiaji kubadilisha vigezo vya kichakato (processor) wakati wa kuanzisha mfumo wa uwekaji njia kwa kutoa maadili ambayo hubadilisha nafasi za vigezo katika ufafanuzi wa mfumo wa uwekaji njia.
...
<<<<<<< HEAD
Mifumo ya uwekaji njia katika GraphIt sasa inaunga mkono vigezo vya kichakato ambavyo yanaweza kuwa na maadili thabiti au nafasi za vigezo. Hii huunda fursa ya urekebishaji wakati wa utendaji.
=======
Mifumo ya uwekaji njia katika GraphIt sasa inasaidia vigezo vya kichakato ambavyo yanaweza kuwa na maadili thabiti au nafasi za vigezo. Hii huunda fursa ya urekebishaji wakati wa utendaji.
>>>>>>> 82edf2d (New md files from RunPod)
...
Kwa kutumia vigezo vya kichakato, GraphIt inaweza:
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   Moduli: graphit-flow/graphit/flow/definition.py
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   Moduli: graphit-flow/graphit/flow/parameter_resolver.py
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   Moduli: graphit-flow/graphit/flow/parameter_store.py
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   Moduli: graphit-flow/graphit/flow/launcher.py
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   Moduli: graphit-ui/components/flow-parameters/
...
Huduma ya usanidi wa mchakato (`graphit-flow/graphit/config/service/flow.py`) inahitaji maboresho yafuatayo:
