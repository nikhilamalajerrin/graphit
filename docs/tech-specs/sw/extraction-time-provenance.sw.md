...
`graphit-flow/graphit/librarian/librarian.py` - Operesheni muhimu za msimamizi wa maktaba
`graphit-flow/graphit/librarian/service.py` - Mchakato wa huduma, upakaji hati
`graphit-flow/graphit/tables/library.py` - Duka la meza ya Cassandra
`graphit-base/graphit/schema/services/library.py` - Ufafanuzi wa mpango
...
| Aina ya PROV-O | Matumizi katika GraphIt |
|-------------|------------------|
...
#### Miongozo ya Upanuzi wa Nafasi ya GraphIt
