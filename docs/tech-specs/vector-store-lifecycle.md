...
This document describes how GraphIt manages vector store collections across different backend implementations (Qdrant, Pinecone, Milvus). The design addresses the challenge of supporting embeddings with different dimensions without hardcoding dimension values.
...
- A single GraphIt collection may receive embeddings from multiple models
...
- Storage Schema: `graphit-base/graphit/schema/services/storage.py`
- Librarian Service: `graphit-flow/graphit/librarian/service.py`
