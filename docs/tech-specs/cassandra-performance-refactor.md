...
This specification addresses performance issues in the GraphIt Cassandra knowledge base implementation and proposes optimizations for RDF triple storage and querying.

## Current Implementation

### Schema Design

The current implementation uses a single table design in `graphit-flow/graphit/direct/cassandra_kg.py`:
...
**File: `graphit-flow/graphit/direct/cassandra_kg.py`**
...
**Integration Points:**
- **Write Path:** `graphit-flow/graphit/storage/triples/cassandra/write.py`
- **Query Path:** `graphit-flow/graphit/query/triples/cassandra/service.py`
- **Knowledge Store:** `graphit-flow/graphit/tables/knowledge.py`
...
**`graphit-flow/graphit/direct/cassandra_kg.py`** - Complete rewrite required
