...
**Implementation Location**: `graphit-flow/graphit/extract/kg/ontology/ontology_loader.py`
...
**Implementation Location**: `graphit-flow/graphit/extract/kg/ontology/ontology_embedder.py`
...
**Implementation Location**: `graphit-flow/graphit/extract/kg/ontology/text_processor.py`
...
**Implementation Location**: `graphit-flow/graphit/extract/kg/ontology/ontology_selector.py`
...
**Implementation Location**: `graphit-flow/graphit/extract/kg/ontology/extract.py` (build_extraction_variables method)
...
**Implementation Location**: `graphit-flow/graphit/extract/kg/ontology/extract.py`

### Configuration

The service uses GraphIt's standard configuration approach with command-line arguments:
...
**Implementation Location**: `graphit-flow/graphit/extract/kg/ontology/vector_store.py`
