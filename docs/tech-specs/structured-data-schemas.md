...
Based on the STRUCTURED_DATA.md specification, this document proposes the necessary Pulsar schema additions and modifications to support structured data capabilities in GraphIt.
...
- `graphit-flow/graphit/decoding/structured` - Uses StructuredDataSubmission
- `graphit-flow/graphit/query/nlp_query/cassandra` - Uses NLP query schemas
- `graphit-flow/graphit/query/objects/cassandra` - Uses structured query schemas
- `graphit-flow/graphit/extract/object/row/` - Consumes Chunk, produces ExtractedObject
- `graphit-flow/graphit/storage/objects/cassandra` - Uses Rows schema
- `graphit-flow/graphit/embeddings/object_embeddings/qdrant` - Uses object embedding schemas
