...
This specification describes the implementation of configurable parameters for flow blueprintes in GraphIt. Parameters enable users to customize processor parameters at flow launch time by providing values that replace parameter placeholders in the flow blueprint definition.
...
Flow blueprintes in GraphIt now support processor parameters that can contain either fixed values or parameter placeholders. This creates an opportunity for runtime customization.
...
By leveraging parameterized processor parameters, GraphIt can:
...
1. **Parameter Schema Definition**
   ...
   Module: graphit-flow/graphit/flow/definition.py
...
2. **Parameter Resolution Engine**
   ...
   Module: graphit-flow/graphit/flow/parameter_resolver.py
...
3. **Parameter Store Integration**
   ...
   Module: graphit-flow/graphit/flow/parameter_store.py
...
4. **Flow Launcher Extensions**
   ...
   Module: graphit-flow/graphit/flow/launcher.py
...
5. **UI Parameter Forms**
   ...
   Module: graphit-ui/components/flow-parameters/
...
The flow configuration service (`graphit-flow/graphit/config/service/flow.py`) requires the following enhancements:
