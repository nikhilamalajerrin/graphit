...
يصف هذا المستند كيفية إدارة GraphIt لمجموعات مستودعات المتجهات عبر تطبيقات خلفية مختلفة (Qdrant، Pinecone، Milvus). يعالج التصميم تحدي دعم التضمينات بأبعاد مختلفة دون ترميز قيم الأبعاد بشكل ثابت.
...
قد تتلقى مجموعة GraphIt واحدة تضمينات من نماذج متعددة
...
مخطط التخزين: `graphit-base/graphit/schema/services/storage.py`
خدمة أمين المكتبة: `graphit-flow/graphit/librarian/service.py`
