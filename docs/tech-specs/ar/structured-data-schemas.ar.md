...
استنادًا إلى مواصفات `STRUCTURED_DATA.md`، تقترح هذه الوثيقة الإضافات والتعديلات اللازمة على مخطط Pulsar لدعم قدرات البيانات المنظمة في GraphIt.
...
- `graphit-flow/graphit/decoding/structured` - يستخدم StructuredDataSubmission
- `graphit-flow/graphit/query/nlp_query/cassandra` - يستخدم مخططات استعلام NLP
- `graphit-flow/graphit/query/objects/cassandra` - يستخدم مخططات استعلام منظمة
- `graphit-flow/graphit/extract/object/row/` - يستهلك Chunk، وينتج ExtractedObject
- `graphit-flow/graphit/storage/objects/cassandra` - يستخدم مخطط Rows
- `graphit-flow/graphit/embeddings/object_embeddings/qdrant` - يستخدم مخططات تضمين الكائنات
