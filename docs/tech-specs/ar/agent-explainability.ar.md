...
يستخدم كل من GraphRAG والوكيل PROV-O كعلم الوجود الأساسي مع أنواع فرعية خاصة بـ GraphIt:
...
|---------|-------------|-----------|
| `tg:GraphRagQuestion` | `urn:graphit:question:{uuid}` | RAG للرسم البياني المعرفي |
| `tg:DocRagQuestion` | `urn:graphit:docrag:{uuid}` | RAG للوثائق/الأجزاء |
| `tg:AgentQuestion` | `urn:graphit:agent:{uuid}` | وكيل ReAct |
...
**الملف:** `graphit-base/graphit/schema/services/agent.py`
...
**الملف:** `graphit-base/graphit/provenance/agent.py`
...
**الملف:** `graphit-base/graphit/provenance/namespaces.py`
...
| الملف | التغيير |
|------|--------|
| `graphit-base/graphit/schema/services/agent.py` | إضافة session_id و collection إلى AgentRequest |
| `graphit-base/graphit/messaging/translators/agent.py` | تحديث المترجم للحقول الجديدة |
| `graphit-base/graphit/provenance/namespaces.py` | إضافة أنواع الكيانات، وعبارات الوكيل، وأنواع Document RAG |
| `graphit-base/graphit/provenance/triples.py` | إضافة أنواع TG إلى أدوات بناء الثلاثيات GraphRAG، وإضافة أدوات بناء الثلاثيات Document RAG |
| `graphit-base/graphit/provenance/uris.py` | إضافة مولدات URI لـ Document RAG |
| `graphit-base/graphit/provenance/__init__.py` | تصدير الأنواع والعبارات الجديدة ووظائف Document RAG |
| `graphit-base/graphit/schema/services/retrieval.py` | إضافة explain_id و explain_graph إلى DocumentRagResponse |
| `graphit-base/graphit/messaging/translators/retrieval.py` | تحديث DocumentRagResponseTranslator للحقول الخاصة بالقدرة على الشرح |
| `graphit-flow/graphit/agent/react/service.py` | إضافة منطق الإنتاج والتسجيل الخاص بالقدرة على الشرح |
| `graphit-flow/graphit/retrieval/document_rag/document_rag.py` | إضافة استدعاء رد (callback) خاص بالقدرة على الشرح وإصدار ثلاثيات المصدر |
| `graphit-flow/graphit/retrieval/document_rag/rag.py` | إضافة مُنتج القدرة على الشرح وربطه بالاستدعاء الردي |
| `graphit-cli/graphit/cli/show_explain_trace.py` | معالجة أنواع تتبع الوكيل |
| `graphit-cli/graphit/cli/list_explain_traces.py` | عرض جلسات الوكيل جنبًا إلى جنب مع GraphRAG |

## الملفات التي تم إنشاؤها

| الملف | الغرض |
|------|---------|
| `graphit-base/graphit/provenance/agent.py` | مولدات ثلاثيات خاصة بالوكيل |

## تحديثات واجهة سطر الأوامر (CLI)

**الكشف:** كل من GraphRAG والأسئلة الخاصة بالوكيل لهما نوع `tg:Question`. يتم التمييز بينهما بواسطة:
1. نمط URI: `urn:graphit:agent:` مقابل `urn:graphit:question:`
