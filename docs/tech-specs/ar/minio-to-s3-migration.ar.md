...
**الموقع**: `graphit-flow/graphit/librarian/blob_store.py`
**العمليات**:
...
### الملفات الرئيسية
1. `graphit-flow/graphit/librarian/blob_store.py` - تطبيق BlobStore
2. `graphit-flow/graphit/librarian/librarian.py` - تهيئة BlobStore
3. `graphit-flow/graphit/librarian/service.py` - تكوين الخدمة
4. `graphit-flow/pyproject.toml` - التبعيات (حزمة `minio`)
