...
تصف هذه المواصفات قدرات التكوين المتقدمة لسطر الأوامر لـ GraphIt، مما يمكّن المستخدمين من إدارة عناصر التكوين الفردية من خلال أوامر سطر الأوامر التفصيلية. يدعم التكامل أربعة حالات استخدام رئيسية:
...
*   **نمط سطر أوامر متسق**: اتباع قواعد GraphIt CLI الراسخة وأنماطها
...
يوفر GraphIt حاليًا إدارة التكوين من خلال واجهة API للتكوين وأمر سطر أوامر واحد `gr-show-config` الذي يعرض التكوين بأكمله. على الرغم من أن هذا يعمل في عرض التكوين، إلا أنه يفتقر إلى قدرات الإدارة التفصيلية.
...
تتعالج هذه المواصفات هذه الثغرات من خلال إضافة أربعة أوامر سطر أوامر جديدة التي توفر إدارة التكوين التفصيلية. من خلال الكشف عن عمليات واجهة API للتكوين الفردية من خلال أوامر سطر الأوامر، يمكن لـ GraphIt:
...
1.  **gr-list-config-items**
    ...
    *   إخراج قائمة بمفاتيح التكوين
    ...
    وحدة: `graphit.cli.list_config_items`
...
2.  **gr-get-config-item**
    ...
    *   إخراج قيم التكوين بتنسيق JSON
    ...
    وحدة: `graphit.cli.get_config_item`
...
3.  **gr-put-config-item**
    ...
    *   قبول معلمات النوع والمفتاح والقيمة
    ...
    وحدة: `graphit.cli.put_config_item`
...
4.  **gr-delete-config-item**
    ...
    *   قبول معلمات النوع والمفتاح
    ...
    وحدة: `graphit.cli.delete_config_item`

### نماذج البيانات

#### ConfigKey و ConfigValue

تستخدم الأوامر هياكل البيانات الموجودة من `graphit.api.types`:
...
*   واجهة API للتكوين: `graphit/api/config.py`
*   أنماط سطر الأوامر: `graphit-cli/graphit/cli/show_config.py`
*   أنواع البيانات: `graphit/api/types.py`
