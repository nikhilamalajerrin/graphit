...
تصف هذه المواصفات إعادة هيكلة شاملة لمكتبة عميل واجهة برمجة التطبيقات (API) الخاصة بـ Python لـ GraphIt لتحقيق التوافق مع واجهة برمجة التطبيقات (API) والبوابة وإضافة دعم لأنماط الاتصال في الوقت الفعلي الحديثة.
...
واجهة برمجة التطبيقات (API) الخاصة بـ Python (`graphit-base/graphit/api/`) هي مكتبة عميل REST فقط مع الوحدات التالية:
...
الوحدة: `graphit-base/graphit/api/api.py`
...
الوحدة: `graphit-base/graphit/api/socket_client.py` (جديد)
...
الوحدة: `graphit-base/graphit/api/async_socket_client.py` (جديد)
...
الوحدة: `graphit-base/graphit/api/bulk_client.py` (جديد)
...
الوحدة: `graphit-base/graphit/api/async_bulk_client.py` (جديد)
...
الوحدة: `graphit-base/graphit/api/flow.py`
...
الوحدة: `graphit-base/graphit/api/async_flow.py` (جديد)
...
الوحدة: `graphit-base/graphit/api/metrics.py` (جديد).
...
الوحدة: `graphit-base/graphit/api/types.py` (معدلة)
...
### ملفات التنفيذ
`graphit-base/graphit/api/` - مصدر واجهة برمجة التطبيقات (API) بلغة Python
`graphit-flow/graphit/gateway/` - مصدر البوابة
`graphit-flow/graphit/gateway/dispatch/mux.py` - تطبيق مرجعي لتقسيم WebSocket
