...
4. **توسيع الـ URI** (`extract.py:473-521`)
   ...
   إذا لم يتم العثور عليها، يتم إنشاء الـ URI: `f"https://example.com/ontology/{ontology_id}#{value}"`
...
عنوان URI المُنشأ: `https://example.com/ontology/food#Recipe`
...
التنفيذ الحالي: `graphit-flow/graphit/extract/kg/ontology/extract.py`
