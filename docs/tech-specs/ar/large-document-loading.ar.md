...
المستندات الكبيرة في GraphIt. تعالج البنية الحالية تحميل المستندات
...
الملفات الرئيسية:
نقطة الدخول REST/WebSocket: `graphit-flow/graphit/gateway/service.py`
النواة الأساسية لـ Librarian: `graphit-flow/graphit/librarian/librarian.py`
تخزين الكائنات الثنائية: `graphit-flow/graphit/librarian/blob_store.py`
جداول Cassandra: `graphit-flow/graphit/tables/library.py`
مخطط API: `graphit-base/graphit/schema/services/library.py`
...
**الملف:** `graphit-flow/graphit/librarian/blob_store.py`
...
يجب أن تتعامل حزمة تطوير البرمجيات (SDK) بلغة بايثون (`graphit-base/graphit/api/library.py`) مع عمليات التحميل المقسمة بشفافية. يظل الواجهة العامة دون تغيير:
...
**`gr-add-library-document`** يستمر في العمل دون تغيير:
...
`gr-load-pdf` - قديمة، استخدم `gr-add-library-document`
`gr-load-text` - قديمة، استخدم `gr-add-library-document`
