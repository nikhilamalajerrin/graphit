...
يُظهر تطبيق التضمينات في `graphit-flow/graphit/embeddings/fastembed/processor.py` عدم كفاءة كبيرة في الأداء:
...
**الملف:** `graphit-flow/graphit/gateway/dispatch/embeddings.py`
...
**الملف:** `graphit-flow/graphit/embeddings/document_embeddings/embeddings.py`
...
**الملف:** `graphit-flow/graphit/embeddings/graph_embeddings/embeddings.py`
...
**الملف:** `graphit-flow/graphit/embeddings/row_embeddings/embeddings.py`
...
**الملف:** `graphit-base/graphit/base/embeddings_client.py`
...
**الملف:** `graphit-cli/graphit/cli/invoke_embeddings.py`
...
توفر حزمة تطوير البرمجيات الخاصة بـ Python فئتين من العملاء للتفاعل مع خدمات GraphIt. تدعم كلتاهما فقط التضمين لنص واحد.

**الملف:** `graphit-base/graphit/api/flow.py`
...
**الملف:** `graphit-base/graphit/api/socket_client.py`
...
#### 1. **تحسين المخطط**
   ...
   الوحدة: `graphit-base/graphit/schema/services/llm.py`
...
#### 2. **تحسين الخدمة الأساسية**
   ...
   الوحدة: `graphit-base/graphit/base/embeddings_service.py`
...
#### 4. **تحسين العميل**
   ...
   الوحدة: `graphit-base/graphit/base/embeddings_client.py`
...
#### 6. **تحسين بوابة واجهة برمجة التطبيقات**
   ...
   الوحدة: `graphit-flow/graphit/gateway/dispatch/embeddings.py`

#### 7. **تحسين أداة سطر الأوامر**
   أضف دعمًا للنصوص المتعددة أو إدخال الملف.
   أضف معلمة حجم الدفعة.

   الوحدة: `graphit-cli/graphit/cli/invoke_embeddings.py`
...
[تنفيذ EmbeddingsService](graphit-base/graphit/base/embeddings_service.py)
