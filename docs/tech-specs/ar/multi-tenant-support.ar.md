...
يستخدم نظام GraphIt بنية **قائمة انتظار قائمة على التدفق** لحل ديناميكي لقوائم الانتظار، والتي تدعم بشكل طبيعي البيئات متعددة المستأجرين:
...
**الملف:** `graphit-base/graphit/base/async_processor.py`
**السطر:** 260-264
...
**الملف:** `graphit-flow/graphit/config/service/service.py`
**السطر:** 276-279
...
**الملف:** `graphit-base/graphit/base/cassandra_config.py`
...
**الملف:** `graphit-flow/graphit/cores/service.py`
...
**الملف:** `graphit-flow/graphit/librarian/service.py`
...
**الملف:** `graphit-flow/graphit/librarian/collection_manager.py`
...
**الملف:** `graphit-flow/graphit/tables/library.py`
...
**الملف:** `graphit-base/graphit/schema/services/collection.py`
...
1. **خدمة استعلام الثلاثيات** (`graphit-flow/graphit/query/triples/cassandra/service.py:65`)
   تستخدم `keyspace=query.user`
2. **خدمة استعلام الكائنات** (`graphit-flow/graphit/query/objects/cassandra/service.py:479`)
   تستخدم `keyspace=self.sanitize_name(user)`
3. **الوصول المباشر إلى الرسم البياني المعرفي** (`graphit-flow/graphit/direct/cassandra_kg.py:18`)
   المعلمة الافتراضية `keyspace="graphit"`
...
## المراجع
مشكلة GitHub: https://github.com/example.com/graphit/issues/582
الملفات ذات الصلة:
