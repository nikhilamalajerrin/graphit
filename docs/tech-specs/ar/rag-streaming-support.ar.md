...
- **تجربة تدفق متسقة**: توفير تجربة تدفق متسقة عبر جميع خدمات GraphIt.
...
- تجربة غير متسقة مقارنة بـ خدمات GraphIt الأخرى.

تستجيب هذه المواصفات لهذه الثغرات من خلال إضافة دعم التدفق إلى GraphRAG و DocumentRAG. من خلال تمكين الاستجابات على شكل أجزاء، يمكن لـ GraphIt:
...
1.  **تدفق PromptClient** (مطبق بالفعل)
    ...
    الوحدة: `graphit-base/graphit/base/prompt_client.py`
...
2.  **خدمة GraphRAG** (تحتاج إلى تمرير معلمة التدفق)
    ...
    -   `graphit-flow/graphit/retrieval/graph_rag/rag.py` (المعالجة)
    -   `graphit-base/graphit/schema/graph_rag.py` (مخطط الطلب)
    -   `graphit-flow/graphit/gateway/dispatch/graph_rag.py` (البوابة)
...
3.  **خدمة DocumentRAG** (تحتاج إلى تمرير معلمة التدفق)
    ...
    -   `graphit-flow/graphit/retrieval/document_rag/rag.py` (المعالجة)
    -   `graphit-base/graphit/schema/document_rag.py` (مخطط الطلب)
    -   `graphit-flow/graphit/gateway/dispatch/document_rag.py` (البوابة)
...
- تدفق PromptClient: `graphit-base/graphit/base/prompt_client.py`
- تدفق الوكيل: `graphit-flow/graphit/agent/react/agent_manager.py`
