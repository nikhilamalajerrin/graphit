...
تتناول هذه المواصفة مشكلات الأداء في تطبيق قاعدة المعرفة Cassandra GraphIt وتقترح تحسينات لتخزين واستعلام ثلاثيات RDF.

## التنفيذ الحالي

### تصميم المخطط

يستخدم التنفيذ الحالي تصميم جدول واحد في `graphit-flow/graphit/direct/cassandra_kg.py`:
...
**الملف: `graphit-flow/graphit/direct/cassandra_kg.py`**
...
**نقاط التكامل:**
**مسار الكتابة:** `graphit-flow/graphit/storage/triples/cassandra/write.py`.
**مسار الاستعلام:** `graphit-flow/graphit/query/triples/cassandra/service.py`.
**مخزن المعرفة:** `graphit-flow/graphit/tables/knowledge.py`.
...
**`graphit-flow/graphit/direct/cassandra_kg.py`** - مطلوب إعادة كتابة كاملة.
