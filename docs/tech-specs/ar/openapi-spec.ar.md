...
إنشاء مواصفات OpenAPI 3.1 شاملة وقابلة للتطوير لواجهة GraphIt REST API التي:
...
**مترجمو الرسائل**: `graphit-base/graphit/messaging/translators/*.py`
**مدير الموزع**: `graphit-flow/graphit/gateway/dispatch/manager.py`
**مدير نقطة النهاية**: `graphit-flow/graphit/gateway/endpoint/manager.py`
...
لكل مترجم في `graphit-base/graphit/messaging/translators/`:
...
المترجمون: `graphit-base/graphit/messaging/translators/`
تعيين الموزع: `graphit-flow/graphit/gateway/dispatch/manager.py`
توجيه نقطة النهاية: `graphit-flow/graphit/gateway/endpoint/manager.py`
