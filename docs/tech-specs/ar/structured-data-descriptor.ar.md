...
محدد البيانات المنظمة هو لغة تكوين تعتمد على JSON تصف كيفية تحليل وتحويل واستيراد البيانات المنظمة إلى GraphIt. يوفر نهجًا تصريحيًا لاستيعاب البيانات، مما يدعم تنسيقات إدخال متعددة وقنوات تحويل معقدة دون الحاجة إلى تعليمات برمجية مخصصة.
...
Generate a complete, valid Structured Data Descriptor configuration that will properly import this data into GraphIt. Include comments explaining key decisions.
```
...
5. Output in GraphIt ExtractedObject format
