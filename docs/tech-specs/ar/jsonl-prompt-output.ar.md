...
في GraphIt. يتيح JSONL استخراجًا مقاومًا للتقطيع للبيانات المنظمة من
...
التنفيذ الحالي في `graphit-flow/graphit/template/prompt_manager.py`:
...
التنفيذ الحالي: `graphit-flow/graphit/template/prompt_manager.py`.
