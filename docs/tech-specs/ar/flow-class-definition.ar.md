...
يحدد مخطط التدفق قالبًا كاملاً لنمط تدفق البيانات في نظام GraphIt. عند تنفيذه، فإنه ينشئ شبكة مترابطة من المعالجات التي تتعامل مع استيعاب البيانات ومعالجتها وتخزينها والاستعلام عنها كنظام موحد.
...
**المستأجر**: `tg` لتعريفات مخطط التدفق المقدمة من GraphIt
