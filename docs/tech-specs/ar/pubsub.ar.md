...
يوثق هذا المستند جميع الاتصالات بين قاعدة بيانات GraphIt والبنية التحتية للنشر والاشتراك. حاليًا، يتم ترميز النظام لاستخدام Apache Pulsar. تحدد هذه التحليلات جميع نقاط التكامل لإعلام عمليات إعادة الهيكلة المستقبلية نحو تجريد نشر واشتراك قابل للتكوين.

## الحالة الحالية: نقاط تكامل Pulsar

### 1. استخدام عميل Pulsar المباشر

**الموقع:** `graphit-flow/graphit/gateway/service.py`
...
**الموقع:** `graphit-base/graphit/base/async_processor.py`
...
**الموقع:** `graphit-base/graphit/base/consumer.py`
...
**ملف المواصفات:** `graphit-base/graphit/base/consumer_spec.py`
**السطر 22:** يشير إلى `processor.pulsar_client`

### 4. تجريد الناشر

**الموقع:** `graphit-base/graphit/base/producer.py`
...
**ملف المواصفات:** `graphit-base/graphit/base/producer_spec.py`
**السطر 18:** يشير إلى `processor.pulsar_client`

### 5. تجريد الناشر

**الموقع:** `graphit-base/graphit/base/publisher.py`
...
**الموقع:** `graphit-base/graphit/base/subscriber.py`
...
**ملف المواصفات:** `graphit-base/graphit/base/subscriber_spec.py`
**السطر 19:** يشير إلى `processor.pulsar_client`

### 7. نظام المخططات (قلب الظلام)

**الموقع:** `graphit-base/graphit/schema/`
...
إنشاء **نظام مخططات GraphIt** مستقل عن النشر والاشتراك (باستخدام فئات البيانات أو Pydantic)، ثم إنشاء مخططات Pulsar/Kafka/إلخ من ذلك. يتطلب هذا إعادة كتابة كل ملف مخطط وقد يؤدي إلى تغييرات غير متوقعة.
...
1. **إنشاء إصدارات من فئات البيانات** لجميع المخططات في `graphit/schema/`
