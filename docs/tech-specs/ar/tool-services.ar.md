...
يتم تعريف الأدوات حاليًا في `graphit-flow/graphit/agent/react/tools.py` مع تطبيقات مُصنّفة:
...
استخدم `gr-put-config-item` لتحميل الإعدادات:
...
أنواع الطلبات والاستجابات في `graphit-base/graphit/schema/services/tool_service.py`:
...
الفئة الأساسية في `graphit-base/graphit/base/dynamic_tool_service.py`:
...
التنفيذ في `graphit-flow/graphit/agent/react/tools.py`:
...
| الملف | الغرض |
|------|---------|
| `graphit-base/graphit/schema/services/tool_service.py` | مخططات الطلبات والاستجابات |
| `graphit-base/graphit/base/tool_service_client.py` | عميل لاستدعاء الخدمات |
| `graphit-base/graphit/base/dynamic_tool_service.py` | الفئة الأساسية لتنفيذ الخدمة |
| `graphit-flow/graphit/agent/react/tools.py` | فئة `ToolServiceImpl` |
| `graphit-flow/graphit/agent/react/service.py` | تحميل التكوين |

### مثال: خدمة النكت

مثال لخدمة في `graphit-flow/graphit/tool_service/joke/`:
...
التنفيذ الحالي للأداة: `graphit-flow/graphit/agent/react/tools.py`
تسجيل الأداة: `graphit-flow/graphit/agent/react/service.py:105-214`
مخططات الوكيل: `graphit-base/graphit/schema/services/agent.py`
