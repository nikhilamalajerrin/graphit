...
تصف هذه المواصفات التغييرات التي تم إجراؤها على المكونات الأساسية للرسم البياني في GraphIt لمواءمتها مع RDF 1.2 ولتقديم دعم كامل لسمات مجموعة بيانات RDF. هذا تغيير جذري لإصدار 2.x.
...
يمكن للفئة `Value` الحالية في `graphit-base/graphit/schema/core/primitives.py` أن تمثل:
- عقد URI (`is_uri=True`)
