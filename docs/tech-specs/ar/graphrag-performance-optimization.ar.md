...
يصف هذا المستند تفصيليًا تحسينات الأداء الشاملة لخوارزمية GraphRAG (Graph Retrieval-Augmented Generation) في GraphIt. تعاني التنفيذ الحالي من نقاط اختناق أداء كبيرة تحد من قابلية التوسع وأوقات الاستجابة. يتناول هذا المستند أربعة مجالات رئيسية للتحسين:
...
يُظهر التنفيذ الحالي لـ GraphRAG في `graphit-flow/graphit/retrieval/graph_rag/graph_rag.py` العديد من مشكلات الأداء الهامة التي تؤثر بشدة على قابلية توسع النظام:
...
تعالج هذه المواصفات هذه الثغرات من خلال تنفيذ الاستعلامات المجمعة، والتخزين المؤقت الذكي، والمعالجة المتوازية. من خلال تحسين أنماط الاستعلام والوصول إلى البيانات، يمكن لـ GraphIt:
<<<<<<< HEAD
...
<<<<<<< HEAD
   **استمرارية الاتصال:** الحفاظ على اتصالات عميل قاعدة البيانات عبر الطلبات
   ...
   الوحدة: `graphit-flow/graphit/retrieval/graph_rag/rag.py` (تم التعديل)
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   الوحدة: `graphit-flow/graphit/retrieval/graph_rag/optimized_traversal.py`
...
#### 3. **نظام حل التسميات المتوازي**
   ...
   الوحدة: `graphit-flow/graphit/retrieval/graph_rag/label_resolver.py`
...
>>>>>>> 82edf2d (New md files from RunPod)
   ...
   الوحدة: `graphit-flow/graphit/retrieval/graph_rag/cache_manager.py`
...
#### 5. **إطار تحسين الاستعلام**
   ...
   الوحدة: `graphit-flow/graphit/retrieval/graph_rag/query_optimizer.py`
...
[التنفيذ الأصلي لـ GraphRAG](graphit-flow/graphit/retrieval/graph_rag/graph_rag.py)
<<<<<<< HEAD
[مبادئ معمارية GraphIt](architecture-principles.md)
[مواصفات إدارة المجموعة](collection-management.md)
=======
[مبادئ بنية GraphIt](architecture-principles.md)
