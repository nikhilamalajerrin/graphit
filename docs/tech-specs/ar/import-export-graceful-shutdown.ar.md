...
بوابة GraphIt تواجه حاليًا فقدان الرسائل أثناء إغلاق WebSocket في كل من عمليات الاستيراد والتصدير. يحدث هذا بسبب حالات السباق حيث يتم التخلص من الرسائل أثناء النقل قبل وصولها إلى وجهتها (قوائم انتظار Pulsar للاستيراد، عملاء WebSocket للتصدير).
...
**الملف:** `graphit-base/graphit/base/publisher.py`
...
**الملف:** `graphit-flow/graphit/gateway/dispatch/triples_import.py`
...
**الملف:** `graphit-base/graphit/base/subscriber.py`
...
**الملف:** `graphit-flow/graphit/gateway/dispatch/triples_export.py`
...
**الملف:** `graphit-flow/graphit/gateway/endpoint/socket.py`
