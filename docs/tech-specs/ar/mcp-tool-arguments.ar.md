...
### المكونات ذات الصلة
- **graphit-flow/agent/react/service.py**: تحميل تكوين الأداة وإنشاء AgentManager
- **graphit-flow/agent/react/tools.py**: تنفيذ McpToolImpl
- **graphit-flow/agent/react/agent_manager.py**: إنشاء المطالبات بمعاملات الأداة
...
5. **دعم CLI**: يدعم CLI الحالي `gr-invoke-mcp-tool` المعاملات (مُنفذ بالفعل)
...
- [تنفيذ أداة MCP](./graphit-flow/graphit/agent/react/service.py#L114-129)
- [تنفيذ أداة MCP الحالي](./graphit-flow/graphit/agent/react/tools.py#L58-86)
