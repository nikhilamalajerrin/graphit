...
The GraphIt gateway currently experiences message loss during websocket closure in both import and export operations. This occurs due to race conditions where messages in transit are discarded before reaching their destination (Pulsar queues for imports, websocket clients for exports).
...
**File**: `graphit-base/graphit/base/publisher.py`
...
**File**: `graphit-flow/graphit/gateway/dispatch/triples_import.py`
...
**File**: `graphit-base/graphit/base/subscriber.py`
...
**File**: `graphit-flow/graphit/gateway/dispatch/triples_export.py`
...
**File**: `graphit-flow/graphit/gateway/endpoint/socket.py`
