...
- `graphit-flow/graphit/librarian/librarian.py` - Core librarian operations
- `graphit-flow/graphit/librarian/service.py` - Service processor, document loading
- `graphit-flow/graphit/tables/library.py` - Cassandra table store
- `graphit-base/graphit/schema/services/library.py` - Schema definitions
