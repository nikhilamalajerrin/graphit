...
1. **SPARQL Query Service (FlowProcessor)**
   ...
   Module: `graphit-flow/graphit/query/sparql/service.py`
...
2. **SPARQL Parser (rdflib wrapper)**
   ...
   Module: `graphit-flow/graphit/query/sparql/parser.py`
...
3. **Algebra Evaluator**
   ...
   Module: `graphit-flow/graphit/query/sparql/algebra.py`
...
4. **Solution Sequence**
   ...
   Module: `graphit-flow/graphit/query/sparql/solutions.py`
...
12. **CLI command** -- add a `gr-sparql-query` CLI command that takes a
