...
All URIs use the `urn:graphit:` namespace with UUIDs:

| Entity | URI Pattern |
|--------|-------------|
| Session | `urn:graphit:session:{uuid}` |
| Retrieval | `urn:graphit:prov:retrieval:{uuid}` |
| Selection | `urn:graphit:prov:selection:{uuid}` |
| Answer | `urn:graphit:prov:answer:{uuid}` |
| Edge Selection | `urn:graphit:prov:edge:{uuid}:{index}` |
...
Defined in `graphit-base/graphit/provenance/namespaces.py`:
...
| `TG_IN_TOKEN` | `https://graphit.example/ns/inToken` |
| `TG_OUT_TOKEN` | `https://graphit.example/ns/outToken` |
| `TG_LLM_MODEL` | `https://graphit.example/ns/llmModel` |
...
| File | Purpose |
|------|---------|
| `graphit-base/graphit/provenance/uris.py` | URI generators |
| `graphit-base/graphit/provenance/namespaces.py` | RDF namespace constants |
| `graphit-base/graphit/provenance/triples.py` | Triple builders |
| `graphit-base/graphit/schema/services/retrieval.py` | GraphRagResponse schema |
| `graphit-flow/graphit/retrieval/graph_rag/graph_rag.py` | Core GraphRAG with URI preservation |
| `graphit-flow/graphit/retrieval/graph_rag/rag.py` | Service with librarian integration |
| `graphit-flow/graphit/query/triples/cassandra/service.py` | Quoted triple query support |
| `graphit-cli/graphit/cli/invoke_graph_rag.py` | CLI with explainability display |

## Vocabulary Reference

The full OWL ontology covering all classes and predicates is at `specs/ontology/graphit.ttl`.
