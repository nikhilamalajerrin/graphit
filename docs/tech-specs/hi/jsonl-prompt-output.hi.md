...
`graphit-flow/graphit/template/prompt_manager.py` में वर्तमान कार्यान्वयन:
=======
2. `response-type: "json"` - प्रतिक्रिया से पार्स किया गया JSON, जिसकी तुलना
   वैकल्पिक `schema` से की जाती है

वर्तमान कार्यान्वयन `graphit-flow/graphit/template/prompt_manager.py` में:
>>>>>>> 82edf2d (New md files from RunPod)
...
वर्तमान कार्यान्वयन: `graphit-flow/graphit/template/prompt_manager.py`
