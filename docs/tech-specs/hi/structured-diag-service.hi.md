...
वर्तमान में, `gr-load-structured-data` कमांड संरचित डेटा का विश्लेषण करने और विवरण उत्पन्न करने के लिए व्यापक कार्यक्षमता प्रदान करता है। हालाँकि, यह कार्यक्षमता CLI इंटरफ़ेस से दृढ़ता से जुड़ी हुई है, जो इसकी पुन: प्रयोज्यता को सीमित करती है।
...
1. **डायग्नोस्टिक सर्विस प्रोसेसर**
   ...
   मॉड्यूल: `graphit-flow/graphit/diagnosis/structured_data/service.py`
...
2. **डेटा टाइप डिटेक्टर**
   ...
   मॉड्यूल: `graphit-flow/graphit/diagnosis/structured_data/type_detector.py`
...
3. **डिस्क्रिप्टर जेनरेटर**
   ...
   मॉड्यूल: `graphit-flow/graphit/diagnosis/structured_data/descriptor_generator.py`
...
यह सेवा GraphIt सेवा सम्मेलनों का पालन करेगी:
...
यह सेवा मौजूदा GraphIt एपीआई के साथ एकीकृत होगी:

संशोधित घटक:
`gr-load-structured-data` CLI - निदान कार्यों के लिए नई सेवा का उपयोग करने के लिए रिफैक्टर किया गया
...
`gr-load-structured-data` कार्यान्वयन: `graphit-cli/graphit/cli/load_structured_data.py`
