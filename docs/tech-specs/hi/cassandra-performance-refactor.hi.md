...
वर्तमान कार्यान्वयन `graphit-flow/graphit/direct/cassandra_kg.py` में एक एकल तालिका डिज़ाइन का उपयोग करता है:
...
**फ़ाइल: `graphit-flow/graphit/direct/cassandra_kg.py`**
...
**एकीकरण बिंदु:**
**राइट पाथ:** `graphit-flow/graphit/storage/triples/cassandra/write.py`
**क्वेरी पाथ:** `graphit-flow/graphit/query/triples/cassandra/service.py`
**नॉलेज स्टोर:** `graphit-flow/graphit/tables/knowledge.py`
...
**`graphit-flow/graphit/direct/cassandra_kg.py`** - पूर्ण पुनर्लेखन आवश्यक है।
