...
### संबंधित घटक
**graphit-flow/graphit/agent/mcp_tool/service.py**: MCP टूल इनवोकेशन सेवा।
**graphit-cli/graphit/cli/set_mcp_tool.py**: MCP कॉन्फ़िगरेशन बनाने/अपडेट करने के लिए CLI टूल।
**graphit-cli/graphit/cli/show_mcp_tools.py**: MCP कॉन्फ़िगरेशन प्रदर्शित करने के लिए CLI टूल।
...
3. **CLI समर्थन:** `gr-set-mcp-tool` को एक वैकल्पिक `--auth-token` पैरामीटर स्वीकार करना चाहिए।
4. **टोकन प्रदर्शन:** `gr-show-mcp-tools` को यह इंगित करना चाहिए कि ऑथ-टोकन कॉन्फ़िगर किया गया है (सुरक्षा के लिए मास्क किया गया)।
...
1. **कॉन्फ़िगरेशन संग्रहण:** उपयोगकर्ता `gr-set-mcp-tool --id my-tool --tool-url http://server/api --auth-token xyz123` चलाता है
...
**फ़ाइल:** `graphit-flow/graphit/agent/mcp_tool/service.py`
...
**फ़ाइल**: `graphit-cli/graphit/cli/set_mcp_tool.py`
...
**फ़ाइल**: `graphit-cli/graphit/cli/show_mcp_tools.py`
...
#### घटक 4: दस्तावेज़
**फ़ाइल**: `docs/cli/gr-set-mcp-tool.md`
...
[ ] `gr-set-mcp-tool.md` में `--auth-token` पैरामीटर का दस्तावेज़ बनाएं
...
| `gr-set-mcp-tool.md` | संशोधित | विभिन्न | नए पैरामीटर का दस्तावेज़ बनाने के लिए |
...
**कोई उपयोगकर्ता संदर्भ नहीं**: MCP सर्वर विभिन्न GraphIt उपयोगकर्ताओं के बीच अंतर नहीं कर सकता है
...
आपका GraphIt परिनियोजन कई संगठनों (मल्टी-टेनेंट) को सेवा प्रदान करता है
...
प्रत्येक किरायेदार के लिए अलग-अलग GraphIt इंस्टेंस तैनात करें
...
MCP सर्वर विभिन्न GraphIt उपयोगकर्ताओं के बीच अंतर नहीं कर सकता है
...
[ ] `gr-set-mcp-tool.md` को `--auth-token` पैरामीटर के साथ अपडेट करें
...
[वर्तमान MCP टूल सेवा](../graphit-flow/graphit/agent/mcp_tool/service.py)
