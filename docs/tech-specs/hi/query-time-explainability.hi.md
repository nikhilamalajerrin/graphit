...
सभी यूआरआई `urn:graphit:` नेमस्पेस का उपयोग करते हैं जिसमें यूयूआईडी शामिल हैं:

| इकाई | यूआरआई पैटर्न |
|--------|-------------|
| सत्र | `urn:graphit:session:{uuid}` |
| पुनर्प्राप्ति | `urn:graphit:prov:retrieval:{uuid}` |
| चयन | `urn:graphit:prov:selection:{uuid}` |
| उत्तर | `urn:graphit:prov:answer:{uuid}` |
| किनारे का चयन | `urn:graphit:prov:edge:{uuid}:{index}` |
...
`graphit-base/graphit/provenance/namespaces.py` में परिभाषित:
...
| फ़ाइल | उद्देश्य |
|------|---------|
| `graphit-base/graphit/provenance/uris.py` | यूआरआई जनरेटर |
| `graphit-base/graphit/provenance/namespaces.py` | आरडीएफ नेमस्पेस स्थिरांक |
| `graphit-base/graphit/provenance/triples.py` | ट्रिपल बिल्डर |
| `graphit-base/graphit/schema/services/retrieval.py` | GraphRagResponse स्कीमा |
| `graphit-flow/graphit/retrieval/graph_rag/graph_rag.py` | यूआरआई संरक्षण के साथ मुख्य GraphRAG |
| `graphit-flow/graphit/retrieval/graph_rag/rag.py` | लाइब्रेरियन एकीकरण के साथ सेवा |
| `graphit-flow/graphit/query/triples/cassandra/service.py` | उद्धृत ट्रिपल क्वेरी समर्थन |
| `graphit-cli/graphit/cli/invoke_graph_rag.py` | व्याख्यात्मक प्रदर्शन के साथ सीएलआई |
