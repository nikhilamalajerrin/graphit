...
1. **एनएलपी-टू-स्ट्रक्चर्ड-क्वेरी सेवा**
   ...
   मॉड्यूल: graphit-flow/graphit/query/nlp_query/cassandra
...
3. **ऑब्जेक्ट निष्कर्षण मॉड्यूल** ✅ **[पूर्ण]**
   ...
   एक कॉन्फ़िग हैंडलर (उदाहरण: graphit-flow/graphit/prompt/template/service.py) को कॉन्फ़िग डेटा प्राप्त करने और स्कीमा जानकारी को डिकोड करने के लिए पंजीकृत करता है।
   ऑब्जेक्ट प्राप्त करता है और उन्हें पल्सर कतार पर डिलीवरी के लिए एक्सट्रैक्टेडऑब्जेक्ट ऑब्जेक्ट में डिकोड करता है।
   ध्यान दें: `graphit-flow/graphit/extract/object/row/` पर मौजूदा कोड है। यह एक पिछला प्रयास था और इसे वर्तमान एपीआई के अनुरूप नहीं होने के कारण प्रमुख रूप से फिर से तैयार करने की आवश्यकता होगी। यदि यह उपयोगी है तो इसका उपयोग करें, यदि नहीं तो इसे खरोंच से शुरू करें।
   एक कमांड-लाइन इंटरफ़ेस की आवश्यकता है: `kg-extract-objects`

   मॉड्यूल: graphit-flow/graphit/extract/kg/objects/
...
4. **संरचित स्टोर लेखक मॉड्यूल** ✅ **[पूर्ण]**
   ...
   **कार्यान्वयन नोट्स**:
   `graphit-flow/graphit/storage/objects/cassandra/` पर मौजूद मौजूदा कोड पुराना है और वर्तमान एपीआई के अनुरूप नहीं है।
   `graphit-flow/graphit/storage/triples/cassandra` को एक कार्यशील स्टोरेज प्रोसेसर के उदाहरण के रूप में संदर्भित किया जाना चाहिए।
   ...
   मॉड्यूल: graphit-flow/graphit/storage/objects/cassandra
...
5. **स्ट्रक्चर्ड क्वेरी सर्विस** ✅ **[पूर्ण]**
   ...
   मॉड्यूल: graphit-flow/graphit/query/objects/cassandra
...
7. **स्ट्रक्चर्ड डेटा इंजेक्शन सर्विस**:
   ...
   मॉड्यूल: graphit-flow/graphit/decoding/structured
...
8. **ऑब्जेक्ट एम्बेडिंग सर्विस**:
   ...
   मॉड्यूल: graphit-flow/graphit/embeddings/object_embeddings/qdrant
