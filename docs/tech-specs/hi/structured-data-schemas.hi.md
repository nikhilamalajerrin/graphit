...
- `graphit-flow/graphit/decoding/structured` - `StructuredDataSubmission` का उपयोग करता है
- `graphit-flow/graphit/query/nlp_query/cassandra` - एनएलपी क्वेरी स्कीमा का उपयोग करता है
- `graphit-flow/graphit/query/objects/cassandra` - संरचित क्वेरी स्कीमा का उपयोग करता है
- `graphit-flow/graphit/extract/object/row/` - `Chunk` का उपभोग करता है, `ExtractedObject` उत्पन्न करता है
- `graphit-flow/graphit/storage/objects/cassandra` - `Rows` स्कीमा का उपयोग करता है
- `graphit-flow/graphit/embeddings/object_embeddings/qdrant` - ऑब्जेक्ट एम्बेडिंग स्कीमा का उपयोग करता है
