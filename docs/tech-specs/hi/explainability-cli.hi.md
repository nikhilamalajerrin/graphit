...
1. **`gr-show-document-hierarchy`** - दस्तावेज़ → पृष्ठ → भाग → किनारा पदानुक्रम दिखाएं
2. **`gr-list-explain-traces`** - सभी GraphRAG सत्रों को प्रश्नों के साथ सूचीबद्ध करें
3. **`gr-show-explain-trace`** - एक सत्र के लिए पूर्ण व्याख्यात्मकता ट्रेस दिखाएं
...
### टूल 1: gr-show-document-hierarchy
...
| `-u/--api-url` | गेटवे यूआरएल (डिफ़ॉल्ट: `$GRAPHIT_URL`) |
| `-t/--token` | ऑथ टोकन (डिफ़ॉल्ट: `$GRAPHIT_TOKEN`) |
| `-U/--user` | उपयोगकर्ता आईडी (डिफ़ॉल्ट: `graphit`) |
...
| फ़ाइल | उद्देश्य |
|------|---------|
| `graphit-cli/graphit/cli/show_document_hierarchy.py` | टूल 1 |
| `graphit-cli/graphit/cli/list_explain_traces.py` | टूल 2 |
| `graphit-cli/graphit/cli/show_explain_trace.py` | टूल 3 |

## बदलने के लिए फ़ाइलें

| फ़ाइल | परिवर्तन |
|------|--------|
| `graphit-cli/setup.py` | console_scripts प्रविष्टियाँ जोड़ें |
...
`--token` या `$GRAPHIT_TOKEN` के माध्यम से टोकन प्रमाणीकरण समर्थित है।
...
मौजूदा CLI उदाहरण: `graphit-cli/graphit/cli/invoke_graph_rag.py`
