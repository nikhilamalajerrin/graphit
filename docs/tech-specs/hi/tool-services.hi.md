...
टूल वर्तमान में `graphit-flow/graphit/agent/react/tools.py` में टाइप किए गए कार्यान्वयन के साथ परिभाषित किए गए हैं:
...
कॉन्फ़िगरेशन लोड करने के लिए `gr-put-config-item` का उपयोग करें:
...
`graphit-base/graphit/schema/services/tool_service.py` में अनुरोध और प्रतिक्रिया प्रकार:
...
`graphit-base/graphit/base/dynamic_tool_service.py` में बेस क्लास:
...
`graphit-flow/graphit/agent/react/tools.py` में कार्यान्वयन:
...
| फ़ाइल | उद्देश्य |
|------|---------|
| `graphit-base/graphit/schema/services/tool_service.py` | अनुरोध/प्रतिक्रिया स्कीमा |
| `graphit-base/graphit/base/tool_service_client.py` | सेवाओं को आमंत्रित करने के लिए क्लाइंट |
| `graphit-base/graphit/base/dynamic_tool_service.py` | सेवा कार्यान्वयन के लिए आधार वर्ग |
| `graphit-flow/graphit/agent/react/tools.py` | `ToolServiceImpl` वर्ग |
| `graphit-flow/graphit/agent/react/service.py` | कॉन्फ़िगरेशन लोडिंग |

### उदाहरण: जोक सर्विस

`graphit-flow/graphit/tool_service/joke/` में एक उदाहरण सेवा:
...
वर्तमान टूल कार्यान्वयन: `graphit-flow/graphit/agent/react/tools.py`
टूल पंजीकरण: `graphit-flow/graphit/agent/react/service.py:105-214`
एजेंट स्कीमा: `graphit-base/graphit/schema/services/agent.py`
