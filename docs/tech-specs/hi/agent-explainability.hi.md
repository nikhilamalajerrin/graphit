...
|---------|-------------|-----------|
| `tg:GraphRagQuestion` | `urn:graphit:question:{uuid}` | ज्ञान ग्राफ आरएजी |
| `tg:DocRagQuestion` | `urn:graphit:docrag:{uuid}` | दस्तावेज़/टुकड़ा आरएजी |
| `tg:AgentQuestion` | `urn:graphit:agent:{uuid}` | रीएक्ट एजेंट |
...
**फ़ाइल:** `graphit-base/graphit/schema/services/agent.py`
...
**फ़ाइल:** `graphit-base/graphit/messaging/translators/agent.py`
...
**फ़ाइल:** `graphit-flow/graphit/agent/react/service.py`
...
**फ़ाइल:** `graphit-base/graphit/provenance/agent.py`
...
**फ़ाइल:** `graphit-base/graphit/provenance/namespaces.py`
...
| फ़ाइल | परिवर्तन |
|------|--------|
| `graphit-base/graphit/schema/services/agent.py` | AgentRequest में session_id और collection जोड़ें |
| `graphit-base/graphit/messaging/translators/agent.py` | नए फ़ील्ड के लिए ट्रांसलेटर को अपडेट करें |
| `graphit-base/graphit/provenance/namespaces.py` | एंटिटी प्रकार, एजेंट प्रेडिकेट और Document RAG प्रेडिकेट जोड़ें |
| `graphit-base/graphit/provenance/triples.py` | GraphRAG ट्रिपल बिल्डरों में TG प्रकार जोड़ें, Document RAG ट्रिपल बिल्डर जोड़ें |
| `graphit-base/graphit/provenance/uris.py` | Document RAG URI जनरेटर जोड़ें |
| `graphit-base/graphit/provenance/__init__.py` | नए प्रकार, प्रेडिकेट और Document RAG फ़ंक्शन निर्यात करें |
| `graphit-base/graphit/schema/services/retrieval.py` | DocumentRagResponse में explain_id और explain_graph जोड़ें |
| `graphit-base/graphit/messaging/translators/retrieval.py` | व्याख्यात्मक फ़ील्ड के लिए DocumentRagResponseTranslator को अपडेट करें |
| `graphit-flow/graphit/agent/react/service.py` | व्याख्यात्मक उत्पादक + रिकॉर्डिंग लॉजिक जोड़ें |
| `graphit-flow/graphit/retrieval/document_rag/document_rag.py` | व्याख्यात्मक कॉलबैक जोड़ें और प्रोवेनेंस ट्रिपल उत्सर्जित करें |
| `graphit-flow/graphit/retrieval/document_rag/rag.py` | व्याख्यात्मक उत्पादक जोड़ें और कॉलबैक को कनेक्ट करें |
| `graphit-cli/graphit/cli/show_explain_trace.py` | एजेंट ट्रेस प्रकारों को संभालें |
| `graphit-cli/graphit/cli/list_explain_traces.py` | GraphRAG के साथ एजेंट सत्रों को सूचीबद्ध करें |

## बनाई गई फ़ाइलें

| फ़ाइल | उद्देश्य |
|------|---------|
| `graphit-base/graphit/provenance/agent.py` | एजेंट-विशिष्ट ट्रिपल जनरेटर |

## CLI अपडेट

**पहचान:** GraphRAG और Agent Questions दोनों में `tg:Question` प्रकार होता है। निम्नलिखित द्वारा पहचाना जाता है:
1. URI पैटर्न: `urn:graphit:agent:` बनाम `urn:graphit:question:`
