...
मुख्य फाइलें:
REST/WebSocket एंट्री: `graphit-flow/graphit/gateway/service.py`
Librarian कोर: `graphit-flow/graphit/librarian/librarian.py`
Blob स्टोरेज: `graphit-flow/graphit/librarian/blob_store.py`
Cassandra टेबल: `graphit-flow/graphit/tables/library.py`
API स्कीमा: `graphit-base/graphit/schema/services/library.py`
...
**फ़ाइल:** `graphit-flow/graphit/librarian/blob_store.py`
...
पायथन एसडीके (`graphit-base/graphit/api/library.py`) को खंडित अपलोड को पारदर्शी रूप से संभालना चाहिए। सार्वजनिक इंटरफ़ेस अपरिवर्तित रहता है:
...
**`gr-add-library-document`** बिना किसी बदलाव के काम करता रहता है:
...
`gr-load-pdf` - अप्रचलित, `gr-add-library-document` का उपयोग करें।
`gr-load-text` - अप्रचलित, `gr-add-library-document` का उपयोग करें।
