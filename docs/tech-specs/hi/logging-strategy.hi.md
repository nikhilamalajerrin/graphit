...
सभी लॉगिंग कॉन्फ़िगरेशन को `graphit.base.logging` मॉड्यूल द्वारा प्रबंधित किया जाता है, जो निम्नलिखित प्रदान करता है:
...
`logger`: मॉड्यूल नाम (उदाहरण के लिए, `graphit.gateway.service`, `graphit.agent.react.service`)
...
पहले से ही `graphit-base/pyproject.toml` और `requirements.txt` में शामिल है।
