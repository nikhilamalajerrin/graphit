...
**संदेश अनुवादक**: `graphit-base/graphit/messaging/translators/*.py`
**डिस्पैचर मैनेजर**: `graphit-flow/graphit/gateway/dispatch/manager.py`
**एंडपॉइंट मैनेजर**: `graphit-flow/graphit/gateway/endpoint/manager.py`
...
प्रत्येक अनुवादक के लिए `graphit-base/graphit/messaging/translators/`:
...
अनुवादक: `graphit-base/graphit/messaging/translators/`
डिस्पैचर मैपिंग: `graphit-flow/graphit/gateway/dispatch/manager.py`
एंडपॉइंट रूटिंग: `graphit-flow/graphit/gateway/endpoint/manager.py`
