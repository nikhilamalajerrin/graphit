...
`gr-set-collection` के माध्यम से उपयोग से पहले संग्रह बनाने की आवश्यकता होती है
...
1. **संग्रह निर्माण** (दो रास्ते):
   ...
   **रास्ता A: उपयोगकर्ता-आरंभित निर्माण** `gr-set-collection` के माध्यम से:
...
4. **मेटाडेटा अपडेट**: उपयोगकर्ता निर्माण के बाद संग्रह मेटाडेटा को अपडेट कर सकते हैं:
   `gr-set-collection` के माध्यम से नाम, विवरण और टैग अपडेट करें
...
5. **स्पष्ट विलोपन**: उपयोगकर्ता `gr-delete-collection` के माध्यम से संग्रह को हटाते हैं:
...
आवश्यक संचालन:
**संग्रह बनाएं**: `gr-set-collection` के माध्यम से उपयोगकर्ता ऑपरेशन या दस्तावेज़ सबमिशन पर स्वचालित
...
**संग्रह बनाएं/अपडेट करें**: `gr-set-collection` के माध्यम से एक नया संग्रह बनाएं या मौजूदा मेटाडेटा को अपडेट करें
...
1. **ट्रस्टग्राफ क्लास रीफैक्टर** (`graphit/direct/cassandra.py`):
...
2. **स्टोरेज राइटर अपडेट** (`graphit/storage/triples/cassandra/write.py`):
...
3. **क्वेरी सर्विस अपडेट** (`graphit/query/triples/cassandra/service.py`):
...
1. **लाइब्रेरियन संग्रह प्रबंधन सेवा** (`graphit-flow/graphit/librarian/collection_manager.py`)
...
2. **संग्रह मेटाडेटा स्कीमा** (`graphit-base/graphit/schema/services/collection.py`)
...
3. **स्टोरेज प्रबंधन स्कीमा** (`graphit-base/graphit/schema/services/storage.py`)
...
4. **कैसेंड्रा 4-टेबल स्कीमा** (`graphit-flow/graphit/direct/cassandra_kg.py`)
