...
वर्तमान स्कीमा (`graphit-base/graphit/schema/services/llm.py`):
...
##### एलएलएम स्कीमा (`graphit-base/graphit/schema/services/llm.py`)
...
##### प्रॉम्प्ट स्कीमा (`graphit-base/graphit/schema/services/prompt.py`)
...
**LlmClient अपडेट** (`graphit-base/graphit/clients/llm_client.py`):
...
**प्रॉम्प्टक्लाइंट अपडेट** (`graphit-base/graphit/base/prompt_client.py`):
...
**मॉड्यूल:** `graphit-vertexai/graphit/model/text_completion/vertexai/llm.py`
...
|----------|---------|-------------------|
| ओपनएआई | graphit-flow | पूर्ण (मूल स्ट्रीमिंग एपीआई) |
| क्लाउड/एंथ्रोपिक | graphit-flow | पूर्ण (मूल स्ट्रीमिंग एपीआई) |
| ओलामा | graphit-flow | पूर्ण (मूल स्ट्रीमिंग एपीआई) |
| कोहेर | graphit-flow | पूर्ण (मूल स्ट्रीमिंग एपीआई) |
| मिस्ट्रल | graphit-flow | पूर्ण (मूल स्ट्रीमिंग एपीआई) |
| एज़्योर ओपनएआई | graphit-flow | पूर्ण (मूल स्ट्रीमिंग एपीआई) |
| गूगल एआई स्टूडियो | graphit-flow | पूर्ण (मूल स्ट्रीमिंग एपीआई) |
| वर्टेक्सएआई | graphit-vertexai | पूर्ण (चरण 2) |
| बेडरोक | graphit-bedrock | पूर्ण (मूल स्ट्रीमिंग एपीआई) |
| एलएम स्टूडियो | graphit-flow | पूर्ण (ओपनएआई-संगत) |
| लैमाफाइल | graphit-flow | पूर्ण (ओपनएआई-संगत) |
| वीएलएलएम | graphit-flow | पूर्ण (ओपनएआई-संगत) |
| टीजीआई | graphit-flow | तय किया जाना है |
| एज़्योर | graphit-flow | तय किया जाना है |
...
वर्तमान एलएलएम स्कीमा: `graphit-base/graphit/schema/services/llm.py`
वर्तमान प्रॉम्प्ट स्कीमा: `graphit-base/graphit/schema/services/prompt.py`
वर्तमान एजेंट स्कीमा: `graphit-base/graphit/schema/services/agent.py`
एलएलएम सेवा आधार: `graphit-base/graphit/base/llm_service.py`
वर्टेक्सएआई प्रदाता: `graphit-vertexai/graphit/model/text_completion/vertexai/llm.py`
गेटवे एपीआई: `graphit-base/graphit/api/`
सीएलआई उपकरण: `graphit-cli/graphit/cli/`
