...
1. **प्रॉम्प्टक्लाइंट स्ट्रीमिंग** (पहले से लागू)
   ...
   मॉड्यूल: `graphit-base/graphit/base/prompt_client.py`
...
2. **ग्राफआरएजी सेवा** (स्ट्रीमिंग पैरामीटर पास-थ्रू की आवश्यकता है)
   ...
   `graphit-flow/graphit/retrieval/graph_rag/rag.py` (प्रोसेसर)
   `graphit-base/graphit/schema/graph_rag.py` (रिक्वेस्ट स्कीमा)
   `graphit-flow/graphit/gateway/dispatch/graph_rag.py` (गेटवे)
...
3. **डॉक्यूमेंटआरएजी सेवा** (स्ट्रीमिंग पैरामीटर पास-थ्रू की आवश्यकता है)
   ...
   `graphit-flow/graphit/retrieval/document_rag/rag.py` (प्रोसेसर)
   `graphit-base/graphit/schema/document_rag.py` (रिक्वेस्ट स्कीमा)
   `graphit-flow/graphit/gateway/dispatch/document_rag.py` (गेटवे)
...
5. `--no-streaming` ध्वज `gr-invoke-graph-rag` और `gr-invoke-document-rag` में जोड़ें (डिफ़ॉल्ट रूप से स्ट्रीमिंग सक्षम, एजेंट CLI पैटर्न का अनुसरण करते हुए)
...
**मैन्युअल परीक्षण**:
`gr-invoke-graph-rag -q "What is machine learning?"` (डिफ़ॉल्ट रूप से स्ट्रीमिंग)
`gr-invoke-document-rag -q "Summarize the documents about AI"` (डिफ़ॉल्ट रूप से स्ट्रीमिंग)
`gr-invoke-graph-rag --no-streaming -q "..."` (गैर-स्ट्रीमिंग मोड का परीक्षण करें)
...
एजेंट स्ट्रीमिंग: `graphit-flow/graphit/agent/react/agent_manager.py`
PromptClient स्ट्रीमिंग: `graphit-base/graphit/base/prompt_client.py`
