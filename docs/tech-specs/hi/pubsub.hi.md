...
**स्थान:** `graphit-flow/graphit/gateway/service.py`
...
**स्थान:** `graphit-base/graphit/base/async_processor.py`
...
**स्थान:** `graphit-base/graphit/base/consumer.py`
...
**स्पेक फ़ाइल:** `graphit-base/graphit/base/consumer_spec.py`
**पंक्ति 22:** `processor.pulsar_client` को संदर्भित करता है

### 4. उत्पादक एब्स्ट्रैक्शन

**स्थान:** `graphit-base/graphit/base/producer.py`
...
**स्पेक फ़ाइल:** `graphit-base/graphit/base/producer_spec.py`
**पंक्ति 18:** `processor.pulsar_client` को संदर्भित करता है

### 5. प्रकाशक एब्स्ट्रैक्शन

**स्थान:** `graphit-base/graphit/base/publisher.py`
...
**स्थान:** `graphit-base/graphit/base/subscriber.py`
...
**स्पेक फाइल:** `graphit-base/graphit/base/subscriber_spec.py`
**लाइन 19:** संदर्भ `processor.pulsar_client`

### 7. स्कीमा सिस्टम (हार्ट ऑफ डार्कनेस)

**स्थान:** `graphit-base/graphit/schema/`
...
1. `graphit/schema/` में सभी स्कीमा के डेटाक्लास संस्करण बनाएं
