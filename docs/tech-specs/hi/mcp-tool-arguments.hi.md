...
### संबंधित घटक
   **graphit-flow/agent/react/service.py**: टूल कॉन्फ़िगरेशन लोडिंग और एजेंटमैनेजर (AgentManager) निर्माण।
**graphit-flow/agent/react/tools.py**: McpToolImpl कार्यान्वयन।
**graphit-flow/agent/react/agent_manager.py**: टूल तर्कों के साथ प्रॉम्प्ट पीढ़ी।
**graphit-cli**: एमसीपी टूल प्रबंधन के लिए सीएलआई (CLI) उपकरण।
...
5. **CLI समर्थन**: मौजूदा `gr-invoke-mcp-tool` CLI तर्कों का समर्थन करता है (पहले से लागू)।
...
**सीएलआई इंटीग्रेशन**: टेस्ट `gr-invoke-mcp-tool` नए आर्गुमेंट-कॉन्फ़िगर किए गए एमसीपी टूल के साथ काम करता है।
...
[प्रॉम्प्ट टेम्पलेट टूल कार्यान्वयन](./graphit-flow/graphit/agent/react/service.py#L114-129)
[वर्तमान एमसीपी टूल कार्यान्वयन](./graphit-flow/graphit/agent/react/tools.py#L58-86)
