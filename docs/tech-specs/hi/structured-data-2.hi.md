...
**चरण 1: एम्बेडिंग गणना** (`graphit-flow/graphit/embeddings/row_embeddings/`) - `ExtractedObject` का उपयोग करता है, एम्बेडिंग सेवा के माध्यम से एम्बेडिंग की गणना करता है, `RowEmbeddings` आउटपुट करता है
**चरण 2: एम्बेडिंग भंडारण** (`graphit-flow/graphit/storage/row_embeddings/qdrant/`) - `RowEmbeddings` का उपयोग करता है, वैक्टर को Qdrant में लिखता है

कैसेंड्रा पंक्ति लेखक एक अलग समानांतर उपभोक्ता है:

**कैसेंड्रा पंक्ति लेखक** (`graphit-flow/graphit/storage/rows/cassandra`) - `ExtractedObject` का उपयोग करता है, पंक्तियों को कैसेंड्रा में लिखता है
...
|-------|--------|-------------|
| चरण 1 | `graphit-flow/graphit/embeddings/row_embeddings/` | `row-embeddings` |
| चरण 2 | `graphit-flow/graphit/storage/row_embeddings/qdrant/` | `row-embeddings-write-qdrant` |
...
मॉड्यूल: `graphit-flow/graphit/query/row_embeddings/qdrant`
...
| घटक | स्थान |
|-----------|----------|
| डिस्पैचर | `graphit-flow/graphit/gateway/dispatch/row_embeddings_query.py` |
...
कमांड: `gr-invoke-row-embeddings`
...
|-----------|----------|-------|-------------|
| क्वेरी सेवा | `graphit-flow/graphit/query/objects/cassandra/service.py` | ~740 | एकरूप: GraphQL स्कीमा पीढ़ी, फ़िल्टर पार्सिंग, कैसेंड्रा क्वेरी, अनुरोध हैंडलिंग |
| लेखक | `graphit-flow/graphit/storage/objects/cassandra/write.py` | ~540 | प्रति-स्कीमा तालिका निर्माण, द्वितीयक अनुक्रमणिका, सम्मिलित/हटाना |
...
**राइटर** (`graphit-flow/graphit/storage/rows/cassandra/`):
...
**क्वेरी सर्विस** (`graphit-flow/graphit/query/rows/cassandra/`):
...
| मॉड्यूल | उद्देश्य |
|--------|---------|
| `graphit-flow/graphit/query/graphql/` | साझा GraphQL उपयोगिताएँ |
| `graphit-flow/graphit/query/row_embeddings/qdrant/` | रो एम्बेडिंग क्वेरी एपीआई |
| `graphit-flow/graphit/embeddings/row_embeddings/` | रो एम्बेडिंग गणना (स्टेज 1) |
| `graphit-flow/graphit/storage/row_embeddings/qdrant/` | रो एम्बेडिंग भंडारण (स्टेज 2) |
