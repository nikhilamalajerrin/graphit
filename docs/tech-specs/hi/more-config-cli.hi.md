...
यह विनिर्देश GraphIt के लिए उन्नत कमांड-लाइन कॉन्फ़िगरेशन क्षमताओं का वर्णन करता है, जो उपयोगकर्ताओं को दानेदार CLI कमांड के माध्यम से व्यक्तिगत कॉन्फ़िगरेशन आइटम प्रबंधित करने की अनुमति देता है। यह एकीकरण चार प्राथमिक उपयोग मामलों का समर्थन करता है:
...
- **संगत CLI पैटर्न**: स्थापित GraphIt CLI कन्वेंशन और पैटर्न का पालन करें।
...
GraphIt वर्तमान में कॉन्फ़िगरेशन API और एक एकल CLI कमांड `gr-show-config` के माध्यम से कॉन्फ़िगरेशन प्रबंधन प्रदान करता है जो संपूर्ण कॉन्फ़िगरेशन प्रदर्शित करता है। जबकि यह कॉन्फ़िगरेशन देखने के लिए उपयोगी है, यह दानेदार प्रबंधन क्षमताओं की कमी है।
...
यह विनिर्देश इन कमियों को चार नए CLI कमांड जोड़कर संबोधित करता है जो दानेदार कॉन्फ़िगरेशन प्रबंधन प्रदान करते हैं। GraphIt, CLI कमांड के माध्यम से व्यक्तिगत कॉन्फ़िगरेशन API परिचालनों को उजागर करके:
...
1. **gr-list-config-items**
   ...
   मॉड्यूल: `graphit.cli.list_config_items`
...
2. **gr-get-config-item**
   ...
   मॉड्यूल: `graphit.cli.get_config_item`
...
3. **gr-put-config-item**
   ...
   मॉड्यूल: `graphit.cli.put_config_item`
...
4. **gr-delete-config-item**
   ...
   मॉड्यूल: `graphit.cli.delete_config_item`

### डेटा मॉडल

#### ConfigKey और ConfigValue

कमांड `graphit.api.types` से मौजूदा डेटा संरचनाओं का उपयोग करते हैं:
...
- मौजूदा कॉन्फ़िगरेशन API: `graphit/api/config.py`
- CLI पैटर्न: `graphit-cli/graphit/cli/show_config.py`
- डेटा प्रकार: `graphit/api/types.py`
