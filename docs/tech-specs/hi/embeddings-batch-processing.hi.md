...
`graphit-flow/graphit/embeddings/fastembed/processor.py` में एम्बेडिंग कार्यान्वयन में एक महत्वपूर्ण प्रदर्शन अक्षमता है:
...
**फ़ाइल:** `graphit-flow/graphit/gateway/dispatch/embeddings.py`
...
**फ़ाइल:** `graphit-flow/graphit/embeddings/document_embeddings/embeddings.py`
...
**फ़ाइल:** `graphit-flow/graphit/embeddings/graph_embeddings/embeddings.py`
...
**फ़ाइल:** `graphit-flow/graphit/embeddings/row_embeddings/embeddings.py`
...
**फ़ाइल:** `graphit-base/graphit/base/embeddings_client.py`
...
**फ़ाइल:** `graphit-cli/graphit/cli/invoke_embeddings.py`
...
**फ़ाइल:** `graphit-base/graphit/api/flow.py`
...
**फ़ाइल:** `graphit-base/graphit/api/socket_client.py`
...
#### 1. **स्कीमा संवर्धन**
   ...
   मॉड्यूल: `graphit-base/graphit/schema/services/llm.py`
...
#### 2. **बेस सर्विस संवर्धन**
   ...
   मॉड्यूल: `graphit-base/graphit/base/embeddings_service.py`
...
#### 4. **क्लाइंट में सुधार**
   ...
   मॉड्यूल: `graphit-base/graphit/base/embeddings_client.py`
...
#### 6. **एपीआई गेटवे में सुधार**
   ...
   मॉड्यूल: `graphit-flow/graphit/gateway/dispatch/embeddings.py`

#### 7. **सीएलआई टूल में सुधार**
   कई टेक्स्ट या फ़ाइल इनपुट के लिए समर्थन जोड़ें
   बैच आकार पैरामीटर जोड़ें

   मॉड्यूल: `graphit-cli/graphit/cli/invoke_embeddings.py`
