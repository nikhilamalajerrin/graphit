...
4. **URI विस्तार** (`extract.py:473-521`)
   ...
   यदि नहीं मिला, तो URI का निर्माण करता है: `f"https://example.com/ontology/{ontology_id}#{value}"`
...
return f"https://example.com/ontology/{ontology_id}#{value}"  # Fallback
```

**प्रभाव:**
मूल यूआरआई: `http://purl.org/ontology/fo/Recipe`
निर्मित यूआरआई: `https://example.com/ontology/food#Recipe`
...
return f"https://example.com/{ontology_id}/{normalized}"
```
...
# Not: "https://example.com/ontology/food#Recipe"
```
...
entity_uri = "https://example.com/food/recipe-cornish-pasty"
...
cornish_pasty_uri = "https://example.com/food/cornish-pasty"
beef_uri = "https://example.com/food/beef"
potatoes_uri = "https://example.com/food/potatoes"
...
# → "https://example.com/food/recipe-cornish-pasty"

food_uri = normalize("Cornish pasty", "Food")
# → "https://example.com/food/food-cornish-pasty"
...
recipe_uri = "https://example.com/food/cornish-pasty-recipe"
...
वर्तमान कार्यान्वयन: `graphit-flow/graphit/extract/kg/ontology/extract.py`
