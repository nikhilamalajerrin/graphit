...
**फ़ाइल:** `graphit-base/graphit/base/async_processor.py`
**पंक्ति:** 260-264
...
**फ़ाइल:** `graphit-flow/graphit/config/service/service.py`
**पंक्ति:** 276-279
...
**फ़ाइल:** `graphit-base/graphit/base/cassandra_config.py`
...
**फ़ाइल:** `graphit-flow/graphit/cores/service.py`
...
**फ़ाइल:** `graphit-flow/graphit/librarian/service.py`
...
**फ़ाइल:** `graphit-flow/graphit/librarian/collection_manager.py`
...
**फ़ाइल:** `graphit-flow/graphit/tables/library.py`
...
**फ़ाइल:** `graphit-base/graphit/schema/services/collection.py`
...
1. **ट्रिपल्स क्वेरी सर्विस** (`graphit-flow/graphit/query/triples/cassandra/service.py:65`)
   `keyspace=query.user` का उपयोग करता है
2. **ऑब्जेक्ट्स क्वेरी सर्विस** (`graphit-flow/graphit/query/objects/cassandra/service.py:479`)
   `keyspace=self.sanitize_name(user)` का उपयोग करता है
3. **नॉलेज ग्राफ डायरेक्ट एक्सेस** (`graphit-flow/graphit/direct/cassandra_kg.py:18`)
   डिफ़ॉल्ट पैरामीटर `keyspace="graphit"`
...
## संदर्भ
GitHub मुद्दा: https://github.com/example.com/graphit/issues/582
संबंधित फाइलें:
