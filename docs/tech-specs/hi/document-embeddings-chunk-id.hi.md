...
### क्लाइंट
`graphit-base/graphit/base/document_embeddings_client.py` - `chunk_ids` लौटाएं
...
`graphit-base/graphit/api/async_flow.py` - यदि लागू हो
`graphit-base/graphit/api/bulk_client.py` - दस्तावेज़ एम्बेडिंग का आयात/निर्यात
`graphit-base/graphit/api/async_bulk_client.py` - दस्तावेज़ एम्बेडिंग का आयात/निर्यात

### एम्बेडिंग सेवा
`graphit-flow/graphit/embeddings/document_embeddings/embeddings.py` - `chunk_id` पास करें
...
### दस्तावेज़ RAG
`graphit-flow/graphit/retrieval/document_rag/rag.py` - लाइब्रेरियन क्लाइंट जोड़ें
`graphit-flow/graphit/retrieval/document_rag/document_rag.py` - गैरेज से प्राप्त करें
