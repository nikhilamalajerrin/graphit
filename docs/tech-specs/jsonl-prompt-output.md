...
format for prompt responses in GraphIt. JSONL enables truncation-resilient
...
Current implementation in `graphit-flow/graphit/template/prompt_manager.py`:
...
- Current implementation: `graphit-flow/graphit/template/prompt_manager.py`
