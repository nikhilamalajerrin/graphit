...
### Related Components
- **graphit-flow/agent/react/service.py**: Tool configuration loading and AgentManager creation
- **graphit-flow/agent/react/tools.py**: McpToolImpl implementation  
- **graphit-flow/agent/react/agent_manager.py**: Prompt generation with tool arguments
- **graphit-cli**: CLI tools for MCP tool management
...
5. **CLI Support**: Existing `gr-invoke-mcp-tool` CLI supports arguments (already implemented)
...
- **CLI Integration**: Test gr-invoke-mcp-tool works with new argument-configured MCP tools
...
- [Prompt Template Tool Implementation](./graphit-flow/graphit/agent/react/service.py#L114-129)
- [Current MCP Tool Implementation](./graphit-flow/graphit/agent/react/tools.py#L58-86)
