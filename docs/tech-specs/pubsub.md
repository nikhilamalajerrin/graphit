...
This document catalogs all connections between the GraphIt codebase and the pub/sub infrastructure. Currently, the system is hardcoded to use Apache Pulsar. This analysis identifies all integration points to inform future refactoring toward a configurable pub/sub abstraction.

## Current State: Pulsar Integration Points

### 1. Direct Pulsar Client Usage

**Location:** `graphit-flow/graphit/gateway/service.py`
...
**Location:** `graphit-base/graphit/base/async_processor.py`
...
**Location:** `graphit-base/graphit/base/consumer.py`
...
**Spec file:** `graphit-base/graphit/base/consumer_spec.py`
- **Line 22:** References `processor.pulsar_client`

### 4. Producer Abstraction

**Location:** `graphit-base/graphit/base/producer.py`
...
**Spec file:** `graphit-base/graphit/base/producer_spec.py`
- **Line 18:** References `processor.pulsar_client`

### 5. Publisher Abstraction

**Location:** `graphit-base/graphit/base/publisher.py`
...
**Location:** `graphit-base/graphit/base/subscriber.py`
...
**Spec file:** `graphit-base/graphit/base/subscriber_spec.py`
- **Line 19:** References `processor.pulsar_client`

### 7. Schema System (Heart of Darkness)

**Location:** `graphit-base/graphit/schema/`
...
Create a **GraphIt schema system** that's pub/sub agnostic (using dataclasses or Pydantic), then generate Pulsar/Kafka/etc schemas from it. This requires rewriting every schema file and potentially breaking changes.
...
1. **Create dataclass versions** of all schemas in `graphit/schema/`
