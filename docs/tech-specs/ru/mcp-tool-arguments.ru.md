...
- **graphit-flow/agent/react/service.py**: Загрузка конфигурации инструментов и создание AgentManager
- **graphit-flow/agent/react/tools.py**: Реализация McpToolImpl
- **graphit-flow/agent/react/agent_manager.py**: Генерация запросов с аргументами инструментов
- **gr-invoke-mcp-tool**: Клиентские инструменты для управления инструментами MCP
...
5. **Поддержка CLI**: Существующие CLI инструменты gr-invoke-mcp-tool поддерживают аргументы (уже реализовано)
