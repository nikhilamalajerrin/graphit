...
`graphit-flow/graphit/librarian/librarian.py` - Основные операции "библиотекаря".
`graphit-flow/graphit/librarian/service.py` - Сервисный процессор, загрузка документов.
`graphit-flow/graphit/tables/library.py` - Хранилище таблиц Cassandra.
`graphit-base/graphit/schema/services/library.py` - Определения схемы.
...
| Тип PROV-O | Использование в GraphIt |
|-------------|------------------|
...
#### Расширения пространства имен GraphIt
