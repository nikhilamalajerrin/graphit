...
Создать всеобъемлющую, модульную спецификацию OpenAPI 3.1 для шлюза REST API GraphIt, которая:
...
**Переводчики сообщений**: `graphit-base/graphit/messaging/translators/*.py`
**Менеджер диспетчера**: `graphit-flow/graphit/gateway/dispatch/manager.py`
**Менеджер конечных точек**: `graphit-flow/graphit/gateway/endpoint/manager.py`
...
Для каждого переводчика в `graphit-base/graphit/messaging/translators/`:
...
Переводчики: `graphit-base/graphit/messaging/translators/`
Отображение диспетчера: `graphit-flow/graphit/gateway/dispatch/manager.py`
Маршрутизация конечных точек: `graphit-flow/graphit/gateway/endpoint/manager.py`
