...
4. **Расширение URI** (`extract.py:473-521`)
   ...
   Если не найдено, создает URI: `f"https://example.com/ontology/{ontology_id}#{value}"`
...
Сформированный URI: `https://example.com/ontology/food#Recipe`
...
Текущая реализация: `graphit-flow/graphit/extract/kg/ontology/extract.py`
