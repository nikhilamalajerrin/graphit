...
Этот документ описывает, как данные передаются через конвейер извлечения данных GraphIt, начиная с отправки документов и заканчивая хранением в хранилищах знаний.
