...
Данная спецификация рассматривает проблемы производительности в реализации базы знаний GraphIt на Cassandra и предлагает оптимизации для хранения и запросов RDF-тройных.

## Текущая реализация

### Структура данных

Текущая реализация использует структуру данных с одной таблицей в `graphit-flow/graphit/direct/cassandra_kg.py`:
...
**Файл: `graphit-flow/graphit/direct/cassandra_kg.py`**
...
**Точки интеграции:**
**Путь записи:** `graphit-flow/graphit/storage/triples/cassandra/write.py`
**Путь запроса:** `graphit-flow/graphit/query/triples/cassandra/service.py`
**Хранилище знаний:** `graphit-flow/graphit/tables/knowledge.py`
...
**`graphit-flow/graphit/direct/cassandra_kg.py`** - Требуется полная переработка.
