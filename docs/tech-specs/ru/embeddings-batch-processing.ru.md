...
Реализация эмбеддингов в `graphit-flow/graphit/embeddings/fastembed/processor.py` демонстрирует значительную неэффективность:
...
**Файл:** `graphit-flow/graphit/gateway/dispatch/embeddings.py`
...
**Файл:** `graphit-flow/graphit/embeddings/document_embeddings/embeddings.py`
...
**Файл:** `graphit-flow/graphit/embeddings/graph_embeddings/embeddings.py`
...
**Файл:** `graphit-flow/graphit/embeddings/row_embeddings/embeddings.py`
...
**Файл:** `graphit-base/graphit/base/embeddings_client.py`
...
**Файл:** `graphit-cli/graphit/cli/invoke_embeddings.py`
...
Python SDK предоставляет два клиентских класса для взаимодействия со службами GraphIt. Оба поддерживают только вставку одного текста.

**Файл:** `graphit-base/graphit/api/flow.py`
...
**Файл:** `graphit-base/graphit/api/socket_client.py`
...
#### 1. **Улучшение схемы данных**
   ...
   Модуль: `graphit-base/graphit/schema/services/llm.py`
...
#### 2. **Улучшение базового сервиса**
   ...
   Модуль: `graphit-base/graphit/base/embeddings_service.py`
...
#### 4. **Улучшение клиентской библиотеки**
   ...
   Модуль: `graphit-base/graphit/base/embeddings_client.py`
...
#### 6. **Улучшение API-шлюза**
   ...
   Модуль: `graphit-flow/graphit/gateway/dispatch/embeddings.py`
...
#### 7. **Улучшение инструмента командной строки (CLI)**
   ...
   Модуль: `graphit-cli/graphit/cli/invoke_embeddings.py`
...
[Реализация сервиса вложений](graphit-base/graphit/base/embeddings_service.py)
