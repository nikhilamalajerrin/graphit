...
**Местоположение реализации**: `graphit-flow/graphit/extract/kg/ontology/ontology_loader.py`
...
**Местоположение реализации**: `graphit-flow/graphit/extract/kg/ontology/ontology_embedder.py`
...
**Местоположение реализации**: `graphit-flow/graphit/extract/kg/ontology/text_processor.py`
...
**Местоположение реализации**: `graphit-flow/graphit/extract/kg/ontology/ontology_selector.py`
...
**Местоположение реализации**: `graphit-flow/graphit/extract/kg/ontology/extract.py` (метод build_extraction_variables)
...
**Местоположение реализации**: `graphit-flow/graphit/extract/kg/ontology/extract.py`

### Конфигурация

Сервис использует стандартный подход к конфигурации GraphIt с аргументами командной строки:
...
**Местоположение реализации**: `graphit-flow/graphit/extract/kg/ontology/vector_store.py`
