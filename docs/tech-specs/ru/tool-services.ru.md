...
Инструменты в настоящее время определены в `graphit-flow/graphit/agent/react/tools.py` с типизированными реализациями:
...
Используйте `gr-put-config-item` для загрузки конфигураций:
...
Типы запросов и ответов в `graphit-base/graphit/schema/services/tool_service.py`:
...
Базовый класс в `graphit-base/graphit/base/dynamic_tool_service.py`:
...
Реализация в `graphit-flow/graphit/agent/react/tools.py`:
...
| Файл | Назначение |
|------|---------|
| `graphit-base/graphit/schema/services/tool_service.py` | Схемы запросов/ответов |
| `graphit-base/graphit/base/tool_service_client.py` | Клиент для вызова сервисов |
| `graphit-base/graphit/base/dynamic_tool_service.py` | Базовый класс для реализации сервиса |
| `graphit-flow/graphit/agent/react/tools.py` | Класс `ToolServiceImpl` |
| `graphit-flow/graphit/agent/react/service.py` | Загрузка конфигурации |

### Пример: Сервис шуток

Пример сервиса на `graphit-flow/graphit/tool_service/joke/`:
...
Текущая реализация инструментов: `graphit-flow/graphit/agent/react/tools.py`
Регистрация инструментов: `graphit-flow/graphit/agent/react/service.py:105-214`
Схемы агента: `graphit-base/graphit/schema/services/agent.py`
