...
**Расположение**: `graphit-flow/graphit/librarian/blob_store.py`
**Операции**:
...
### Основные файлы
1. `graphit-flow/graphit/librarian/blob_store.py` - Реализация BlobStore.
2. `graphit-flow/graphit/librarian/librarian.py` - Инициализация BlobStore.
3. `graphit-flow/graphit/librarian/service.py` - Конфигурация сервиса.
4. `graphit-flow/pyproject.toml` - Зависимости (пакет `minio`).
