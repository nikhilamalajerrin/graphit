...
This specification describes a comprehensive refactor of the GraphIt Python API client library to achieve feature parity with the API Gateway and add support for modern real-time communication patterns.
...
The Python API (`graphit-base/graphit/api/`) is a REST-only client library with the following modules:
...
Модуль: `graphit-base/graphit/api/api.py`
...
Модуль: `graphit-base/graphit/api/socket_client.py` (новый)
...
Модуль: `graphit-base/graphit/api/async_socket_client.py` (новый)
...
Модуль: `graphit-base/graphit/api/bulk_client.py` (новый)
...
Модуль: `graphit-base/graphit/api/async_bulk_client.py` (новый)
...
Модуль: `graphit-base/graphit/api/flow.py`
...
Модуль: `graphit-base/graphit/api/async_flow.py` (новый)
...
Модуль: `graphit-base/graphit/api/metrics.py` (новый)
...
Модуль: `graphit-base/graphit/api/types.py` (изменен)
...
### Файлы реализации
`graphit-base/graphit/api/` - Исходный код API на Python
`graphit-flow/graphit/gateway/` - Исходный код шлюза
`graphit-flow/graphit/gateway/dispatch/mux.py` - Пример реализации мультиплексора WebSocket
