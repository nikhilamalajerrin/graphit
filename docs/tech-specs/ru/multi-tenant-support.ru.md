...
Система GraphIt использует **архитектуру на основе потоков** для динамического разрешения очередей, что изначально поддерживает многопользовательскую среду:
...
**Файл:** `graphit-base/graphit/base/async_processor.py`
**Строка:** 260-264
...
**Файл:** `graphit-flow/graphit/config/service/service.py`
**Строка:** 276-279
...
**Файл:** `graphit-base/graphit/base/cassandra_config.py`
...
**Файл:** `graphit-flow/graphit/cores/service.py`
...
**Файл:** `graphit-flow/graphit/librarian/service.py`
...
**Файл:** `graphit-flow/graphit/librarian/collection_manager.py`
...
**Файл:** `graphit-flow/graphit/tables/library.py`
...
**Файл:** `graphit-base/graphit/schema/services/collection.py`
...
1. **Сервис запросов Triple** (`graphit-flow/graphit/query/triples/cassandra/service.py:65`)
   Использует `keyspace=query.user`
2. **Сервис запросов объектов** (`graphit-flow/graphit/query/objects/cassandra/service.py:479`)
   Использует `keyspace=self.sanitize_name(user)`
3. **Прямой доступ к графу знаний** (`graphit-flow/graphit/direct/cassandra_kg.py:18`)
   Параметр по умолчанию `keyspace="graphit"`
