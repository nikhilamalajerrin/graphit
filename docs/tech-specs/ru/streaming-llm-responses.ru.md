...
в GraphIt. Потоковая передача обеспечивает доставку сгенерированных
...
Текущая схема (`graphit-base/graphit/schema/services/llm.py`):
...
##### Схема LLM (`graphit-base/graphit/schema/services/llm.py`)
...
##### Схема запроса (`graphit-base/graphit/schema/services/prompt.py`)
...
**Обновления LlmClient** (`graphit-base/graphit/clients/llm_client.py`):
...
**Обновления PromptClient** (`graphit-base/graphit/base/prompt_client.py`):
...
Такой же шаблон, как у `gr-invoke-llm`.
...
**Модуль:** `graphit-vertexai/graphit/model/text_completion/vertexai/llm.py`
...
|----------|---------|-------------------|
| OpenAI | graphit-flow | Полная (нативная API потоковой передачи) |
| Claude/Anthropic | graphit-flow | Полная (нативная API потоковой передачи) |
| Ollama | graphit-flow | Полная (нативная API потоковой передачи) |
| Cohere | graphit-flow | Полная (нативная API потоковой передачи) |
| Mistral | graphit-flow | Полная (нативная API потоковой передачи) |
| Azure OpenAI | graphit-flow | Полная (нативная API потоковой передачи) |
| Google AI Studio | graphit-flow | Полная (нативная API потоковой передачи) |
| VertexAI | graphit-vertexai | Полная (Фаза 2) |
| Bedrock | graphit-bedrock | Полная (нативная API потоковой передачи) |
| LM Studio | graphit-flow | Полная (совместима с OpenAI) |
| LlamaFile | graphit-flow | Полная (совместима с OpenAI) |
| vLLM | graphit-flow | Полная (совместима с OpenAI) |
| TGI | graphit-flow | Будет определено |
| Azure | graphit-flow | Будет определено |
...
Текущая схема LLM: `graphit-base/graphit/schema/services/llm.py`
Текущая схема запросов: `graphit-base/graphit/schema/services/prompt.py`
Текущая схема агента: `graphit-base/graphit/schema/services/agent.py`
Базовый URL службы LLM: `graphit-base/graphit/base/llm_service.py`
Провайдер VertexAI: `graphit-vertexai/graphit/model/text_completion/vertexai/llm.py`
API шлюза: `graphit-base/graphit/api/`
Инструменты CLI: `graphit-cli/graphit/cli/`
