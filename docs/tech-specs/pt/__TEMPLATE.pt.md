...
Esta especificação descreve as interfaces de linha de comando para carregar conhecimento no GraphIt, permitindo que os usuários ingiram dados de várias fontes por meio de ferramentas de linha de comando. A integração suporta quatro casos de uso primários:
...
Esta especificação aborda essas lacunas ao [descrição]. Ao [capacidade], o GraphIt pode:
- [Benefício 1]
- [Benefício 2]
- [Benefício 3]
- [Benefício 4]
