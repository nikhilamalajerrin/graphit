...
**Localização da Implementação**: `graphit-flow/graphit/extract/kg/ontology/ontology_loader.py`
...
**Localização da Implementação**: `graphit-flow/graphit/extract/kg/ontology/ontology_embedder.py`
...
**Localização da Implementação**: `graphit-flow/graphit/extract/kg/ontology/text_processor.py`
...
**Localização da Implementação**: `graphit-flow/graphit/extract/kg/ontology/ontology_selector.py`
...
**Localização da Implementação**: `graphit-flow/graphit/extract/kg/ontology/extract.py` (método build_extraction_variables)
...
**Localização da Implementação**: `graphit-flow/graphit/extract/kg/ontology/extract.py`

### Configuração

O serviço usa a abordagem de configuração padrão da GraphIt com argumentos de linha de comando:
...
**Localização da Implementação**: `graphit-flow/graphit/extract/kg/ontology/vector_store.py`
