...
As ferramentas são atualmente definidas em `graphit-flow/graphit/agent/react/tools.py` com implementações tipadas:
...
Use `gr-put-config-item` para carregar as configurações:
...
Tipos de requisição e resposta em `graphit-base/graphit/schema/services/tool_service.py`:
...
Classe base em `graphit-base/graphit/base/dynamic_tool_service.py`:
...
Implementação em `graphit-flow/graphit/agent/react/tools.py`:
...
| Arquivo | Propósito |
|------|---------|
| `graphit-base/graphit/schema/services/tool_service.py` | Esquemas de requisição/resposta |
| `graphit-base/graphit/base/tool_service_client.py` | Cliente para invocar serviços |
| `graphit-base/graphit/base/dynamic_tool_service.py` | Classe base para implementação de serviço |
| `graphit-flow/graphit/agent/react/tools.py` | Classe `ToolServiceImpl` |
| `graphit-flow/graphit/agent/react/service.py` | Carregamento de configuração |

### Exemplo: Serviço de Piadas

Um exemplo de serviço em `graphit-flow/graphit/tool_service/joke/`:
...
Implementação atual da ferramenta: `graphit-flow/graphit/agent/react/tools.py`
Registro de ferramentas: `graphit-flow/graphit/agent/react/service.py:105-214`
Esquemas do agente: `graphit-base/graphit/schema/services/agent.py`
