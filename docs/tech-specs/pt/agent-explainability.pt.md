...
Tanto o GraphRAG quanto o Agent usam PROV-O como a ontologia base, com subtipos específicos do GraphIt:
...
|---------|-------------|-----------|
| `tg:GraphRagQuestion` | `urn:graphit:question:{uuid}` | RAG de grafo de conhecimento |
| `tg:DocRagQuestion` | `urn:graphit:docrag:{uuid}` | RAG de documento/trecho |
...
**Arquivo:** `graphit-base/graphit/schema/services/agent.py`
...
**Arquivo:** `graphit-base/graphit/messaging/translators/agent.py`
...
**Arquivo:** `graphit-flow/graphit/agent/react/service.py`
...
**Arquivo:** `graphit-base/graphit/provenance/agent.py`
...
**Arquivo:** `graphit-base/graphit/provenance/namespaces.py`
...
| Arquivo | Alteração |
|------|--------|
| `graphit-base/graphit/schema/services/agent.py` | Adiciona session_id e collection a AgentRequest |
| `graphit-base/graphit/messaging/translators/agent.py` | Atualiza o tradutor para novos campos |
| `graphit-base/graphit/provenance/namespaces.py` | Adiciona tipos de entidade, predicados de agente e predicados Document RAG |
| `graphit-base/graphit/provenance/triples.py` | Adiciona tipos TG aos construtores de triplas GraphRAG, adiciona construtores de triplas Document RAG |
| `graphit-base/graphit/provenance/uris.py` | Adiciona geradores de URI Document RAG |
| `graphit-base/graphit/provenance/__init__.py` | Exporta novos tipos, predicados e funções Document RAG |
| `graphit-base/graphit/schema/services/retrieval.py` | Adiciona explain_id e explain_graph a DocumentRagResponse |
| `graphit-base/graphit/messaging/translators/retrieval.py` | Atualiza DocumentRagResponseTranslator para campos de explicabilidade |
| `graphit-flow/graphit/agent/react/service.py` | Adiciona lógica de produção e gravação de explicabilidade |
| `graphit-flow/graphit/retrieval/document_rag/document_rag.py` | Adiciona callback de explicabilidade e emite triplas de procedência |
| `graphit-flow/graphit/retrieval/document_rag/rag.py` | Adiciona produtor de explicabilidade e conecta o callback |
| `graphit-cli/graphit/cli/show_explain_trace.py` | Lida com tipos de rastreamento de agente |
| `graphit-cli/graphit/cli/list_explain_traces.py` | Lista sessões de agente junto com GraphRAG |

## Arquivos Criados

| Arquivo | Propósito |
|------|---------|
| `graphit-base/graphit/provenance/agent.py` | Geradores de triplas específicos para agente |

## Atualizações da CLI

**Detecção:** Tanto GraphRAG quanto Agent Questions têm o tipo `tg:Question`. Distinguido por:
1. Padrão de URI: `urn:graphit:agent:` vs `urn:graphit:question:`
