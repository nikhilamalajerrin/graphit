...
O sistema GraphIt usa uma **arquitetura baseada em fluxo** para a resolução dinâmica de filas, que suporta inerentemente o multi-tenancy:
...
**Arquivo:** `graphit-base/graphit/base/async_processor.py`
**Linha:** 260-264
...
**Arquivo:** `graphit-flow/graphit/config/service/service.py`
**Linha:** 276-279
...
**Arquivo:** `graphit-base/graphit/base/cassandra_config.py`
...
**Arquivo:** `graphit-flow/graphit/cores/service.py`
...
**Arquivo:** `graphit-flow/graphit/librarian/service.py`
...
**Arquivo:** `graphit-flow/graphit/librarian/collection_manager.py`
...
**Arquivo:** `graphit-flow/graphit/tables/library.py`
...
**Arquivo:** `graphit-base/graphit/schema/services/collection.py`
...
1. **Triples Query Service** (`graphit-flow/graphit/query/triples/cassandra/service.py:65`)
   Usa `keyspace=query.user`
2. **Objects Query Service** (`graphit-flow/graphit/query/objects/cassandra/service.py:479`)
   Usa `keyspace=self.sanitize_name(user)`
3. **KnowledgeGraph Direct Access** (`graphit-flow/graphit/direct/cassandra_kg.py:18`)
   Parâmetro padrão `keyspace="graphit"`
