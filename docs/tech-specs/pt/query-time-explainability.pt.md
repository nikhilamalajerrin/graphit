...
Todos os URIs usam o namespace `urn:graphit:` com UUIDs:

| Entidade | Padrão de URI |
|--------|-------------|
| Sessão | `urn:graphit:session:{uuid}` |
| Recuperação | `urn:graphit:prov:retrieval:{uuid}` |
| Seleção | `urn:graphit:prov:selection:{uuid}` |
| Resposta | `urn:graphit:prov:answer:{uuid}` |
| Seleção de Aresta | `urn:graphit:prov:edge:{uuid}:{index}` |
...
Definido em `graphit-base/graphit/provenance/namespaces.py`:
...
| Arquivo | Propósito |
|------|---------|
| `graphit-base/graphit/provenance/uris.py` | Geradores de URI |
| `graphit-base/graphit/provenance/namespaces.py` | Constantes de namespace RDF |
| `graphit-base/graphit/provenance/triples.py` | Construtores de triplas |
| `graphit-base/graphit/schema/services/retrieval.py` | Esquema GraphRagResponse |
| `graphit-flow/graphit/retrieval/graph_rag/graph_rag.py` | Núcleo GraphRAG com preservação de URI |
| `graphit-flow/graphit/retrieval/graph_rag/rag.py` | Serviço com integração de bibliotecário |
| `graphit-flow/graphit/query/triples/cassandra/service.py` | Suporte para consultas de triplas entre aspas |
| `graphit-cli/graphit/cli/invoke_graph_rag.py` | CLI com exibição de explicabilidade |
