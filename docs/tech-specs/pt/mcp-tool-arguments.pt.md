...
### Componentes Relacionados
   **graphit-flow/agent/react/service.py**: Carregamento de configuração de ferramentas e criação do AgentManager.
**graphit-flow/agent/react/tools.py**: Implementação do McpToolImpl.
**graphit-flow/agent/react/agent_manager.py**: Geração de prompts com argumentos de ferramentas.
**graphit-cli**: Ferramentas de linha de comando para gerenciamento de ferramentas MCP.
...
5. **Suporte para CLI**: A CLI existente `gr-invoke-mcp-tool` suporta argumentos (já implementado).
...
**Integração com a Linha de Comando**: Testar se gr-invoke-mcp-tool funciona com ferramentas MCP configuradas com novos argumentos.
...
[Implementação da Ferramenta do Modelo de Prompt](./graphit-flow/graphit/agent/react/service.py#L114-129)
[Implementação Atual da Ferramenta MCP](./graphit-flow/graphit/agent/react/tools.py#L58-86)
