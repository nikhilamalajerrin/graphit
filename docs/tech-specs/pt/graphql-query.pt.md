...
<<<<<<< HEAD
**Integração de Solicitação/Resposta**: Manter a compatibilidade com o padrão de solicitação/resposta baseado no Pulsar do GraphIt.
=======
**Integração de Solicitação/Resposta**: Manter a compatibilidade com o padrão de solicitação/resposta baseado em Pulsar do GraphIt.
...
<<<<<<< HEAD
A implementação do armazenamento de dados estruturados (graphit-flow/graphit/storage/objects/cassandra/) grava objetos em tabelas do Cassandra com base em definições de esquema armazenadas no sistema de configuração do GraphIt. Essas tabelas usam uma estrutura de chave de partição composta com chaves primárias definidas por coleção e esquema, permitindo consultas eficientes dentro das coleções.
=======
A implementação de armazenamento de dados estruturados (graphit-flow/graphit/storage/objects/cassandra/) grava objetos em tabelas do Cassandra com base em definições de esquema armazenadas no sistema de configuração do GraphIt. Essas tabelas usam uma estrutura de chave de partição composta com chaves primárias definidas por coleção, permitindo consultas eficientes dentro de coleções.
>>>>>>> 82edf2d (New md files from RunPod)
...
Geração dinâmica de esquemas GraphQL a partir da configuração do GraphIt.
...
O serviço de consulta GraphQL será implementado como um novo processador de fluxo do GraphIt, seguindo padrões estabelecidos:

**Localização do Módulo**: `graphit-flow/graphit/query/objects/cassandra/`
...
2. **Gerador de Esquema Dinâmico**
   Converte definições de RowSchema do GraphIt em tipos GraphQL.
<<<<<<< HEAD
...
**GraphIt Base**: Para FlowProcessor e definições de esquema.
<<<<<<< HEAD
...
Referência CQL do Apache Cassandra: ⟦URL_0⟧
   Documentação do Flow Processor GraphIt: Documentação interna.
=======
   Opção: Enfileirar consultas durante as atualizações de esquema
...
Documentação do Processador de Fluxo GraphIt: Documentação interna
