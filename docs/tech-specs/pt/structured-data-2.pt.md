...
Esta especificação aborda problemas e lacunas identificadas durante a implementação inicial da integração de dados estruturados do GraphIt, conforme descrito em `structured-data.md`.
...
**Etapa 1: Computação de embeddings** (`graphit-flow/graphit/embeddings/row_embeddings/`) - Consome `ExtractedObject`, calcula embeddings através do serviço de embeddings, gera `RowEmbeddings`
**Etapa 2: Armazenamento de embeddings** (`graphit-flow/graphit/storage/row_embeddings/qdrant/`) - Consome `RowEmbeddings`, escreve vetores no Qdrant

O escritor de linhas do Cassandra é um consumidor paralelo separado:

**Escritor de linhas do Cassandra** (`graphit-flow/graphit/storage/rows/cassandra`) - Consome `ExtractedObject`, escreve linhas no Cassandra
...
|-------|--------|-------------|
| Estágio 1 | `graphit-flow/graphit/embeddings/row_embeddings/` | `row-embeddings` |
| Estágio 2 | `graphit-flow/graphit/storage/row_embeddings/qdrant/` | `row-embeddings-write-qdrant` |
...
|-----------|----------|
| Dispatcher | `graphit-flow/graphit/gateway/dispatch/row_embeddings_query.py` |
...
|-----------|----------|-------|-------------|
| Serviço de Consulta | `graphit-flow/graphit/query/objects/cassandra/service.py` | ~740 | Monolítico: geração de esquema GraphQL, análise de filtros, consultas Cassandra, tratamento de solicitações |
| Escritor | `graphit-flow/graphit/storage/objects/cassandra/write.py` | ~540 | Criação de tabelas por esquema, índices secundários, inserção/exclusão |
...
**Serviço de Consulta** (`graphit-flow/graphit/query/rows/cassandra/`):
...
| Módulo | Propósito |
|--------|---------|
| `graphit-flow/graphit/query/graphql/` | Utilitários GraphQL compartilhados |
| `graphit-flow/graphit/query/row_embeddings/qdrant/` | API de consulta de incorporações de linhas |
| `graphit-flow/graphit/embeddings/row_embeddings/` | Cálculo de incorporações de linhas (Etapa 1) |
| `graphit-flow/graphit/storage/row_embeddings/qdrant/` | Armazenamento de incorporações de linhas (Etapa 2) |
