...
Um modelo de fluxo define um modelo de padrão de fluxo de dados completo no sistema GraphIt. Quando instanciado, ele cria uma rede interconectada de processadores que lidam com a ingestão, o processamento, o armazenamento e a consulta de dados como um sistema unificado.
...
<<<<<<< HEAD
**inquilino**: `tg` para definições de blueprint de fluxo fornecidas pelo GraphIt
=======
**inquilino**: `tg` para definições de blueprint de fluxo fornecidas pela GraphIt
>>>>>>> 82edf2d (New md files from RunPod)
