...
**Localização**: `graphit-flow/graphit/librarian/blob_store.py`
**Operações**:
...
### Arquivos Chave
1. `graphit-flow/graphit/librarian/blob_store.py` - Implementação do BlobStore.
2. `graphit-flow/graphit/librarian/librarian.py` - Inicialização do BlobStore.
3. `graphit-flow/graphit/librarian/service.py` - Configuração do serviço.
4. `graphit-flow/pyproject.toml` - Dependências (pacote `minio`).
