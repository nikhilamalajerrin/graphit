...
Esta especificação descreve uma refatoração abrangente da biblioteca de cliente da API Python GraphIt para alcançar a paridade de recursos com o API Gateway e adicionar suporte para padrões de comunicação em tempo real modernos.
...
A API Python (`graphit-base/graphit/api/`) é uma biblioteca de cliente REST somente com os seguintes módulos:
...
Módulo: `graphit-base/graphit/api/socket_client.py` (novo)
...
Módulo: `graphit-base/graphit/api/async_socket_client.py` (novo)
...
Módulo: `graphit-base/graphit/api/bulk_client.py` (novo)
...
Módulo: `graphit-base/graphit/api/async_bulk_client.py` (novo)
...
Módulo: `graphit-base/graphit/api/async_flow.py` (novo)
...
Módulo: `graphit-base/graphit/api/metrics.py` (novo)
...
`graphit-base/graphit/api/` - Código fonte da API Python
`graphit-flow/graphit/gateway/` - Código fonte do Gateway
`graphit-flow/graphit/gateway/dispatch/mux.py` - Implementação de referência de multiplexador WebSocket
