...
Este documento descreve como o GraphIt gerencia coleções de vector store em diferentes implementações de backend (Qdrant, Pinecone, Milvus). O design aborda o desafio de suportar embeddings com diferentes dimensões sem codificar valores de dimensão.
...
Uma única coleção do GraphIt pode receber embeddings de vários modelos
...
Esquema de Armazenamento: `graphit-base/graphit/schema/services/storage.py`
Serviço Librarian: `graphit-flow/graphit/librarian/service.py`
