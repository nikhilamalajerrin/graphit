...
documentos grandes no GraphIt. A arquitetura atual trata o upload de documentos
...
Arquivos chave:
<<<<<<< HEAD
Ponto de entrada REST/WebSocket: `graphit-flow/graphit/gateway/service.py`
=======
Entrada REST/WebSocket: `graphit-flow/graphit/gateway/service.py`
>>>>>>> 82edf2d (New md files from RunPod)
Núcleo do Librarian: `graphit-flow/graphit/librarian/librarian.py`
Armazenamento de blobs: `graphit-flow/graphit/librarian/blob_store.py`
Tabelas do Cassandra: `graphit-flow/graphit/tables/library.py`
Esquema da API: `graphit-base/graphit/schema/services/library.py`
...
**Arquivo:** `graphit-flow/graphit/librarian/blob_store.py`
...
O SDK Python (`graphit-base/graphit/api/library.py`) deve lidar com uploads divididos de forma transparente. A interface pública permanece inalterada:
...
**`gr-add-library-document`** continua a funcionar inalterado:
...
`gr-load-pdf` - descontinuado, use `gr-add-library-document`
`gr-load-text` - descontinuado, use `gr-add-library-document`
