...
Este documento cataloga todas as conexões entre o código-fonte do GraphIt e a infraestrutura pub/sub. Atualmente, o sistema está codificado para usar o Apache Pulsar. Esta análise identifica todos os pontos de integração para informar futuras refatorações em direção a uma abstração pub/sub configurável.

## Estado Atual: Pontos de Integração do Pulsar

### 1. Uso Direto do Cliente Pulsar

**Localização:** `graphit-flow/graphit/gateway/service.py`
...
**Localização:** `graphit-base/graphit/base/async_processor.py`
...
**Localização:** `graphit-base/graphit/base/consumer.py`
...
**Arquivo de especificação:** `graphit-base/graphit/base/consumer_spec.py`
**Linha 22:** Referencia `processor.pulsar_client`

### 4. Abstração do Produtor

**Localização:** `graphit-base/graphit/base/producer.py`
...
**Arquivo de especificação:** `graphit-base/graphit/base/producer_spec.py`
**Linha 18:** Referencia `processor.pulsar_client`

### 5. Abstração do Publicador

**Localização:** `graphit-base/graphit/base/publisher.py`
...
**Localização:** `graphit-base/graphit/base/subscriber.py`
...
**Arquivo de especificação:** `graphit-base/graphit/base/subscriber_spec.py`
**Linha 19:** Referencia `processor.pulsar_client`

### 7. Sistema de Schema (Heart of Darkness)

**Localização:** `graphit-base/graphit/schema/`
...
Crie um sistema de esquemas **GraphIt** que seja agnóstico de pub/sub (usando dataclasses ou Pydantic), e então gere esquemas Pulsar/Kafka/etc a partir dele. Isso requer reescrever todos os arquivos de esquema e pode causar alterações disruptivas.
...
1. **Criar versões de dataclass** de todos os esquemas em `graphit/schema/`
