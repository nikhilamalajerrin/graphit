...
Criar uma especificação OpenAPI 3.1 abrangente e modular para o Gateway de API REST GraphIt que:
...
**Tradutores de Mensagens**: `graphit-base/graphit/messaging/translators/*.py`
**Gerenciador de Dispatcher**: `graphit-flow/graphit/gateway/dispatch/manager.py`
**Gerenciador de Endpoint**: `graphit-flow/graphit/gateway/endpoint/manager.py`
...
Para cada tradutor em `graphit-base/graphit/messaging/translators/`:
...
Tradutores: `graphit-base/graphit/messaging/translators/`
Mapeamento do despachante: `graphit-flow/graphit/gateway/dispatch/manager.py`
Roteamento de endpoint: `graphit-flow/graphit/gateway/endpoint/manager.py`
