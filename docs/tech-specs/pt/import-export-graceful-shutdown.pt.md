...
**Arquivo**: `graphit-base/graphit/base/publisher.py`
...
**Arquivo**: `graphit-flow/graphit/gateway/dispatch/triples_import.py`
...
**Arquivo**: `graphit-base/graphit/base/subscriber.py`
...
**Arquivo**: `graphit-flow/graphit/gateway/dispatch/triples_export.py`
...
**Arquivo**: `graphit-flow/graphit/gateway/endpoint/socket.py`
