...
Este documento descreve como os dados fluem através do pipeline de extração do GraphIt, desde o envio do documento até ao armazenamento nos repositórios de conhecimento.
