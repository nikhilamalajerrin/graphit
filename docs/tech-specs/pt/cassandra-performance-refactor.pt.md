...
Esta especificação aborda problemas de desempenho na implementação da base de conhecimento Cassandra GraphIt e propõe otimizações para o armazenamento e consulta de triplas RDF.

## Implementação Atual

### Design do Esquema

A implementação atual utiliza um design de tabela única em `graphit-flow/graphit/direct/cassandra_kg.py`:
...
**Arquivo: `graphit-flow/graphit/direct/cassandra_kg.py`**
...
**Caminho de Escrita:** `graphit-flow/graphit/storage/triples/cassandra/write.py`
**Caminho de Consulta:** `graphit-flow/graphit/query/triples/cassandra/service.py`
**Armazenamento de Conhecimento:** `graphit-flow/graphit/tables/knowledge.py`
...
**`graphit-flow/graphit/direct/cassandra_kg.py`** - Reescrita completa necessária.
