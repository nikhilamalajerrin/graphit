...
no GraphIt. O streaming permite a entrega em tempo real de tokens gerados
...
Esquema atual (`graphit-base/graphit/schema/services/llm.py`):
...
##### Esquema LLM (`graphit-base/graphit/schema/services/llm.py`)
...
##### Esquema do Prompt (`graphit-base/graphit/schema/services/prompt.py`)
...
**Atualizações do LlmClient** (`graphit-base/graphit/clients/llm_client.py`):
...
**Atualizações do PromptClient** (`graphit-base/graphit/base/prompt_client.py`):
...
Mesmo padrão que `gr-invoke-llm`.
...
|----------|---------|-------------------|
| OpenAI | graphit-flow | Completo (API de streaming nativa) |
| Claude/Anthropic | graphit-flow | Completo (API de streaming nativa) |
| Ollama | graphit-flow | Completo (API de streaming nativa) |
| Cohere | graphit-flow | Completo (API de streaming nativa) |
| Mistral | graphit-flow | Completo (API de streaming nativa) |
| Azure OpenAI | graphit-flow | Completo (API de streaming nativa) |
| Google AI Studio | graphit-flow | Completo (API de streaming nativa) |
| VertexAI | graphit-vertexai | Completo (Fase 2) |
| Bedrock | graphit-bedrock | Completo (API de streaming nativa) |
| LM Studio | graphit-flow | Completo (compatível com OpenAI) |
| LlamaFile | graphit-flow | Completo (compatível com OpenAI) |
| vLLM | graphit-flow | Completo (compatível com OpenAI) |
| TGI | graphit-flow | A ser definido |
| Azure | graphit-flow | A ser definido |
...
Esquema atual do LLM: `graphit-base/graphit/schema/services/llm.py`
Esquema atual do prompt: `graphit-base/graphit/schema/services/prompt.py`
Esquema atual do agente: `graphit-base/graphit/schema/services/agent.py`
Serviço base do LLM: `graphit-base/graphit/base/llm_service.py`
Provedor VertexAI: `graphit-vertexai/graphit/model/text_completion/vertexai/llm.py`
API de gateway: `graphit-base/graphit/api/`
Ferramentas de linha de comando: `graphit-cli/graphit/cli/`
