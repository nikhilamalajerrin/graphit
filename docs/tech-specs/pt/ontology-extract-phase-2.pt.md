...
4. **Expansão de URIs** (`extract.py:473-521`)
   ...
   Se não encontrado, constrói o URI: `f"https://example.com/ontology/{ontology_id}#{value}"`
...
URI construído: `https://example.com/ontology/food#Recipe`
...
Implementação atual: `graphit-flow/graphit/extract/kg/ontology/extract.py`
