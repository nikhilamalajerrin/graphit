...
A implementação de embeddings em `graphit-flow/graphit/embeddings/fastembed/processor.py` apresenta uma ineficiência de desempenho significativa:
...
**Arquivo:** `graphit-flow/graphit/gateway/dispatch/embeddings.py`
...
**Arquivo:** `graphit-flow/graphit/embeddings/document_embeddings/embeddings.py`
...
**Arquivo:** `graphit-flow/graphit/embeddings/graph_embeddings/embeddings.py`
...
**Arquivo:** `graphit-flow/graphit/embeddings/row_embeddings/embeddings.py`
...
**Arquivo:** `graphit-base/graphit/base/embeddings_client.py`
...
**Arquivo:** `graphit-cli/graphit/cli/invoke_embeddings.py`
...
O SDK Python fornece duas classes de cliente para interagir com os serviços da GraphIt. Ambas suportam apenas a incorporação de um único texto.

**Arquivo:** `graphit-base/graphit/api/flow.py`
...
**Arquivo:** `graphit-base/graphit/api/socket_client.py`
...
[Implementação do Serviço de Incorporação](graphit-base/graphit/base/embeddings_service.py)
