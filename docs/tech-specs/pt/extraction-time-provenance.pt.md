...
`graphit-flow/graphit/librarian/librarian.py` - Operações principais do bibliotecário
<<<<<<< HEAD
`graphit-flow/graphit/librarian/service.py` - Processador de serviço, carregamento de documento
=======
`graphit-flow/graphit/librarian/service.py` - Processador de serviço, carregamento de documentos
>>>>>>> 82edf2d (New md files from RunPod)
`graphit-flow/graphit/tables/library.py` - Armazenamento de tabela Cassandra
`graphit-base/graphit/schema/services/library.py` - Definições de esquema
...
#### Extensões do Namespace GraphIt
