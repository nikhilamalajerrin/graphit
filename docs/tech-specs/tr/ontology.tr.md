...
Bu özellik, GraphIt sistemindeki ontolojilerin yapısını ve biçimini tanımlar. Ontolojiler, sınıfları, özellikleri ve ilişkileri tanımlayan resmi bilgi modelleri sağlar ve akıl yürütme ve çıkarım yeteneklerini destekler. Sistem, OWL'den ilham alan bir yapılandırma biçimi kullanır ve bu, OWL/RDFS kavramlarını geniş ölçüde temsil ederken aynı zamanda GraphIt'ın gereksinimleri için optimize edilmiştir.
...
GraphIt, ontolojileri esnek bir anahtar-değer sisteminde yapılandırma öğeleri olarak saklar. Biçim OWL (Web Ontology Language) tarafından ilham alınmış olsa da, GraphIt'ın belirli kullanım durumları için optimize edilmiştir ve tüm OWL özelliklerine kesin olarak uymamaktadır.

GraphIt'taki ontolojiler şunları sağlar:
...
```json
{
  "metadata": {
    ...
    "namespace": "http://graphit.ai/ontologies/natural-world",
...
```json
{
  "classes": {
    "animal": {
      "uri": "http://graphit.ai/ontologies/natural-world#animal",
      "type": "owl:Class",
...
```json
{
  "objectProperties": {
    "has-parent": {
      "uri": "http://graphit.ai/ontologies/natural-world#has-parent",
...
```json
{
  "datatypeProperties": {
    "number-of-legs": {
      "uri": "http://graphit.ai/ontologies/natural-world#number-of-legs",
...
```json
{
  ...
  "classes": {
    "lifeform": {
      "uri": "http://graphit.ai/ontologies/natural-world#lifeform",
      "type": "owl:Class",
    ...
    "cat": {
      "uri": "http://graphit.ai/ontologies/natural-world#cat",
      "type": "owl:Class",
    ...
    "dog": {
      "uri": "http://graphit.ai/ontologies/natural-world#dog",
      "type": "owl:Class",
