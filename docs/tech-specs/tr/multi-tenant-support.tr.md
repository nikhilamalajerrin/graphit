...
GraphIt sistemi, dinamik kuyruk çözümlemesi için **akış tabanlı bir mimari** kullanır ve bu, doğal olarak çok kiracılığı destekler:
...
**Dosya:** `graphit-base/graphit/base/async_processor.py`
**Satır:** 260-264
...
**Dosya:** `graphit-flow/graphit/config/service/service.py`
**Satır:** 276-279
...
**Dosya:** `graphit-base/graphit/base/cassandra_config.py`
...
**Dosya:** `graphit-flow/graphit/cores/service.py`
...
**Dosya:** `graphit-flow/graphit/librarian/service.py`
...
**Dosya:** `graphit-flow/graphit/librarian/collection_manager.py`
...
**Dosya:** `graphit-flow/graphit/tables/library.py`
...
**Dosya:** `graphit-base/graphit/schema/services/collection.py`
...
1. **Triples Sorgu Hizmeti** (`graphit-flow/graphit/query/triples/cassandra/service.py:65`)
   `keyspace=query.user` kullanır
2. **Objects Sorgu Hizmeti** (`graphit-flow/graphit/query/objects/cassandra/service.py:479`)
   `keyspace=self.sanitize_name(user)` kullanır
3. **KnowledgeGraph Doğrudan Erişim** (`graphit-flow/graphit/direct/cassandra_kg.py:18`)
   Varsayılan parametre `keyspace="graphit"`
...
## Referanslar
GitHub Sorunu: https://github.com/example.com/graphit/issues/582
İlgili Dosyalar:
