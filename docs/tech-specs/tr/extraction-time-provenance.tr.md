...
`graphit-flow/graphit/librarian/librarian.py` - Temel kütüphaneci işlemleri
`graphit-flow/graphit/librarian/service.py` - Hizmet işlemcisi, belge yükleme
`graphit-flow/graphit/tables/library.py` - Cassandra tablo deposu
`graphit-base/graphit/schema/services/library.py` - Şema tanımları
...
#### GraphIt İsim Alanı Genişletmeleri
...
#### GraphIt Ad Alanı Genişletmeleri
