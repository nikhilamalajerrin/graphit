...
4. **URI Genişletme** (`extract.py:473-521`)
   ...
   Bulunmazsa, URI oluşturulur: `f"https://example.com/ontology/{ontology_id}#{value}"`
...
Oluşturulmuş URI: `https://example.com/ontology/food#Recipe`
...
Mevcut uygulama: `graphit-flow/graphit/extract/kg/ontology/extract.py`
