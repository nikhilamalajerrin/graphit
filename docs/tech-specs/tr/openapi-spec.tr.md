...
GraphIt REST API Gateway için kapsamlı, modüler bir OpenAPI 3.1 spesifikasyonu oluşturmak, bu spesifikasyon şunları sağlamalıdır:
...
**Mesaj Çeviriciler**: `graphit-base/graphit/messaging/translators/*.py`
**Dağıtıcı Yöneticisi**: `graphit-flow/graphit/gateway/dispatch/manager.py`
**Uç Nokta Yöneticisi**: `graphit-flow/graphit/gateway/endpoint/manager.py`
...
Her çevirici için `graphit-base/graphit/messaging/translators/` içinde:
...
Çevirenler: `graphit-base/graphit/messaging/translators/`
Dağıtım eşlemesi: `graphit-flow/graphit/gateway/dispatch/manager.py`
Uç nokta yönlendirmesi: `graphit-flow/graphit/gateway/endpoint/manager.py`
