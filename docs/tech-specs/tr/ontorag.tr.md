...
**Uygulama Konumu**: `graphit-flow/graphit/extract/kg/ontology/ontology_loader.py`
...
**Uygulama Konumu**: `graphit-flow/graphit/extract/kg/ontology/ontology_embedder.py`
...
**Uygulama Konumu**: `graphit-flow/graphit/extract/kg/ontology/text_processor.py`
...
**Uygulama Konumu**: `graphit-flow/graphit/extract/kg/ontology/ontology_selector.py`
...
**Uygulama Konumu**: `graphit-flow/graphit/extract/kg/ontology/extract.py` (build_extraction_variables metodu)
...
**Uygulama Konumu**: `graphit-flow/graphit/extract/kg/ontology/extract.py`

### Yapılandırma

Bu hizmet, komut satırı argümanlarıyla GraphIt'ın standart yapılandırma yaklaşımını kullanır:
...
**Uygulama Konumu**: `graphit-flow/graphit/extract/kg/ontology/vector_store.py`
