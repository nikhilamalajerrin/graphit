...
Bu belge, GraphIt'ın farklı arka uç uygulamaları (Qdrant, Pinecone, Milvus) arasında vektör depolama koleksiyonlarını nasıl yönettiğini açıklamaktadır. Tasarım, sabit boyut değerleri kullanmadan farklı boyutlara sahip gömülmeleri destekleme zorluğunu ele almaktadır.
...
Tek bir GraphIt koleksiyonu, birden fazla modelden gömmeler alabilir.
...
Depolama Şeması: `graphit-base/graphit/schema/services/storage.py`
Kütüphaneci Hizmeti: `graphit-flow/graphit/librarian/service.py`
