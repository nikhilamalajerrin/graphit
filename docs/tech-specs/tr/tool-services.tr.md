...
Araçlar şu anda `graphit-flow/graphit/agent/react/tools.py` içinde, türlenmiş uygulamalarla tanımlanmıştır:
...
Yapılandırmaları yüklemek için `gr-put-config-item`'ı kullanın:
...
`graphit-base/graphit/schema/services/tool_service.py` içindeki istek ve yanıt türleri:
...
`graphit-base/graphit/base/dynamic_tool_service.py` içindeki temel sınıf:
...
`graphit-flow/graphit/agent/react/tools.py` içindeki uygulama:
...
| Dosya | Amaç |
|------|---------|
| `graphit-base/graphit/schema/services/tool_service.py` | İstek/yanıt şemaları |
| `graphit-base/graphit/base/tool_service_client.py` | Hizmetleri çağırmak için istemci |
| `graphit-base/graphit/base/dynamic_tool_service.py` | Hizmet uygulamasının temel sınıfı |
| `graphit-flow/graphit/agent/react/tools.py` | `ToolServiceImpl` sınıfı |
| `graphit-flow/graphit/agent/react/service.py` | Yapılandırma yükleme |

### Örnek: Şaka Hizmeti

`graphit-flow/graphit/tool_service/joke/`'da bir örnek hizmet:
...
Mevcut araç uygulaması: `graphit-flow/graphit/agent/react/tools.py`
Araç kaydı: `graphit-flow/graphit/agent/react/service.py:105-214`
Aracı şemaları: `graphit-base/graphit/schema/services/agent.py`
