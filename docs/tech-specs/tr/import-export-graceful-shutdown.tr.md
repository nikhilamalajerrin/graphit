...
=======
GraphIt geçidi, hem içe hem de dışa aktarma işlemlerinde websocket kapanması sırasında mesaj kaybı yaşamaktadır. Bu, aktarım halindeki mesajların, hedeflerine (içe aktarmalar için Pulsar kuyrukları, dışa aktarmalar için websocket istemcileri) ulaşmadan önce atıldığı yarış koşulları nedeniyle oluşmaktadır.
...
**Dosya**: `graphit-base/graphit/base/publisher.py`
...
**Dosya**: `graphit-flow/graphit/gateway/dispatch/triples_import.py`
...
**Dosya**: `graphit-base/graphit/base/subscriber.py`
...
**Dosya**: `graphit-flow/graphit/gateway/dispatch/triples_export.py`
...
**Dosya**: `graphit-flow/graphit/gateway/endpoint/socket.py`
