...
**Konum:** `graphit-base/graphit/base/async_processor.py`
...
**Konum:** `graphit-base/graphit/base/consumer.py`
...
**Belge dosyası:** `graphit-base/graphit/base/consumer_spec.py`
**Satır 22:** `processor.pulsar_client`'a referans

### 4. Yayıncı Soyutlaması

**Konum:** `graphit-base/graphit/base/producer.py`
...
**Belge dosyası:** `graphit-base/graphit/base/producer_spec.py`
**Satır 18:** `processor.pulsar_client`'a referans

### 5. Yayıncı Soyutlaması

**Konum:** `graphit-base/graphit/base/publisher.py`
...
**Konum:** `graphit-base/graphit/base/subscriber.py`
...
**Spec dosyası:** `graphit-base/graphit/base/subscriber_spec.py`
**19. Satır:** `processor.pulsar_client`'a referans

### 7. Şema Sistemi (Heart of Darkness)

**Konum:** `graphit-base/graphit/schema/`
...
Bir **GraphIt şema sistemi** oluşturun; bu sistem, pub/sub'dan bağımsızdır (dataclass'lar veya Pydantic kullanarak). Ardından, bu sistemden Pulsar/Kafka/vb. şemalarını oluşturun. Bu, her şema dosyasının yeniden yazılmasını gerektirir ve potansiyel olarak uyumsuzluklara neden olabilir.
...
1. `graphit/schema/` içindeki tüm şemaların **dataclass versiyonlarını oluşturun**
