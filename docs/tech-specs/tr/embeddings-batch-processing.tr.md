...
`graphit-flow/graphit/embeddings/fastembed/processor.py` içindeki gömme uygulamasında önemli bir performans verimsizliği bulunmaktadır:
...
**Dosya:** `graphit-flow/graphit/gateway/dispatch/embeddings.py`
...
**Dosya:** `graphit-flow/graphit/embeddings/document_embeddings/embeddings.py`
...
**Dosya:** `graphit-flow/graphit/embeddings/graph_embeddings/embeddings.py`
...
**Dosya:** `graphit-flow/graphit/embeddings/row_embeddings/embeddings.py`
...
**Dosya:** `graphit-base/graphit/base/embeddings_client.py`
...
**Dosya:** `graphit-cli/graphit/cli/invoke_embeddings.py`
...
Python SDK, GraphIt hizmetleriyle etkileşim kurmak için iki istemci sınıfı sağlar. Her ikisi de yalnızca tek metin gömme işlemini destekler.

**Dosya:** `graphit-base/graphit/api/flow.py`
...
**Dosya:** `graphit-base/graphit/api/socket_client.py`
...
#### 1. **Şema Geliştirme**
   ...
   Modül: `graphit-base/graphit/schema/services/llm.py`
...
#### 2. **Temel Servis Geliştirme**
   ...
   Modül: `graphit-base/graphit/base/embeddings_service.py`
...
#### 4. **İstemci Geliştirme**
   ...
   Modül: `graphit-base/graphit/base/embeddings_client.py`
...
#### 6. **API Ağ Geçidi Geliştirme**
   ...
   Modül: `graphit-flow/graphit/gateway/dispatch/embeddings.py`

#### 7. **CLI Aracı Geliştirme**
   Birden fazla metin veya dosya girişi desteği ekleyin
   Toplu boyut parametresi ekleyin

   Modül: `graphit-cli/graphit/cli/invoke_embeddings.py`
...
[EmbeddingsService Uygulaması](graphit-base/graphit/base/embeddings_service.py)
