...
Bu özellik, GraphIt Python API istemci kitaplığının, API Gateway ile özellik uyumluluğu sağlamak ve modern gerçek zamanlı iletişim kalıplarına destek eklemek için kapsamlı bir şekilde yeniden düzenlenmesini açıklamaktadır.
...
Python API'si (`graphit-base/graphit/api/`), aşağıdaki modüllere sahip REST tabanlı bir istemci kitaplığıdır:
...
Modül: `graphit-base/graphit/api/api.py`
...
Modül: `graphit-base/graphit/api/socket_client.py` (yeni)
...
Modül: `graphit-base/graphit/api/async_socket_client.py` (yeni)
...
Modül: `graphit-base/graphit/api/bulk_client.py` (yeni)
...
Modül: `graphit-base/graphit/api/async_bulk_client.py` (yeni)
...
Modül: `graphit-base/graphit/api/flow.py`
...
Modül: `graphit-base/graphit/api/async_flow.py` (yeni)
...
Modül: `graphit-base/graphit/api/metrics.py` (yeni)
...
Modül: `graphit-base/graphit/api/types.py` (değiştirildi)
...
### Uygulama Dosyaları
`graphit-base/graphit/api/` - Python API kaynağı
`graphit-flow/graphit/gateway/` - Ağ Geçidi kaynağı
`graphit-flow/graphit/gateway/dispatch/mux.py` - WebSocket çoklayıcı referans uygulaması
