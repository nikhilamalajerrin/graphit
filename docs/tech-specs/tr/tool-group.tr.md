---
layout: default
title: "GraphIt Araç Grubu Sistemi"
parent: "Turkish (Beta)"
---

# GraphIt Araç Grubu Sistemi
...
`graphit-base/graphit/schema/services/agent.py` içindeki `AgentRequest` şeması geliştirilmiştir:
...
Bu sistem, GraphIt dağıtımlarının araç erişimini daha iyi yönetmesini, güvenlik sınırlarını iyileştirmesini ve mevcut yapılandırmalar ve isteklerle tam uyumluluğu korurken kaynak kullanımını optimize etmesini sağlar.
