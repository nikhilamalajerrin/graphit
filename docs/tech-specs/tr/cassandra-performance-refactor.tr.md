...
Bu özellik, GraphIt Cassandra bilgi tabanı uygulamasındaki performans sorunlarına değinmekte ve RDF üçlü depolama ve sorgulama için optimizasyonlar önermektedir.

## Mevcut Uygulama

### Şema Tasarımı

Mevcut uygulama, `graphit-flow/graphit/direct/cassandra_kg.py`'da tek bir tablo tasarımı kullanmaktadır:
...
**Dosya: `graphit-flow/graphit/direct/cassandra_kg.py`**
...
**Yazma Yolu:** `graphit-flow/graphit/storage/triples/cassandra/write.py`
**Sorgu Yolu:** `graphit-flow/graphit/query/triples/cassandra/service.py`
**Bilgi Deposu:** `graphit-flow/graphit/tables/knowledge.py`
...
**`graphit-flow/graphit/direct/cassandra_kg.py`** - Tamamen yeniden yazılması gerekir.
