...
Bu özellik, GraphIt'ın temel grafik yapılarına yapılan değişiklikleri tanımlar ve
...
Bu özellik, GraphIt'ın temel grafik öğelerindeki değişiklikleri,
...
Mevcut `Value` sınıfı `graphit-base/graphit/schema/core/primitives.py` içinde
=======
...
**Şema ilkel öğeleri** (`graphit-base/graphit/schema/core/primitives.py`)
...
**Mesaj çeviricileri** (`graphit-base/graphit/messaging/translators/`)
