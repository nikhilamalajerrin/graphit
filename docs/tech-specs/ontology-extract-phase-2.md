...
4. **URI Expansion** (`extract.py:473-521`)
   ...
   - If not found, constructs URI: `f"https://example.com/ontology/{ontology_id}#{value}"`
...
- Constructed URI: `https://example.com/ontology/food#Recipe`
...
- Current implementation: `graphit-flow/graphit/extract/kg/ontology/extract.py`
