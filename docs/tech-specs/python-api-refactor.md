...
Module: `graphit-base/graphit/api/api.py`
...
Module: `graphit-base/graphit/api/socket_client.py` (new)
...
Module: `graphit-base/graphit/api/async_socket_client.py` (new)
...
Module: `graphit-base/graphit/api/bulk_client.py` (new)
...
Module: `graphit-base/graphit/api/async_bulk_client.py` (new)
...
Module: `graphit-base/graphit/api/flow.py`
...
Module: `graphit-base/graphit/api/async_flow.py` (new)
...
Module: `graphit-base/graphit/api/metrics.py` (new)
...
Module: `graphit-base/graphit/api/types.py` (modified)
...
- `graphit-base/graphit/api/` - Python API source
- `graphit-flow/graphit/gateway/` - Gateway source
- `graphit-flow/graphit/gateway/dispatch/mux.py` - WebSocket multiplexer reference implementation
