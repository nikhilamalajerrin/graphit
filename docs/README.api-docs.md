...
The Python API documentation is generated from docstrings using a custom Python script that introspects the `graphit.api` package.

### Prerequisites

The graphit package must be importable. If you're working in a development environment:
...
The generated documentation shows the public API exactly as users import it from `graphit.api`, without exposing internal module structure.
