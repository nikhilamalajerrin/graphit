...
All classes and types are imported from the `graphit.api` package:
...
Main GraphIt API client for synchronous and asynchronous operations.

This class provides access to all GraphIt services including flow management,
...
Initialize the GraphIt API client.

**Arguments:**

- `url`: Base URL for GraphIt API (default: "http://localhost:8088/")
...
Flows are the primary execution units in GraphIt, providing access to
...
Retrieves Prometheus-formatted metrics from the GraphIt service
...
This class provides access to all GraphIt services including:
...
result = await flow.graph_rag(
    query="What is GraphIt?",collection="default"
)
```
...
Internal method for making authenticated requests to the GraphIt API.
...
### `text_completion(self, system: str, prompt: str, **kwargs: Any) -> graphit.api.types.TextCompletionResult`
...
### `agent(self, question: str, state: Dict[str, Any] | None = None, group: str | None = None, history: List[Dict[str, Any]] | None = None, streaming: bool = False, **kwargs: Any) -> Dict[str, Any] | Iterator[graphit.api.types.StreamingChunk]`

Execute an agent operation with streaming support.

### `agent_explain(self, question: str, collection: str, state: Dict[str, Any] | None = None, group: str | None = None, history: List[Dict[str, Any]] | None = None, **kwargs: Any) -> Iterator[graphit.api.types.StreamingChunk | graphit.api.types.ProvenanceEvent]`
...
### `document_rag(self, query: str, collection: str, doc_limit: int = 10, streaming: bool = False, **kwargs: Any) -> graphit.api.types.TextCompletionResult | Iterator[graphit.api.types.RAGChunk]`
...
### `document_rag_explain(self, query: str, collection: str, doc_limit: int = 10, **kwargs: Any) -> Iterator[graphit.api.types.RAGChunk | graphit.api.types.ProvenanceEvent]`
...
### `graph_rag(self, query: str, collection: str, entity_limit: int = 50, triple_limit: int = 30, max_subgraph_size: int = 1000, max_path_length: int = 2, edge_score_limit: int = 30, edge_limit: int = 25, streaming: bool = False, **kwargs: Any) -> graphit.api.types.TextCompletionResult | Iterator[graphit.api.types.RAGChunk]`
...
### `graph_rag_explain(self, query: str, collection: str, entity_limit: int = 50, triple_limit: int = 30, max_subgraph_size: int = 1000, max_path_length: int = 2, edge_score_limit: int = 30, edge_limit: int = 25, **kwargs: Any) -> Iterator[graphit.api.types.RAGChunk | graphit.api.types.ProvenanceEvent]`
...
### `prompt(self, id: str, variables: Dict[str, str], streaming: bool = False, **kwargs: Any) -> graphit.api.types.TextCompletionResult | Iterator[graphit.api.types.RAGChunk]`
...
### `text_completion(self, system: str, prompt: str, streaming: bool = False, **kwargs) -> graphit.api.types.TextCompletionResult | Iterator[graphit.api.types.RAGChunk]`
...
- `url`: Base URL for GraphIt API (HTTP/HTTPS will be converted to WS/WSS)
...
- `collection`: Collection identifier
- `api`: GraphIt Api instance for librarian access (optional)
...
- `api`: GraphIt Api instance for librarian access
- `max_content`: Maximum content length to return

**Returns:** The document content as a string

### `fetch_edge_selection(self, uri: str, graph: str | None = None, collection: str | None = None) -> graphit.api.explainability.EdgeSelection | None`
...
### `fetch_entity(self, uri: str, graph: str | None = None, collection: str | None = None) -> graphit.api.explainability.ExplainEntity | None`
...
### `fetch_focus_with_edges(self, uri: str, graph: str | None = None, collection: str | None = None) -> graphit.api.explainability.Focus | None`
...
### `list_sessions(self, graph: str | None = None, collection: str | None = None, limit: int = 50) -> List[graphit.api.explainability.Question]`
...
```python
from graphit.api import Observation
```
...
### `__init__(self, id: str, time: datetime.datetime, kind: str, title: str, comments: str, metadata: List[graphit.api.types.Triple], tags: List[str], parent_id: str = '', document_type: str = 'source') -> None`
...
```python
from graphit.api import TextCompletionResult
```
