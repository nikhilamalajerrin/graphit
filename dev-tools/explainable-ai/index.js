...
// ============================================================================
// GraphIt Explainability API Demo
// ============================================================================
//
// This example demonstrates how to use the GraphIt streaming agent API
...
//
// Explainability events use RDF triples (W3C PROV ontology + GraphIt
...
import { createGraphItSocket } from '@graphit/client';
...
// ---------------------------------------------------------------------------
// RDF predicates and GraphIt namespace constants
// ---------------------------------------------------------------------------
...
const TG_GROUNDING = "https://graphit.ai/ns/Grounding";
const TG_CONCEPT = "https://graphit.ai/ns/concept";
const TG_EXPLORATION = "https://graphit.ai/ns/Exploration";
const TG_ENTITY = "https://graphit.ai/ns/entity";
const TG_FOCUS = "https://graphit.ai/ns/Focus";
const TG_EDGE = "https://graphit.ai/ns/edge";
const TG_CONTAINS = "https://graphit.ai/ns/contains";
...
console.log("GraphIt Explainability API Demo");
console.log("=".repeat(80));
console.log(`Connecting to: ${SOCKET_URL}`);
console.log(`Question: ${QUESTION}`);
console.log("=".repeat(80));

const client = createGraphItSocket(USER, undefined, SOCKET_URL);
