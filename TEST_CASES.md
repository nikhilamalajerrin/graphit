# Test Cases for GraphIt Microservices

This document provides comprehensive test cases for all GraphIt microservices, organized by service category and following the testing strategy outlined in TEST_STRATEGY.md.
...
### OpenAI Text Completion (`graphit.model.text_completion.openai`)
...
### Claude Text Completion (`graphit.model.text_completion.claude`)
...
### Ollama Text Completion (`graphit.model.text_completion.ollama`)
...
### Azure OpenAI Text Completion (`graphit.model.text_completion.azure`)
...
### Google Vertex AI Text Completion (`graphit.model.text_completion.vertexai`)
...
### Document Embeddings (`graphit.embeddings.document_embeddings`)
...
### Graph Embeddings (`graphit.embeddings.graph_embeddings`)
...
### Ollama Embeddings (`graphit.embeddings.ollama`)
...
#### Qdrant Storage (`graphit.storage.doc_embeddings.qdrant`)
...
#### Milvus Storage (`graphit.storage.doc_embeddings.milvus`)
...
#### Qdrant Storage (`graphit.storage.graph_embeddings.qdrant`)
...
#### Milvus Storage (`graphit.storage.graph_embeddings.milvus`)
...
#### Cassandra Storage (`graphit.storage.triples.cassandra`)
...
#### Neo4j Storage (`graphit.storage.triples.neo4j`)
...
#### Qdrant Query (`graphit.query.doc_embeddings.qdrant`)
...
#### Milvus Query (`graphit.query.doc_embeddings.milvus`)
...
#### Qdrant Query (`graphit.query.graph_embeddings.qdrant`)
...
#### Milvus Query (`graphit.query.graph_embeddings.milvus`)
...
#### Cassandra Query (`graphit.query.triples.cassandra`)
...
#### Neo4j Query (`graphit.query.triples.neo4j`)
...
### Base Flow Processor (`graphit.processing`)
...
#### Topic Extraction (`graphit.extract.kg.topics`)
...
#### Relationship Extraction (`graphit.extract.kg.relationships`)
...
#### Definition Extraction (`graphit.extract.kg.definitions`)
...
#### Row Extraction (`graphit.extract.object.row`)
...
### GraphRAG Retrieval (`graphit.retrieval.graph_rag`)
...
### Document RAG Retrieval (`graphit.retrieval.document_rag`)
