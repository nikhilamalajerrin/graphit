"""
Verifies GraphIt system health by running comprehensive checks.
...
from graphit.i18n import get_translator

default_pulsar_url = "http://localhost:8080"
default_api_url = os.getenv("GRAPHIT_URL", "http://localhost:8088/")
...
def main():
    ...
    parser.add_argument(
        '--lang',
        default=os.getenv("GRAPHIT_LANG", "en"),
        help='Language code for CLI output (default: $GRAPHIT_LANG or en)'
    )
