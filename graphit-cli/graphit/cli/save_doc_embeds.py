"""
This utility connects to a running GraphIt through the API and creates
a document embeddings core from the data streaming through the processing
queues.  For completeness of data, gr-save-doc-embeds should be initiated
