...
Examples:
  gr-show-explain-trace -U graphit -C default "urn:graphit:question:abc123"
  gr-show-explain-trace -U graphit -C default "urn:graphit:agent:abc123"
  gr-show-explain-trace --max-answer 1000 "urn:graphit:question:abc123"
  gr-show-explain-trace --show-provenance "urn:graphit:question:abc123"
"""
...
def main():
    ...
    parser.add_argument(
        ...
        help='Auth token (default: $GRAPHIT_TOKEN)',
    )
