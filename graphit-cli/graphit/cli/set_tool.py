"""
Configures and registers tools in the GraphIt system.
...
import argparse
import os
from graphit.api import Api, ConfigKey, ConfigValue
import json
import tabulate
import textwrap
import dataclasses
...
def main():
    ...
    parser.add_argument(
        '--mcp-tool',
        help=f'For MCP type: ID of MCP tool configuration (as defined by gr-set-mcp-tool)',
    )
