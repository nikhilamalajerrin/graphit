...
Examples:
  gr-show-extraction-provenance -U graphit -C default "urn:graphit:doc:abc123"
  gr-show-extraction-provenance --show-content --max-content 500 "urn:graphit:doc:abc123"
"""
...
# Map GraphIt type URIs to display names
TYPE_MAP = {
...
def main():
    parser = argparse.ArgumentParser(
        prog='gr-show-extraction-provenance',
        description=__doc__,
