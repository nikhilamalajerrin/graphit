...
Unlike gr-show-graph which dumps the entire graph, this tool enables selective
...
Examples:
  gr-query-graph -s "http://example.org/entity"
  gr-query-graph -p "http://www.w3.org/2000/01/rdf-schema#label"
  gr-query-graph -o "Marie Curie" --object-language en
  gr-query-graph -o "<<http://ex.org/s http://ex.org/p http://ex.org/o>>"
"""
