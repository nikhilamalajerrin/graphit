...
from graphit.base import AsyncProcessor
from graphit.base import ProducerMetrics, SubscriberMetrics
from graphit.base.config_client import ConfigClient
...
def _load_initialisers_file(path):
    ...
    .. code-block:: yaml
        ...
        initialisers:
          - class: graphit.bootstrap.initialisers.PulsarTopology
