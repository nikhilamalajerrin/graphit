...
def build_entity_uri(entity_name: str, entity_type: str, ontology_id: str,
                    base_uri: str = "https://graphit.ai") -> str:
    ...
    Args:
        ...
        base_uri: Base URI for entity URIs (default: "https://graphit.ai")

    Returns:
        Full entity URI (e.g., "https://graphit.ai/food/recipe-cornish-pasty")

    Examples:
        >>> build_entity_uri("Cornish pasty", "fo/Recipe", "food")
        'https://graphit.ai/food/recipe-cornish-pasty'

        >>> build_entity_uri("Cornish pasty", "Food", "food")
        'https://graphit.ai/food/food-cornish-pasty'

        >>> build_entity_uri("beef", "fo/Food", "food")
        'https://graphit.ai/food/food-beef'
    """
...
class EntityRegistry:
    ...
    def __init__(self, ontology_id: str, base_uri: str = "https://graphit.ai"):
