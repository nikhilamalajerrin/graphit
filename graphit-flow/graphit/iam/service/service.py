...
Shape mirrors graphit.config.service.
"""
...
from graphit.schema import IamRequest, IamResponse
from graphit.schema import iam_request_queue, iam_response_queue
from graphit.schema import ConfigRequest, ConfigResponse, ConfigValue
from graphit.schema import config_request_queue, config_response_queue

from graphit.base import AsyncProcessor, Consumer, Producer
from graphit.base import ConsumerMetrics, ProducerMetrics
from graphit.base.metrics import SubscriberMetrics
from graphit.base.request_response_spec import RequestResponse
from graphit.base.cassandra_config import (
...
class Processor(AsyncProcessor):
    ...
    async def _config_delete(self, workspace, type, key):
        from graphit.schema import ConfigKey
        client = self._create_config_client()
        try:
            await client.start()
            await client.request(
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            ...
            help=(
                ...
                "and returned by gr-bootstrap-iam.  Unsafe to run "
