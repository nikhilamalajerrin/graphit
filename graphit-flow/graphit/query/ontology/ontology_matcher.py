...
from graphit.extract.kg.ontology.ontology_loader import Ontology, OntologyLoader
from graphit.extract.kg.ontology.ontology_embedder import OntologyEmbedder
