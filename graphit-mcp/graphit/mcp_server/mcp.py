...
from graphit.base.logging import add_logging_args, setup_logging
...
class PassthroughTokenVerifier(TokenVerifier):
    ...
    The GraphIt gateway is the authority for token validation, not
...
class McpServer:
    ...
    async def embeddings(
        ...
        """
        Generate vector embeddings for the given texts using GraphIt's embedding models.
    ...
    async def text_completion(
        ...
        """
        Generate text completions using GraphIt's language models.
    ...
    async def graphql_query(
        ...
        Queries structured data schemas that have been loaded into GraphIt.
    ...
    async def get_config_all(
        ...
        """
        Retrieve the complete GraphIt system configuration.
    ...
    async def get_documents(
        ...
        """
        List all documents stored in the GraphIt document library.
    ...
    async def load_document(
        ...
        """
        Upload a document to the GraphIt document library.
...
def main():
    parser = argparse.ArgumentParser(description='GraphIt MCP Server')
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help='WebSocket URL for the GraphIt gateway',
    )
    parser.add_argument(
        '--auth-issuer',
